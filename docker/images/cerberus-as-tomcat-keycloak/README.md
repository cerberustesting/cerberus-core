...
5.0   | Use the 5.0 Cerberus version     | [5.0/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/5.0/Dockerfile)
4.20   | Use the 4.20 Cerberus version     | [4.20/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/4.20/Dockerfile)
4.19   | Use the 4.19 Cerberus version     | [4.19/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/4.19/Dockerfile)
4.18   | Use the 4.18 Cerberus version     | [4.18/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/4.18/Dockerfile)
4.17   | Use the 4.17 Cerberus version     | [4.17/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/4.17/Dockerfile)
...
4.13   | Use the 4.13 Cerberus version     | [4.13/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/4.13/Dockerfile)
4.12   | Use the 4.12 Cerberus version     | [4.12/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/4.12/Dockerfile)
4.11.2   | Use the 4.11.2 Cerberus version     | [4.11.2/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/4.11.2/Dockerfile)
4.11.1   | Use the 4.11.1 Cerberus version     | [4.11.1/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/4.11.1/Dockerfile)
4.11   | Use the 4.11 Cerberus version     | [4.11/Dockerfile](https://github.com/cerberustesting/cerberus-source/blob/master/docker/images/cerberus-as-tomcat-keycloak/4.11/Dockerfile)
