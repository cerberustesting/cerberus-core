...
$GLASSFISHPATH/asadmin undeploy --target server --cascade=true Cerberus-3.6
...
$GLASSFISHPATH/asadmin undeploy --target server --cascade=true Cerberus-4.3
$GLASSFISHPATH/asadmin deploy --target server --contextroot Cerberus --availabilityenabled=true $MYPATH/../Cerberus-4.3.war
