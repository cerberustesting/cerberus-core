...
<%--
    LEGACY FALLBACK. TestCaseExecutionList.jsp now serves the crbTable V2 version
    (js/pages/TestCaseExecutionListV2.js). To roll back, copy this file over
    TestCaseExecutionList.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
