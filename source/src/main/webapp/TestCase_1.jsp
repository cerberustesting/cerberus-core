                    ...
                    <tr>
                        <td class="separation">
                            <table  class="wob" style="text-align: left; border-collapse: collapse" border="0px" cellpadding="0px" cellspacing="0px">
                                ...
                                <tr>
                                    <td class="wob">
                                        <input id="editTest" style="width: 90px; font-weight: bold;" name="editTest" id="DuplicateTest"
                                               value="<%=tcase.getTest()%>" onchange="checkFieldDuplicate();">
                                    </td>
                                    <td class="wob">
                                        <input id="editTestCase" style="width: 90px; font-weight: bold;" name="editTestCase" id="DuplicateTestCase"
                                               value="<%=tcase.getTestCase()%>"
                                               onchange="checkFieldDuplicate('<%=tcase.getTest()%>', '<%=tcase.getTestCase()%>');">
                                    </td>
                                    <td class="wob">
                                        <input id="editDescription" style="width: 950px; background-color: #DCDCDC" name="editDescription" readonly="readonly"
                    ...
                    <table><tr><td id="wob" style="width:10px"></td><td id="leftlined">
                                ...
                                <table style="text-align: left; border-collapse: collapse">
                                    <tr>
                                        ...
                                        <td id="wob">
                                            <input  size="100%" style="font-weight: bold; width: 200px" name="useStepTest"
                                                    value="<%=tcs.getUseStepTest()%>">
                                        </td><td id="wob">
                                            <input size="100%" style="font-weight: bold; width: 50px" name="useStepTestCase"
                                                   value="<%=tcs.getUseStepTestCase()%>">
                                        </td><td id="wob">
                                            <input size="100%" style="font-weight: bold; width: 50px" name="useStepStep"
                    ...
                    <table id="testcaseproperties_table" style="text-align: left; border-collapse: collapse"
                        ...
                        <tr style="background-color : <%=color%>">
                            ...
                            <td><table><tr><td class="wob" rowspan="2"><textarea id="<%=valueID%>" rows="2" class="wob" style="width: <%=size4%>px; background-color : <%=color%>; " name="properties_value"
                                        ...
                                        <td class="wob" id="tdValue2_<%=rowNumber%>" rowspan="2" style="display:<%=styleValue2%>">
                                            <textarea id="<%=valueID%>_2" rows="2" class="wob" style="width: <%=size3%>px; background-color : <%=color%>;"
                                                      name="properties_value2" value="<%=tccp.getValue2()%>"><%=tccp.getValue2()%></textarea>
                                        </td>
                                        <%
                                            if (tccp.getType().equals("executeSqlFromLib")
