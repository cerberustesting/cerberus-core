...
<%--
    LEGACY FALLBACK. TestCaseExecutionQueueList.jsp now serves the crbTable V2
    version (js/pages/TestCaseExecutionQueueListV2.js). To roll back, copy this
    file over TestCaseExecutionQueueList.jsp - it still works untouched.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
