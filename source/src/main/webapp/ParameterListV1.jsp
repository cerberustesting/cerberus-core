...
<%--
    LEGACY FALLBACK. ParameterList.jsp now serves the crbTable V2 version
    (js/pages/ParameterListV2.js). To roll back, copy this file over
    ParameterList.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
