            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-xs-12" id="EnvByBuildRevisionTable">
                                        <table class="table dataTable table-bordered table-hover nomarginbottom" id="envTable">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" id="systemHeader" name="systemHeader">Build</th>
                    ...
                    <div id="ChangelogPanel">
                        <div class="panel panel-default">
                            <div class="panel-heading card" data-toggle="collapse" data-target="#Changelog410">
                                <span class="fa fa-pie-chart fa-fw"></span>
                                <label id="changelogLabel">Changelog</label>
                                <span class="toggle glyphicon glyphicon-chevron-right pull-right"></span>
                            </div>
                            <div class="panel-body collapse in" id="Changelog410">
