...
<%--
    LEGACY FALLBACK. LogEvent.jsp now serves the crbTable V2 version
    (js/pages/LogEventV2.js). To roll back, copy this file over
    LogEvent.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
