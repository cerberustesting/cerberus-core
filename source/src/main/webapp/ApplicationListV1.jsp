...
<%--
    LEGACY FALLBACK. ApplicationList.jsp now serves the crbTable V2 version
    (js/pages/ApplicationListV2.js). To roll back, copy this file over
    ApplicationList.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="crb_html">
    <head>
