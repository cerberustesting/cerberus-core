...
<html class="h-full">
    <head>
        ...
        <%--
            ROLLBACK COPY of the page as it was before the V2 redesign, byte for
            byte apart from this comment. To roll back: copy this file over
            CerberusInformation.jsp. It drives js/pages/CerberusInformation.js,
            which is kept for exactly that reason and is not loaded by the V2 page.
        --%>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <%@ include file="include/global/dependenciesInclusions.html" %>
        <script type="text/javascript" src="js/pages/CerberusInformation.js?v=${appVersion}"></script>
