...
<%--
    LEGACY FALLBACK. UserManager.jsp now serves the crbTable V2 version
    (js/pages/UserManagerV2.js). To roll back, copy this file over
    UserManager.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
