    ...
    if (oldHelperLayer != null) {
      ...
      self._lastShowElementTimer = setTimeout(function() {
        ...
        if (self._options.showBullets) {
            if(oldReferenceLayer.querySelector('.introjs-bullets li > a.active') != null) oldReferenceLayer.querySelector('.introjs-bullets li > a.active').className = '';
