	...
	var aoColumns = [
			{
				...
				"mRender" : function(data, type, obj) {
					...
					var duplicateEntry = '<button class="btn btn-default btn-xs margin-right5" \n\
							...
							+ doc.getDocLabel("page_testdatalib",
									"tooltip_duplicateEntry")
							+ '"\n\
					                         type="button" onclick="openModalAppService(\''
							+ obj["service"]
							+ '\', \'DUPLICATE\'  )">\n\
					                        <span class="glyphicon glyphicon-duplicate"></span></button>'; // TODO
																											// check
																											// if
																											// we
																											// can
