...
//        setPlaceholderAction();
    ...
    thirdRow.append($("<div></div>").addClass("col-lg-3 form-group").append($("<label></label>").text("Condition Operation:")).append(actionconditionoper));
    thirdRow.append($("<div></div>").addClass("col-lg-4 form-group").append($("<label></label>").text("Condition Parameter 1:")).append(actionconditionval1));
    thirdRow.append($("<div></div>").addClass("col-lg-4 form-group").append($("<label></label>").text("Condition Parameter 2:")).append(actionconditionval2));
...
Control.prototype.generateContent = function () {
    ...
    thirdRow.prepend($("<div></div>").addClass("col-lg-3 form-group").append($("<label></label>").text("Condition Operation:")).append(actionconditionoper));
...
function editPropertiesModalSaveHandler(){
    ...
    if(propertyWithoutCountry){
        showModalConfirmation(function(){
            $('#confirmationModal').modal('hide');
            saveProp();
        }, "Save", "Some Properties doesn't have any country, so it will be deleted. Are you sure you want to save?", "", "", "", "");
    }else{
        saveProp();
    }
}
...
function setPlaceholderControl() {
    ...
    var placeHoldersList = {"fr": [
            ...
            {"type": "verifyNumericEquals", "controlValue": "Integer1", "controlProp": "Integer2", "fatal": ""},
            {"type": "verifyNumericDifferent", "controlValue": "Integer1", "controlProp": "Integer2", "fatal": ""},
            {"type": "verifyNumericGreater", "controlValue": "Integer1 ex : 10", "controlProp": "Integer2 ex : 20", "fatal": ""},
            {"type": "verifyNumericGreaterOrEqual", "controlValue": "Integer1 ex : 10", "controlProp": "Integer2 ex : 20", "fatal": ""},
            {"type": "verifyNumericMinor", "controlValue": "Integer1 ex : 20", "controlProp": "Integer2 ex : 10", "fatal": ""},
            {"type": "verifyNumericMinorOrEqual", "controlValue": "Integer1 ex : 20", "controlProp": "Integer2 ex : 10", "fatal": ""},
