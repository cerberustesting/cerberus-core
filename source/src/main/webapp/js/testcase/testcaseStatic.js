...
var actionOptList = {
    ...
    "click":{"group":"mouse_action","value":"click","label":{"en":"Click","fr":"Cliquer"},"application_types":["GUI","IPA","APK","FAT"],
        ...
        "field2":{"label":{"en": "[Optional] Offset. (ex : 50,100) [GUI,APK,IPA only]", "fr": "[Optionnel] Offset (ex : 50,100) [seulement GUI,APK,IPA]"},"picto":"images/action-numeric.png", "class": "col-lg-12 crb-autocomplete-element crb-contextual-button"}},
