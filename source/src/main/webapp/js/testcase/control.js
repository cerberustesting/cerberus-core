...
var convertToGui = {
    ...
    "verifyStringEqual":{"control":"string_comparison","operator":"equals","field1":{"label":{"en": "String 1", "fr": "Chaine 1"},"picto":"images/action-font.png","class": "col-lg-8"},"field2":{"label":{"en": "String 2", "fr": "Chaine 2"},"picto":"images/action-font.png","class": "col-lg-8"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-4"}},
    ...
    "verifyStringMinor":{"control":"string_comparison","operator":"minor","field1":{"label":{"en": "String 1", "fr": "Chaine 1"},"picto":"images/action-font.png","class": "col-lg-8"},"field2":{"label":{"en": "String 2", "fr": "Chaine 2"},"picto":"images/action-font.png","class": "col-lg-8"}},
    "verifyStringContains":{"control":"string_comparison","operator":"contains","field1":{"label":{"en": "String 1 (ex : toto)", "fr": "Chaine 1 (ex : toto)"},"picto":"images/action-font.png","class": "col-lg-8"},"field2":{"label":{"en": "String 2 (ex : ot)", "fr": "Chaine 2 (ex : ot)"},"picto":"images/action-font.png","class": "col-lg-8"}},
    "verifyStringNotContains":{"control":"string_comparison","operator":"notContains","field1":{"label":{"en": "String 1 (ex : toto)", "fr": "Chaine 1 (ex : toto)"},"picto":"images/action-font.png","class": "col-lg-8"},"field2":{"label":{"en": "String 2 (ex : zot)", "fr": "Chaine 2 (ex : zot)"},"picto":"images/action-font.png","class": "col-lg-8"}},

    "verifyNumericEquals":{"control":"numeric_comparison","operator":"equals","field1":{"label":{"en": "Integer 1 (ex : 1234)", "fr": "Entier 1 (ex : 1234)"},"picto":"images/action-numeric.png","class": "col-lg-8"},"field2":{"label":{"en": "Integer 2 (ex : 1234)", "fr": "Entier 2 (ex : 1234)"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyNumericDifferent":{"control":"numeric_comparison","operator":"different","field1":{"label":{"en": "Integer 1 (ex : 1234)", "fr": "Entier 1 (ex : 123)"},"picto":"images/action-numeric.png","class": "col-lg-8"},"field2":{"label":{"en": "Integer 2 (ex : 1234)", "fr": "Entier 2 (ex : 123)"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyNumericGreater":{"control":"numeric_comparison","operator":"greater","field1":{"label":{"en": "Integer 1 (ex : 12)", "fr": "Entier 1 (ex : 12)"},"picto":"images/action-numeric.png","class": "col-lg-5"},"field8":{"label":{"en": "Integer 2 (ex : 10)", "fr": "Entier 2 (ex : 10)"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyNumericGreaterOrEqual":{"control":"numeric_comparison","operator":"greaterOrEqual","field1":{"label":{"en": "Integer 1 (ex : 12)", "fr": "Entier 1 (ex : 12)"},"picto":"images/action-numeric.png","class": "col-lg-8"},"field2":{"label":{"en": "Integer 2 (ex : 10)", "fr": "Entier 2 (ex : 10)"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyNumericMinor":{"control":"numeric_comparison","operator":"minor","field1":{"label":{"en": "Integer 1 (ex : 10)", "fr": "Entier 1 (ex : 10)"},"picto":"images/action-numeric.png","class": "col-lg-8"},"field2":{"label":{"en": "Integer 2 (ex : 12)", "fr": "Entier 2 (ex : 12)"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyNumericMinorOrEqual":{"control":"numeric_comparison","operator":"minorOrEqual","field1":{"label":{"en": "Integer 1 (ex : 10)", "fr": "Entier 1 (ex : 10)"},"picto":"images/action-numeric.png","class": "col-lg-8"},"field2":{"label":{"en": "Integer 2 (ex : 12)", "fr": "Entier 2 (ex : 12)"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    ...
    "verifyElementEquals":{"control":"element","operator":"equals","field1":{"label":{"en": "Path of the element", "fr": "Chemin de l'élément"},"picto":"images/action-settings.png","class": "col-lg-8"},"field2":{"label":{"en": "Expected element", "fr": "Element"},"picto":"images/action-html.png","class": "col-lg-8"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-4"}},
    "verifyElementDifferent":{"control":"element","operator":"different","field1":{"label":{"en": "Path of the element", "fr": "Chemin de l'élément"},"picto":"images/action-settings.png","class": "col-lg-8"},"field2":{"label":{"en": "Expected element", "fr": "Element"},"picto":"images/action-html.png","class": "col-lg-8"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-4"}},


    "verifyStringArrayContains":{"control":"array","operator":"isArrayString","field1":{"label":{"en": "Array (ex : [\"a\",\"b\",\"c\"])", "fr": "Tableau (ex : [\"a\",\"b\",\"c\"])"},"picto":"images/action-font.png","class": "col-lg-8"},"field2":{"label":{"en": "Text (ex: a)", "fr": "Texte (ex: a)"},"picto":"images/action-font.png","class": "col-lg-8"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-4"}},
    "verifyNumericArrayContains":{"control":"array","operator":"isArrayNumeric","field1":{"label":{"en": "Array (ex : [1,2,3])", "fr": "Tableau (ex : [1,2,3])"},"picto":"images/action-font.png","class": "col-lg-8"},"field2":{"label":{"en": "Integer (ex: 1)", "fr": "Entier (ex: 1)"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyElementTextArrayContains":{"control":"array","operator":"isElementArrayString","field1":{"label":{"en": "Element (ex : xpath=/path/to/element)", "fr": "Element (ex : xpath=/chemin/vers/element)"},"picto":"images/action-html.png","class": "col-lg-8"},"field2":{"label":{"en": "Text (ex: a)", "fr": "Texte (ex: a)"},"picto":"images/action-font.png","class": "col-lg-8"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-4"}},
    "verifyElementNumericArrayContains":{"control":"array","operator":"isElementArrayNumeric","field1":{"label":{"en": "Element (ex : xpath=/path/to/element)", "fr": "Element (ex : xpath=/chemin/vers/element)"},"picto":"images/action-html.png","class": "col-lg-8"},"field2":{"label":{"en": "Integer (ex: 1)", "fr": "Entier (ex: 1)"},"picto":"images/action-font.png","class": "col-lg-8"}},

    "verifyElementTextEqual":{"control":"element_text","operator":"equals","field1":{"label":{"en": "Element (ex : xpath=/path/to/element)", "fr": "Element (ex : xpath=/chemin/vers/element)"},"picto":"images/action-html.png","class": "col-lg-8"},"field2":{"label":{"en": "Text", "fr": "Texte"},"picto":"images/action-font.png","class": "col-lg-8"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-4"}},
    ...
    "verifyElementTextMatchRegex":{"control":"element_text","operator":"matchRegex","field1":{"label":{"en": "Element (ex : xpath=/path/to/element)", "fr": "Element (ex : xpath=/chemin/vers/element)"},"picto":"images/action-html.png","class": "col-lg-8"},"field2":{"label":{"en": "Regex", "fr": "Regex"},"picto":"images/action-font.png","class": "col-lg-8"}},

    "verifyElementNumericEqual":{"control":"element_numeric","operator":"equals","field1":{"label":{"en": "Element (ex : xpath=/path/to/element)", "fr": "Element (ex : xpath=/chemin/vers/element)"},"picto":"images/action-html.png","class": "col-lg-8"},"field2":{"label":{"en": "Numeric", "fr": "Valeur Numérique"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyElementNumericDifferent":{"control":"element_numeric","operator":"different","field1":{"label":{"en": "Element (ex : xpath=/path/to/element)", "fr": "Element (ex : xpath=/chemin/vers/element)"},"picto":"images/action-html.png","class": "col-lg-8"},"field2":{"label":{"en": "Numeric", "fr": "Valeur Numérique"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyElementNumericGreater":{"control":"element_numeric","operator":"greater","field1":{"label":{"en": "Element (ex : xpath=/path/to/element)", "fr": "Element (ex : xpath=/chemin/vers/element)"},"picto":"images/action-html.png","class": "col-lg-8"},"field2":{"label":{"en": "Numeric", "fr": "Valeur Numérique"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyElementNumericGreaterOrEqual":{"control":"element_numeric","operator":"greaterOrEqual","field1":{"label":{"en": "Element (ex : xpath=/path/to/element)", "fr": "Element (ex : xpath=/chemin/vers/element)"},"picto":"images/action-html.png","class": "col-lg-8"},"field2":{"label":{"en": "Numeric", "fr": "Valeur Numérique"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
    "verifyElementNumericMinor":{"control":"element_numeric","operator":"minor","field1":{"label":{"en": "Element (ex : xpath=/path/to/element)", "fr": "Element (ex : xpath=/chemin/vers/element)"},"picto":"images/action-html.png","class": "col-lg-8"},"field2":{"label":{"en": "Numeric", "fr": "Valeur Numérique"},"picto":"images/action-numeric.png","class": "col-lg-8"}},
...
var controlOptList = {
    "unknown":{"value":"unknown","label":{"en":"Define a control","fr":"Choisir un control"},"application_types":["GUI","SRV","IPA","APK","BAT","FAT","NONE"]},
    "string_comparison":{"value":"string_comparison","label":{"en":"String Comparison","fr":"Comparaison de Chaine de Caractère"},"application_types":["GUI","SRV","IPA","APK","BAT","FAT","NONE"],"equals":"verifyStringEqual","different":"verifyStringDifferent","greater":"verifyStringGreater","minor":"verifyStringMinor"}
};
