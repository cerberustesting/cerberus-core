...
var convertToGui = {
    ...
    "verifyStringEqual":{"control":"string_comparison","operator":"equals",
        ...
        "field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-4 crb-autocomplete-variable"}},
    ...
    "verifyNumericGreater":{"control":"numeric_comparison","operator":"greater",
        "field1":{"label":{"en": "Integer 1 (ex : 12)", "fr": "Entier 1 (ex : 12)"},"picto":"images/action-numeric.png","class": "col-lg-5 crb-autocomplete-variable"},
        "field8":{"label":{"en": "Integer 2 (ex : 10)", "fr": "Entier 2 (ex : 10)"},"picto":"images/action-numeric.png","class": "col-lg-8 crb-autocomplete-variable"}},
    ...
    "verifyTitle":{"control":"title","operator":"unknown",
    ...
    "verifyUrl":{"control":"url","operator":"unknown",
