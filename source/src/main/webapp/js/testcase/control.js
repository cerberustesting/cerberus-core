...
var convertToGui = {
    ...
    "verifyStringDifferent":{"control":"string_comparison","operator":"different","field1":{"label":{"en": "String 1", "fr": "Chaine 1"},"picto":"images/action-font.png","class": "col-lg-3"},"field2":{"label":{"en": "String 2", "fr": "Chaine 2"},"picto":"images/action-font.png","class": "col-lg-3"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-3"}},
    ...
    "verifyStringArrayContains":{"control":"array","operator":"isArrayString","field1":{"label":{"en": "Array", "fr": "Tableau"},"picto":"images/action-settings.png","class": "col-lg-4"},"field2":{"label":{"en": "Text", "fr": "Texte"},"picto":"images/action-font.png","class": "col-lg-4"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-3"}},
    ...
    "verifyElementTextArrayContains":{"control":"array","operator":"isElementArrayString","field1":{"label":{"en": "Array Path", "fr": "Chemin vers le Tableau"},"picto":"images/action-settings.png","class": "col-lg-4"},"field2":{"label":{"en": "Text", "fr": "Texte"},"picto":"images/action-font.png","class": "col-lg-4"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-3"}},
    ...
    "verifyElementTextEqual":{"control":"element_text","operator":"equals","field1":{"label":{"en": "Element (ex : data-cerberus=fieldToto)", "fr": "Element (ex : data-cerberus=fieldToto)"},"picto":"images/action-html.png","class": "col-lg-4"},"field2":{"label":{"en": "Text", "fr": "Texte"},"picto":"images/action-font.png","class": "col-lg-4"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-3"}},
