...
var convertToGui = {
    ...
    "verifyStringArrayContains":{"control":"array","operator":"isArrayString","field1":{"label":{"en": "Array", "fr": "Tableau"},"picto":"images/action-settings.png","class": "col-lg-5"},"field2":{"label":{"en": "Text", "fr": "Texte"},"picto":"images/action-font.png","class": "col-lg-5"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-5"}},
    "verifyNumericArrayContains":{"control":"array","operator":"isArrayNumeric","field1":{"label":{"en": "Array", "fr": "Tableau"},"picto":"images/action-settings.png","class": "col-lg-5"},"field2":{"label":{"en": "Text", "fr": "Texte"},"picto":"images/action-font.png","class": "col-lg-5"}},
    "verifyElementTextArrayContains":{"control":"array","operator":"isElementArrayString","field1":{"label":{"en": "Array Path", "fr": "Chemin vers le Tableau"},"picto":"images/action-settings.png","class": "col-lg-5"},"field2":{"label":{"en": "Text", "fr": "Texte"},"picto":"images/action-font.png","class": "col-lg-5"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-5"}},
    "verifyElementNumericArrayContains":{"control":"array","operator":"isElementArrayNumeric","field1":{"label":{"en": "Array Path", "fr": "Chemin vers le Tableau"},"picto":"images/action-settings.png","class": "col-lg-5"},"field2":{"label":{"en": "Text", "fr": "Texte"},"picto":"images/action-font.png","class": "col-lg-5"}},

    "verifyElementTextEqual":{"control":"element_text","operator":"equals","field1":{"label":{"en": "Element (ex : data-cerberus=fieldToto)", "fr": "Element (ex : data-cerberus=fieldToto)"},"picto":"images/action-html.png","class": "col-lg-5"},"field2":{"label":{"en": "Text", "fr": "Texte"},"picto":"images/action-font.png","class": "col-lg-5"},"field3":{"label":{"en": "Case sensitive (Y/N)", "fr": "[opt] Sensible à la Casse (Y/N)"},"picto":"images/action-vote.png","class": "col-lg-5"}},
    ...
    "verifyElementTextMatchRegex":{"control":"element_text","operator":"matchRegex","field1":{"label":{"en": "Element (ex : data-cerberus=fieldToto)", "fr": "Element (ex : data-cerberus=fieldToto)"},"picto":"images/action-html.png","class": "col-lg-5"},"field2":{"label":{"en": "Regex", "fr": "Regex"},"picto":"images/action-font.png","class": "col-lg-5"}},

    "verifyElementNumericEqual":{"control":"element_numeric","operator":"equals","field1":{"label":{"en": "Element (ex : data-cerberus=fieldToto)", "fr": "Element (ex : data-cerberus=fieldToto)"},"picto":"images/action-html.png","class": "col-lg-5"},"field2":{"label":{"en": "Numeric", "fr": "Valeur Numérique"},"picto":"images/action-numeric.png","class": "col-lg-5"}},
    "verifyElementNumericDifferent":{"control":"element_numeric","operator":"different","field1":{"label":{"en": "Element (ex : data-cerberus=fieldToto)", "fr": "Element (ex : data-cerberus=fieldToto)"},"picto":"images/action-html.png","class": "col-lg-5"},"field2":{"label":{"en": "Numeric", "fr": "Valeur Numérique"},"picto":"images/action-numeric.png","class": "col-lg-5"}},
    "verifyElementNumericGreater":{"control":"element_numeric","operator":"greater","field1":{"label":{"en": "Element (ex : data-cerberus=fieldToto)", "fr": "Element (ex : data-cerberus=fieldToto)"},"picto":"images/action-html.png","class": "col-lg-5"},"field2":{"label":{"en": "Numeric", "fr": "Valeur Numérique"},"picto":"images/action-numeric.png","class": "col-lg-5"}},
    ...
    "verifyElementNumericMinor":{"control":"element_numeric","operator":"minor","field1":{"label":{"en": "Element (ex : data-cerberus=fieldToto)", "fr": "Element (ex : data-cerberus=fieldToto)"},"picto":"images/action-html.png","class": "col-lg-5"},"field2":{"label":{"en": "Numeric", "fr": "Valeur Numérique"},"picto":"images/action-numeric.png","class": "col-lg-5"}},
