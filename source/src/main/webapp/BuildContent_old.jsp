...
<!--                <td><%=docService.findLabelHTML("buildrevisionparameters", "Link", "")%></td>-->
        ...
        <%
                ...
                MyLogger.log("BuildContent_old.jsp", Level.FATAL, Version.PROJECT_NAME_VERSION + " - Exception catched." + e.toString());
                out.println("<br> error message : " + e.getMessage() + " " + e.toString() + "<br>");
            } finally {
                try {
                    conn.close();
                } catch (Exception ex) {
                    MyLogger.log("BuildContent_old.jsp", Level.FATAL, Version.PROJECT_NAME_VERSION + " - Exception catched." + ex.toString());
                }
            }
