...
<%--
    LEGACY FALLBACK. InvariantList.jsp now serves the crbTable V2 version
    (js/pages/InvariantListV2.js). To roll back, copy this file over
    InvariantList.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="h-full">
<head>
