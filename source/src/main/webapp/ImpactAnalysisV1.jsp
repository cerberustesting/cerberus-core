...
<%--
    LEGACY FALLBACK. ImpactAnalysis.jsp now serves the crbTable V2 version
    (js/pages/ImpactAnalysisV2.js). To roll back, copy this file over
    ImpactAnalysis.jsp - it still works untouched against the same endpoint.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
