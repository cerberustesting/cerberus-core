...
<%--
    LEGACY FALLBACK. CampaignList.jsp now serves the crbTable V2 version
    (js/pages/CampaignListV2.js). To roll back, copy this file over
    CampaignList.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
        ...
        <meta name="active-page" content="CampaignList.jsp">
        <meta name="page" content="Campaign List">
