...
<%--
    LEGACY FALLBACK. Environment.jsp now serves the crbTable V2 version
    (js/pages/EnvironmentV2.js). To roll back, copy this file over
    Environment.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
