...
<%--
    LEGACY FALLBACK. Test.jsp now serves the crbTable V2 version
    (js/pages/TestV2.js). To roll back, copy this file over
    Test.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
