                        ...
                        <div class="crb_card sticky top-0 z-50" id="executionHeader">
                            ...
                            <div class="row">
                                <div class="col-lg-5 pull-left">
                                    ...
                                    <div class="text-wrap" style="display: flex; align-items: center;">
                                        <img id="AppLogo" style="height:20px; overflow:hidden; text-overflow:clip; border: 0px; padding:0; margin-right: 5px;"></img>
                                        <span id="AppName"> </span>
                                    </div>
                                    <div class="text-wrap" style="display: flex; align-items: center;">
                                        <span id="tcDescription"
                                              style="font-size:.9em;margin:0px;line-height:1;height:.95em;">
                                        </span>
                                    ...
                                    <div class="text-wrap" id="robotInformation" style="display: flex; align-items: center;">

                                        <img id="exBrowserLogo"
                                             style="height:20px; overflow:hidden; text-overflow:clip; border: 0px; padding:0; margin-right: 5px;"
                                             src="">
                                        <span id="exBrowser"
                                              style="font-size:.9em;margin-right: 10px;line-height:1;height:.95em;font-weight: 900;word-wrap: break-word">
                                        </span>
                                        <img id="exOSLogo"
                                             style="height:20px; overflow:hidden; text-overflow:clip; border: 0px; padding:0; margin-right: 5px;"
                                             src="">
                                        ...
                                        <div class="marginRight15 blink" id="liveUrl" style="display: none">
                                            <a href="" target="_blank" id="liveUrlLink">
                                                <span class="label label-primary marginRight5"
                                                      style="font-size:.9em;margin:0px;line-height:1;height:.95em;font-weight: 900;word-wrap: break-word;margin-left: 5px;">
                                                    <span class="glyphicon glyphicon-unchecked" aria-hidden="true"></span>&nbsp;LIVE
                                                </span>
                                            </a>
                                        </div>
                                        <div class="marginRight15 blink" id="liveControlUrl" style="display: none">
                                            <a href="" target="_blank" id="liveControlUrlLink">
                                                <span  class="label label-primary"
                                                       style="font-size:.9em;margin:0px;line-height:1;height:.95em;font-weight: 900;word-wrap: break-word;margin-left: 5px;">
                                                    <span class="glyphicon glyphicon-expand" aria-hidden="true"></span>&nbsp;LIVE CONTROL
                                                </span>
                                            </a>
                                        </div>
                                        <div class="marginRight15" id="videoUrl" style="display: none">
                                            <a href="" target="_blank" id="videoUrlLink">
