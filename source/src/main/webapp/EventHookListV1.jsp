...
<%--
    LEGACY FALLBACK. EventHookList.jsp now serves the crbTable V2 version
    (js/pages/EventHookListV2.js). To roll back, copy this file over
    EventHookList.jsp - it still works untouched against the same servlet.
--%>
<!DOCTYPE html>
<html class="h-full">
    <head>
