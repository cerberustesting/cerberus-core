...
//            LOG.error(exception1.toString(), exception1);
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(", (2, 'testTour', 'testTour.detail', 'RunTest', 1, 1)");
        b.append(", (3, 'createTest', 'createTest.detail', 'Test', 2, 1)");
        ...
        b.append(", (1, 20, '#sidebar', 'changePageAfterClick', '#navMenuTest') ");
        b.append(", (1, 25, '#navMenuTest', 'changePageAfterClick', '#navMenuRun') ");
        b.append(", (1, 30, '#navMenuRun', 'changePageAfterClick', '#navMenuExecutionReporting') ");
        b.append(", (1, 35, '#navMenuExecutionReporting', 'changePageAfterClick', '#navMenuApplication') ");
        b.append(", (1, 40, '#navMenuApplication', 'changePageAfterClick', '#navMenuIntegration') ");
        b.append(", (1, 45, '#navMenuIntegration', 'changePageAfterClick', '#navMenuHelp') ");
        b.append(", (1, 50, '#navMenuHelp', 'default', null) ");
        b.append(", (2, 5, '#sidebar', 'changePageAfterClick', '#menuTestCaseList') ");
        b.append(", (2, 10, '.odd', 'changePageAfterClick', '#testCaseLink') ");
        b.append(", (2, 15, '#stepHeader', 'default', null) ");
        b.append(", (2, 20, '#actionContainer', 'default', null) ");
        b.append(", (2, 25, '#tabsScriptEdit', 'default', null) ");
        b.append(", (2, 30, '#testCaseTitle', 'default', null) ");
        b.append(", (2, 35, '#sidebar', 'changePageAfterClick', '#menuRunTestCase') ");
        b.append(", (2, 40, '#sidebar', 'changePageAfterClick', '#menuRunTestCase') ");
        b.append(", (2, 45, '#testCaseList', 'default', null) ");
        b.append(", (2, 50, '#envSettingsAuto', 'default', null) ");
        b.append(", (2, 55, '#countryList', 'default', null) ");
        b.append(", (2, 60, '#robot', 'default', null) ");
        b.append(", (2, 65, '#executionPanel', 'default', null) ");
        b.append(", (2, 70, '#runTestCaseBlockSticky', 'changePageAfterClick', '#runTestCaseAndSee') ");
        b.append(", (2, 75, null, 'general', null) ");
        b.append(", (3, 5, null, 'general', null) ");
        b.append(", (3, 10, '#sidebar', 'changePageAfterClick', '#menuEditTest') ");
        b.append(", (3, 15, '#createTestButton', 'default', null) ");
        b.append(", (3, 20, '#addEntryModal #test', 'default', null) ");
        b.append(", (3, 25, '#addEntryButton', 'default', null) ");
        b.append(", (3, 30, '.dataTables_scroll', 'changePageAfterClick', 'a#testCaseLink') ");
        b.append(", (3, 35, '#createTestCaseButton', 'default', null) ");
        b.append(", (3, 40, '#editTestCaseModal #description', 'default', null) ");
        b.append(", (3, 45, '#editTestCaseModal #shortDesc', 'default', null) ");
        b.append(", (3, 50, '#editTestCaseModal #application', 'default', null) ");
        b.append(", (3, 55, '#addTestCaseButton', 'default', null) ");
        b.append(", (3, 60, null, 'general', null) ");
        b.append(", (3, 65, '#testCaseTable', 'changePageAfterClick', 'a#testCaseLink') ");
        b.append(", (3, 70, '#tabsScriptEdit', 'default', null) ");
        b.append(", (3, 75, '#addStep', 'default', null) ");
        b.append(", (3, 80, '#addStepModal #description', 'default', null) ");
        b.append(", (3, 85, '#addStepConfirm', 'default', null) ");
        b.append(", (3, 90, '#addActionBottom', 'default', null) ");
        b.append(", (3, 95, '#actionContainer .step-action:nth-child(1)', 'default', null) ");
        b.append(", (3, 100, '#actionContainer .step-action:nth-child(1) .boutonGroup', 'default', null) ");
        b.append(", (3, 105, '#actionContainer .step-action:nth-child(2)', 'default', null) ");
        b.append(", (3, 110, '#saveScript', 'changePageAfterClick', '#saveScript') ");
        b.append(", (3, 115, null, 'general', null) ");
        ...
        b.append(",('interactiveTuto', 'productTour.detail', '', 'en', 'Get Familiar with Cerberus Testing Homepage and Menus', '','') ");
        b.append(",('interactiveTuto', 'productTour.detail', '', 'fr', 'Obtenez un aperçu de la page d\\'accueil et des menus', '','') ");
        b.append(",('interactiveTutoStep', '1.step.5', '', 'en', '<h3>Test Campaign By Tag</h3><p>Access directly your last test campaign execution by tag</p><p>Click on <b>Next</b></p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '1.step.10', '', 'en', '<h3>Test Execution Dashboard</h3><p>Here you can track your test execution record over time</p><p>Click on <b>Next</b></p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '1.step.15', '', 'en', '<h3>Test Workflow</h3><p>Follow here your test implementation workflow status.</p><p>Click on <b>Next</b></p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '1.step.25', '', 'en', '<h3>Test Repository</h3><p>Create, update and manage your <b>Test Repository & Requirements</b> from this menu.</p><ul><li>Navigate to your Test Case list</li><li>Edit directly a specific Test Case</li><li>Manage here the labels assigned to your tests to tag specific features, execution groups, or others</li><li>Organize your tests into folders suited to your needs</li></ul></p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.25', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.30', '', 'en', '<h3>Test Execution</h3><p>Manage here your <b>Test Execution</b> in multiple ways</p><ul><li>Run test cases directly from this first menu</li><li>See your pending executions and update them if needed</li><li>Manage your test robot configuration, especially for web and mobile testing</li><li>Administer your test campaign to launch test suites via the test scheduler or integrated with CI/CD</li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.30', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.35', '', 'en', '<h3>Test Reporting</h3><p>Access here various <b>Test Reporting</b> and <b>Test Analytics</b> dashboards:</p><ul><li>Navigate through the test execution list</li><li>See the trends, results and reliability of a particular test case over-time</li><li>Analyze the result, coverage of a specific test campaign</li><li>Get insights with the campaign test analytics dashboard</li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.35', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.40', '', 'en', '<h3>Test Integration</h3><p>Manage here your <b>application, environment and associated libraries</b></p><ul><li>Create, update and manage application and their correspoding environments, parameters</li><li>Define reusable objects to leverage within your test definition</li><li>Build your service library for your API Testing in REST, SOAP, GraphQL, Kafka, ...</li><li>Administer here your SQL library to create rich, dynamic and secured test dataset</li><li>Customize deployment type for specific integrations in CI/CD</li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.40', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.45', '', 'en', '<h3>Test Administration</h3><p>Administer your <b/>environment and integration</b> parameters in this menu</p><ul><li>Access the history of changes performed in a particular environments</li><li>Customize your environments according to your context and requirements</li><li>Define the structure and format of your application build and revisions</li><li>Describe here the content of your integration release</li><li>Set batch description and constraints for dependencies in Batch testing</li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.45', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.50', '', 'en', '<h3>Help Center</h3><p>Need help? Access anytime here our Documentation and Help Center</p><p>This is the end of the Product Tour!</p><p>Click on <b>Next</b> to choose your next step with Cerberus Testing!</p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '2.step.5', '', 'en', '<h3>Navigate to the Test Repository</h3><p>We will start by accessing the existing test case that we will use as an example.</p><p>Please open the <b>Test</b> menu, then select the <b>Test Case List</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.5', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.10', '', 'en', '<h3>Selecting the Test Case</h3><p>Well Done! We now see the available tests.</p><p>Please select the first one by clicking on the second blue icon <b>Go to Test Case Script Page</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.10', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.15', '', 'en', '<h3>Test Case Definition</h3><p>Great! We are now in the Test Case page, we will cover the main elements of a Test Case.</p><p>A <b>Step</b> is a collection of actions and controls for your tests. You can then reuse them across tests, we will cover that later on.</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.15', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.20', '', 'en', '<h3>Action and Control</h3><p>The blue box shows an <b>Action</b>, that is composed of<ul><li>A plain language description</li><li>An low code action you can select in the available list</li><li>Parameters depending on your action, this can be a target element, a specific data, a text to verify</li></ul></p><p>The green box is a <b>Control</b> that will be performed after the above action, in the same way<ul><li>Select a control from the low code library</li><li>Set your desired verifications parameter or value</li></ul></p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.20', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.25', '', 'en', '<h3>Test Data and Properties</h3><p>This tab <b>Properties</b> enables you to use variables within your tests, that can be linked to your Data Library.</p><p>This is not required for now, we will share later on. <p>Click on <b>Next</p></b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.25', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.30', '', 'en', '<h3>Test Execution Options</h3><p>This <b>Run</b> Menu allows you to manually launch a test, in a variety of ways :<ul><li><b>Run Test Case</b> will let you select all the execution settings in the run page</li><li><b>ReRun Test Case</b> move you to the run page with the same execution settings of the last execution</li><li><b>ReRun From Queue</b> let you launch the test with the last execution parameters in the background</li><li><b>ReRun From Queue and See</b> will also launch the test in the same executions settings, but you will be able to see it live</li></ul></p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.30', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.35', '', 'en', '<h3>Accessing the Run Page</h3><p>To start, we will define the test run settings by accessing the execution page!</p><p>We will access the page using the left menu.</p><p>Go to the <b>Run > Run Test Case</b> menu</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.35', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.40', '', 'en', '<h3>Test Execution Page</h3><p>We are now on the page that let you run tests at your convenience.</p><p>They can selected manually or directly from an existing campaign</p><p>For our example, we will select the test that is available</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.40', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.45', '', 'en', '<h3>Test Case Selection</h3><p>Select here the firt Test Case <b>0001A</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.45', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.50', '', 'en', '<h3>Environment Selection</h3><p>Select the environments you would like to launch your Test.</p><p>They can be launched on a single or multiple environments, on existing or a custom one you would like to use for your test (manual).</p><p>For now leave it as <b>PROD</b> and click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.50', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.55', '', 'en', '<h3>Environment Selection</h3><p>This is the list of country where you can execute your tests</p><p>This list is customisable to your own needs</p><p>Proceed by selecting <b>FR</b>, then click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.55', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.60', '', 'en', '<h3>Test Hub Selection</h3><p>Choose where you want to launch your test : local or remote hub</p><p>To simplify your test automation, Cerberus provides you native and ready-to-use integrations</p><p>Select one <b>option</b> and click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.60', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.65', '', 'en', '<h3>Advanced Execution Options</h3><p>You can customise your execution with a specific tag, logging level, screenshots, automated rerun, ...</p><p>For this tour, we will leave them as default, click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.65', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.70', '', 'en', '<h3>Test Case Launch</h3><p>All Right! You are now ready to launch your first test</p><p>Click on <b>Run Test Case (and See Result)</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.70', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.75', '', 'en', '<p>Congratulations! Your first test is now running, you will be able to access its result soon.</p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '3.step.5', '', 'en', '<h3>Test Repository Tutorial</h3><p>Welcome to this Test Creation Tutorial, at the end of this tutorial, you will be able to<ul><li>Manage your Test folder</li><li>Create a Test Case</li><li>Define Actions and Controls </li></ul></p><p>We will guide you through the various steps inside Cerberus Testing with a pop-up that will indicate to either<ul><li>Click on an element</li><li>Fill in a particular field</li><li>Information note where you only need to click on the <b>Next</b> button</li></ul></p><p>Each pop-up will confirm the step to be taken. Ready? Let\\'s get started!</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.5', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.10', '', 'en', '<h3>Create a Test Repository</h3><p>We will start by initiate the <b>Test Repository</b> accessible in this menu.</p><p>Please naviguate to <b>Test > Test Folder</b>.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.10', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.15', '', 'en', '<h3>Test Folder Creation</h3><p>Great! You are now on the page that let you administer your Test folder.</p><p>We will now create a new Test folder that we will use through the tutorial</p><p>Click on <b>Create Test Folder</b>.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.15', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.20', '', 'en', '<h3>Test Folder Settings</h3><p>Great! You now need to define your Test folder parameter.</p><p><b>Fill</b> here your test folder name, then Click on <b>Next</b>.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.20', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.25', '', 'en', '<h3>Test Folder Creation</h3><p>Confirm the Test folder creation by clicking on the <b>Create</b> button.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.25', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.30', '', 'en', '<h3>Test Folder Content</h3><p>Well done! Your test folders will appear here.</p><p>We will now access the Test folder content by clicking on the <b>blue icon </b> (Go To Test Case List).</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.30', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.35', '', 'en', '<h3>Test Case List</h3><p>You have now access to the test cases inside your test folder.</p><p>We will create a new test case by clicking on <b>Create Test Case</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.35', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.40', '', 'en', '<h3>Test Case Header</h3><p>This page enables you to define your Test Case header information such as description, use-case, environment, status and other settings.</p><p>We will fill the mininal information to keep things simple</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.40', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.45', '', 'en', '<h3>Test Case Description</h3><p><b>Fill</b> here your test case description, traditionally a use-case, test case or requirement reference</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.45', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.50', '', 'en', '<h3>Test Case Application</h3><p>A Test Case is executed upon a particular application available on a serie of environment and country. That way, the configuration is not duplicated is each test case.</p><p><b>Select</b> now the application.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.50', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.55', '', 'en', '<h3>Test Case Creation</h3><p>Confirm the Test Case creation by clicking on <b>Create</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.55', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.60', '', 'en', '<h3>Test Case Creation</h3><p>Congratulations! Your Test Case have been created!</p><p>The next step is to define your test actions and controls by accessing the test case detail.</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.60', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.65', '', 'en', '<h3>Test Case Detail</h3><p>We will access the Test Case by clicking on the <b>left blue icon </b> (Go To Test Case Script Page)</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.65', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.70', '', 'en', '<h3>Test Case Content</h3><p>Good! You are now on the Test Case page where you can define your action, control and properties.</p><p>A Test Case is composed of major elements we will cover<ul><li><b>Step</b> that group actions and controls into logical steps, for ease of understanding and organisation</li><li><b>Action</b> that describes every action that the test must perform</li><li><b>Control</b> that are executed after the linked actions to perform regular verifications</li></ul></p><p>You can combine step, action and control as you wish, even have multiple controls for the same action.</p><p>For this tutorial, we will keep things simple and create one action and control</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.70', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.75', '', 'en', '<h3>Test Case Step</h3><p>We need to add a step first, click on <b>Add step</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.75', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.80', '', 'en', '<h3>Test Case Step</h3><p>A step is a convenient way to organize your actions and controls around use-cases and major blocks of your test case. They can even be reused in other tests</p><p>For now, <b>fill</b> the step description, then click on <b>Next</b>.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.80', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.85', '', 'en', '<h3>Test Case Step</h3><p>Click on <b>Create</b> to confirm your Step creation.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.85', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.90', '', 'en', '<h3>Test Case Action & Control</h3><p>Great! We now need to add an action and a control to our test.</p><p>Let\\'s start by adding an Action by clicking on <b>Add Action</b>.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.90', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.95', '', 'en', '<h3>Test Case Action</h3><p>Describe and select here your desired action from the low code library.</p><p><b>Fill</b> first the description, then select the action.</p><p>If you are unsure, leave it to <b>doNothing</b>.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.95', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.100', '', 'en', '<h3>Test Case Control</h3><p>You are quite there, we only miss to add one control.</p><p></p>You can here add or remove action and control from your test<ul><li>The <b>Blue</b> is to <b>Add an action</b></li><li>The <b>Green</b> is to <b>Add a control</b></li><li>The <b>Red</b> one is to <b>Remove</b> an action or control.</li></ul><p>Click on the <b>Green Plus Sign</b> in order to </b>Add a control.</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.100', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.105', '', 'en', '<h3>Test Case Control</h3><p>As for the action, <b>Fill</B> the description and select a control from the library, or leave it to <b>unknown</b> for now.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.105', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.110', '', 'en', '<h3>Save Test Case</h3><p>You need to save your test case o keep your changes.</p><p>Click on the <b>Save Test Case</b> button</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.110', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.115', '', 'en', '<h3>Test Case Tutorial Completed</h3><p>Great job! You have finished the Test Case creation tutorial.</p><p>It should have helped you understand better the steps to manage your test, test cases and how to add actions and controls.</p><p>You can now enjoy Cerberus or use one of the tutorial directed to a particular test such as Web, App or API</p><p>Happy Testing!</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.115', '', 'fr', '', '','') ");
