...
//        b.append(", (3, 75, null, 'general', null) ");
        ...
        b.append(",('interactiveTuto', 'productTour.detail', '', 'fr', 'Introduction à Cerberus Testing', '','') ");
        b.append(",('interactiveTutoStep', '1.step.2', '', 'en', '<h3>Introduction Tutorial</h3><p>Welcome to this Introduction Tutorial, this tutorial will present you:<ul><li>The <b>content of the Homepage</b> section by section.</li><li>All <b>menus entries</b> by presenting the associated concepts and features behind each entry.</li></ul><p>Each pop-up will confirm the step to be taken. Ready? Let\\'s get started!</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.2', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.5', '', 'en', '<h3>Campaign Execution</h3><p>Access directly your last campaign executed and check their corresponding results</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '1.step.10', '', 'en', '<h3>Test Execution Dashboard</h3><p>Here you can see the number of execution done day by day (color code correspond to the status of each execution)</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '1.step.15', '', 'en', '<h3>Test Coverage variation</h3><p>Follow here the number of testcase you created split by their workflow status.</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '1.step.20', '', 'en', '<h3>Cerberus Testing Menus</h3><p>We will now go through the various menus of Cerberus Testing!</p><p>They are organized around the different test automation areas (Test Repository, Execution, ...).</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.20', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.25', '', 'en', '<h3>Test Repository</h3><p class=\\'tutoA\\'>Click on <b>Test</b> in order to discover its various entries.</p><ul><li>Create, update and manage your test cases from <b>TestCase List</b>.</li><li>Edit your test case script from <b>Edit TestCase</b></li><li>Manage the labels that will allow you to group and organise your test cases by sticker or requirement from <b>Label</b></li><li>Manage your test case folders from <b>Test Folder</b></li></ul><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.25', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.27', '', 'en', '<h3>Test Data Management</h3><p class=\\'tutoA\\'>Click on <b>Data</b> in order to discover its various entries.</p><ul><li>Create, update and manage your test data libraries from <b>Data Library</b>. A data library can access a REST or SOAP service but also directly a database with an SQL query</li></ul><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.27', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.30', '', 'en', '<h3>Test Execution</h3><p class=\\'tutoA\\'>Click on <b>Run</b> in order to discover the various entries.</p><p>Manage here your <b>Test Execution</b> in multiple ways</p><ul><li>Run test cases one by one or by campaign from <b>Run Test Case</b></li><li>See your queued executions and either, cancel them, update their priorities or rerun them from <b>Executions in queue</b></li><li>Manage your test robot configuration from <b>Robot</b>. A robot is defining the browser or device parameters used to execute a test case (ex : version of the browser, size of the screens and various capabilities of the device)</li><li>Manage your test campaign from <b>Campaign</b>. A campaign define a list of test case execution to be executed from a list of test cases and a list of environments and countries and a list of devices. Campaign can be easilly executed from CICD systems of even scheduled on specific timing</li></ul><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.30', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.35', '', 'en', '<h3>Execution Reporting</h3><p class=\\'tutoA\\'>Click on <b>Execution Reporting</b> in order to discover the various entries.</p><p>Access here various Reporting and Analytics dashboards:</p><ul><li>Navigate through the test execution list from <b>Execution List</b></li><li>See the trends, results and reliability of a particular test case over-time from <b>Execution Report Over Time</b></li><li>Analyze the result and coverage of a specific test campaign from <b>Campaign execution report</b></li><li>Get insights with the campaign test analytics dashboard from <b>Campaign Report Over Time</b></li></ul><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.35', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.40', '', 'en', '<h3>Application Management</h3><p class=\\'tutoA\\'>Click on <b>Application</b> in order to discover the various entries.</p><p>Manage here your <b>application, environment and associated libraries</b></p><ul><li>Create, update and manage your applications and their corresponding environments and parameters from <b>Application</b></li><li>Define reusable objects to leverage within your test definition from <b>Application Object</b></li><li>Build your service library from <b>Service Library</b>. Service support REST, SOAP, GraphQL, Kafka, or FTP connectivity.</li><li>Administer your SQL library from <b>SQL Library</b> to create rich, dynamic and secured test dataset</li><li>Customize deployment type for specific integrations in a CI/CD environment from <b>Deployment Type</b></li></ul><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.40', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.42', '', 'en', '<h3>Integration</h3><p class=\\'tutoA\\'>Click on <b>Integration</b> in order to discover the various entries.</p><p>Manage here your <b>environments</b> for each system</p><ul><li>Consult the status of all your environments as well as their latest changes from <b>Integration Status</b></li><li>Create, update and manage all environments and their associated applications and parameters from <b>Environment</b></li><li>Defined the major and minor version allowed for each system from <b>Versioning Definition</b></li><li>Describe here the content of your release from <b>Build Content</b></li><li>Set and decribe allowed events for each system from <b>Environment Events</b></li></ul><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.42', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.45', '', 'en', '<h3>System Administration</h3><p class=\\'tutoA\\'>Click on <b>Administration</b> in order to discover the various entries.</p><p>Administer Cerberus Testing from this menu</p><ul><li>Configure the list of system allowed per user as well as access to Keycloack in order to create, delete and modify the users from <b>User Management</b></li><li>Access the full tracability of events done on Cerberus from <b>Log Viewer</b></li><li>Check that Cerberus database has the latest updates from <b>Database Maintenance</b></li><li>Check and modify system parameters from <b>Parameters</b></li><li>Modify invariants from <b>Invariant</b>. Invariant is a concept in Cerberus that allow to administer a list of various values that does not change very often inside Cerberus. Ex : countries, environment, Capabilities, User Agents, ...</li><li>Consult some system information of Cerberus such as JVM memory consumption, database version or scheduled campaigns status from <b>Cerberus Monitoring</b></li></ul><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.45', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.50', '', 'en', '<h3>Help Center</h3><p class=\\'tutoA\\'>Click on <b>Help</b> in order to discover the various entries.</p><p>Need help? Access anytime here our detailed Documentation from <b>Documentation</b></p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.50', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.60', '', 'en', '<h3>Product Tour finished</h3><p>This is the end of the Product Tour!</p><p>We hope it gave you a good overview of Cerberus Testing feature.</p><p class=\\'tutoA\\'>Click on <b>Done</b> in order to leave the tutorial and start your automated testing experience with Cerberus Testing!!</p>', '','') ");
        ...
        b.append(",('interactiveTuto', 'createTest.detail', '', 'fr', 'Création d\\'un cas de test', '','') ");
        ...
        b.append(",('interactiveTutoStep', '2.step.10', '', 'en', '<h3>Test Repository</h3><p>We will start by going to the <b>Test Repository</b> that is accessible from this menu.</p><p class=\\'tutoA\\'>Please naviguate to:<br><b>Test >> Test Case List</b> menu.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.10', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.15', '', 'en', '<h3>Test Case List</h3><p>You have now access to all the test cases that exist in your repository.</p><p class=\\'tutoA\\'>We will create a new test case by clicking on <b>Create Test Case</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.15', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.20', '', 'en', '<h3>Test Case Creation</h3><p>This page let you define all your test case information : description, status, execution settings, ...</p><p>We will configure the main information to keep things simple.</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.20', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.25', '', 'en', '<h3>Test Case Folder</h3><p>You are able to organize your Test Cases inside Test folders. All Test cases belong to a unique Folder.</p><p><b>Click on the pre-selected folder</b> in order to select another one or type a new entry that will be created automatically.</p><p class=\\'tutoA\\'>Click on <b>Next</b> once finished.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.25', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.30', '', 'en', '<h3>Test Case ID</h3><p>Cerberus automatically generated a unique ID on that folder but of course that can be changed to any value. That ID in addition with the folder will identify the test case.</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.30', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.35', '', 'en', '<h3>Test Case Description</h3><p>Fill here your <b>test case description</b>, traditionally a use-case, test case or requirement reference</p><p>The format usually format a use-case format such as : <i>As a user, I want to login and verify the homepage access</i>.</p><p>For this example, let\\'s fill with <b><i>As a web user, I want to access google</i></b></p><p class=\\'tutoA\\'>Click on <b>Next</b> once finished.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.35', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.40', '', 'en', '<h3>Test Case Application</h3><p>A Test Case is linked to a particular application. Each application holds the various endpoint of each environment and country where the application runs.</p><p>Thanks to that, test cases can be created once and executed against any environment with no effort.</p><p>This information is mandatory for each test case.</p><p class=\\'tutoA\\'><b>Select Google</b> in the list and then, Click on <b>Next</b>.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.40', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.45', '', 'en', '<h3>Test Case Creation</h3><p class=\\'tutoA\\'>Confirm the Test Case creation by clicking on <b>Create</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.45', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.50', '', 'en', '<h3>Test Case Creation</h3><p>Congratulations! Your Test Case have been created!</p><p>Cerberus automatically open the script page. The next step is now to define your test actions and controls.</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.50', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.60', '', 'en', '<h3>Test Case Content</h3><p>A Test Case is composed of major elements:<ul><li><b>Steps</b> that group actions and controls into logical steps for ease of understanding and organisation. Every step can be reused from different testcase allowing to build your test cases just like you would play LEGO</li><li><b>Action</b> that describes every action that the test must perform inside the application currently tested.</li><li><b>Control</b> that can be performed after each action in order to control the expected behaviour of the application.</li><li><b>Properties</b> that contain data that is either defined as part of the test or dynamically retreived from the application to be used later on other actions.</li><li><b>Inherited Properties</b> that describes the properties that come from Steps that are used from other test cases.</li></ul></p><p>You can combine step, action and control as you wish, even have multiple controls for the same action.</p><p>For this tutorial, we will keep things simple and create one action and control</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.60', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.80', '', 'en', '<h3>Test Case Action</h3><p>Let\\'s create our simple action!</p><p class=\\'tutoA\\'>Click on <b>Add Action</b> button.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.80', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.85', '', 'en', '<h3>Test Case Action</h3><p>Describe and select here your desired action from the low code library.</p><p class=\\'tutoA\\'><ul><li>Fill the <b>Description</b> with <b><i>Open the google url</i></b></li><li><b>Select the Action</b> on the box <b><i>openUrl</i></b></li><li>Fill the <b>parameter</b> with <b><i>www.google.com</i></b></li></ul></p><p class=\\'tutoA\\'>Click on <b>Next</b> once finished.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.85', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.90', '', 'en', '<h3>Test Case Control</h3><p>You are almost there, we now need to add one control.</p><p>From each action, you can here add or remove action and control from your test.</p><ul><li>The <b>Blue</b> button, <b>Adds an action</b></li><li>The <b>Green</b> one <b>Adds a control</b></li><li>The <b>Red</b> <b>Remove</b> the action.</li></ul><p class=\\'tutoA\\'>Click <b>Green Plus Sign</b> in order to Add a control.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.90', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.95', '', 'en', '<h3>Test Case Control</h3><p>As for the Action, we will define our Control using the available library</p><p>Start by<ul><li>Fill the <b>Description</b> with <b><i>Verify access to google page</i></b></li><li><b>Select the Control</b> on the box <b>verifyTextInPage</b></li><li><b>Fill the parameter</b> with <b>google</b></li></ul></p><p class=\\'tutoA\\'>Click on <b>Next</b> once finished.</p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '3.step.40', '', 'en', '<h3>Test Execution Page</h3><p>We are now on the page that let you run tests at your convenience.</p><p>First, we can choose either to select all criteria for the execution manually or automatically using what has been defined from an existing campaign</p><p>For our example, you can leave <i><b>Manual Selection</b></i> so that we can go through all different parameters required.</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.40', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.45', '', 'en', '<h3>Test Case Selection</h3><p>You can select one or multiple test cases to execute. Just press CTRL key in order to activate multiple selection.</p><p class=\\'tutoA\\'>For our selection, select only one Test Case:<br><b><i>Examples - 5004A [Google] Google Search on weather forecast</i></b></p><p class=\\'tutoA\\'>Then, click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.45', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.50', '', 'en', '<h3>Environment Selection</h3><p>Select the environments you would like to launch your Test.</p><p>Again, you can pick one or several environments, you can even select a manual environment by defining directly the URL of the application to test.</p><p class=\\'tutoA\\'>For this tutorial just select <b><i>PROD</i></b> and click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.50', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.55', '', 'en', '<h3>Country Selection</h3><p>This is the list of country where you can execute your tests</p><p>This list is of course customisable to your own needs.</p><p class=\\'tutoA\\'>Proceed by selecting <b>FR</b>, then click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.55', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.60', '', 'en', '<h3>Test Robot Selection</h3><p>Choose where you want to launch your test. A robot correspond to the browser or device configuration from where the test will be executed.</p><p>Of course that parameter is not required in case the test case is an API test.</p><p class=\\'tutoA\\'>Select <i><b>CerberusChromeProxy</b></i> and click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.60', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.65', '', 'en', '<h3>Advanced Execution Options</h3><p>You can customise your execution with various parameters: <ul><li>a <b>Tag</b> allows to link all execution submited to a unique identifier that produce a global campaign report</li><li>Various logs level in order to tune the level of data collected during the test, a global <b>Verbose</b> level, <b>Screenshots</b>, <b>Videos</b>, <b>Page Source</b>, <b>Robot Logs</b> (Selenium or Appium) or browser <b>Console logs</b>.</li><li><b>Timeout</b> parameter in milisecond that allows to tune the time Cerberus will wait until considering an element is not present</li><li><b>Retries</b> allows to define the number of times, Cerberus will resubmit the execution until it gets an OK status</li><li><b>Priority</b> define how fast the execution will be taken in case it gets queued</li><li><b>Manual Execution</b> allow to submit the test case in a manual way. That means that an operator will have to report the result manually from the execution page.</li></ul><p class=\\'tutoA\\'>Just leave all parameters as default and click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.65', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.70', '', 'en', '<h3>Test Case Launch</h3><p>All Right! You are now ready to launch your first test.</p><p>Once submitted, you will be redirected to the execution report screen and will see it running and report the result.</p><p class=\\'tutoA\\'>Click on <b>Run Test Case (and See Result)</b> and end the tutorial.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.70', '', 'fr', '', '','') ");
//        b.append(",('interactiveTutoStep', '3.step.75', '', 'en', '<h3>Congratulations!</h3><p>Congratulations! Your first test is now running, you will be able to access its result soon.</p>', '','') ");
