...
//        b.append(", (2, 55, '#testCaseTable', 'changePageAfterClick', 'a#testCaseLink') ");
        b.append(", (2, 60, '#tabsScriptEdit', 'default', null) ");
//        b.append(", (2, 65, '#addStep', 'default', null) ");
//        b.append(", (2, 70, '#addStepModal #description', 'default', null) ");
//        b.append(", (2, 75, '#addStepConfirm', 'default', null) ");
        ...
        b.append(", (3, 5, '#sidebar', 'changePageAfterClick', '#menuTestCaseList') ");
        b.append(", (3, 10, '.odd', 'changePageAfterClick', '#testCaseLink') ");
        b.append(", (3, 15, '#stepHeader', 'default', null) ");
        b.append(", (3, 20, '#actionContainer', 'default', null) ");
        b.append(", (3, 25, '#tabsScriptEdit', 'default', null) ");
        b.append(", (3, 30, '#testCaseTitle', 'default', null) ");
        b.append(", (3, 35, '#sidebar', 'changePageAfterClick', '#menuRunTestCase') ");
        b.append(", (3, 40, '#selectionPanel', 'default', null) ");
        b.append(", (3, 45, '#testCaseList', 'default', null) ");
        b.append(", (3, 50, '#envSettingsAuto', 'default', null) ");
        b.append(", (3, 55, '#countryList', 'default', null) ");
        b.append(", (3, 60, '#robot', 'default', null) ");
        b.append(", (3, 65, '#executionPanel', 'default', null) ");
        b.append(", (3, 70, '#runTestCaseBlockSticky', 'changePageAfterClick', '#runTestCaseAndSee') ");
        b.append(", (3, 75, null, 'general', null) ");
        ...
        b.append("('interactiveTuto', 'productTour', '', 'en', 'Take a Tour', '','') ");
        b.append(",('interactiveTuto', 'productTour', '', 'fr', 'Introduction á Cerberus Testing', '','') ");
        b.append(",('interactiveTuto', 'productTour.detail', '', 'en', 'Get Familiar with Cerberus Homepage and Menus', '','') ");
        b.append(",('interactiveTuto', 'productTour.detail', '', 'fr', 'Obtenez un aperçu de la page d\\'accueil et des menus', '','') ");
        b.append(",('interactiveTutoStep', '1.step.5', '', 'en', '<h3>Campaign Execution</h3><p>Access directly your last campaign executed and check their corresponding results</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.5', '', 'fr', '<h3>Campagne de Test</h3><p>Accédez ici directement aux résultats de vos derniéres campagnes de test</p><p>Appuyez sur <b>Suivant</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.10', '', 'en', '<h3>Test Execution Dashboard</h3><p>Here you can see the number of execution done day by day (color code correspond to the status of each execution)</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.10', '', 'fr', '<h3>Tableau de bord des exécutions</h3><p>Gardez ici une vue globale sur l\\'exécution de vos tests</p><p>Appuyez sur <b>Suivant</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.15', '', 'en', '<h3>Test Coverage variation</h3><p>Follow here the number of testcase you created split by their workflow status.</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.15', '', 'fr', '<h3>Statut et Workflow</h3><p>Pilotez l\\'implémentation de vos tests avec le suivi de leur statut</p><p>Appuyez sur <b>Suivant</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.20', '', 'en', '<h3>Cerberus Testing Menus</h3><p>We will now go through the various menus of Cerberus Testing!</p><p>They are organized around the different test automation areas (Test Repository, Execution, ...).</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.20', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.25', '', 'en', '<h3>Test Repository</h3><p>Click on <b>Test</b> in order to discover its various entries.</p><ul><li>Create, update and manage your test cases from <b>TestCase List</b>.</li><li>Edit your test case script from <b>Edit TestCase</b></li><li>Manage the labels that will allow you to group and organise your test cases by sticker or requirement from <b>Label</b></li><li>Manage your test case folders from <b>Test Folder</b></li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.25', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.27', '', 'en', '<h3>Test Data Management</h3><p>Click on <b>Data</b> in order to discover its various entries.</p><ul><li>Create, update and manage your test data libraries from <b>Data Library</b>. A data library can access a REST or SOAP service but also directly a database with an SQL query</li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.27', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.30', '', 'en', '<h3>Test Execution</h3><p>Click on <b>Run</b> in order to discover the various entries.</p><p>Manage here your <b>Test Execution</b> in multiple ways</p><ul><li>Run test cases one by one or by campaign from <b>Run Test Case</b></li><li>See your queued executions and either, cancel them, update their priorities or rerun them from <b>Executions in queue</b></li><li>Manage your test robot configuration from <b>Robot</b>. A robot is defining the browser or device parameters used to execute a test case (ex : version of the browser, size of the screens and various capabilities of the device)</li><li>Manage your test campaign from <b>Campaign</b>. A campaign define a list of test case execution to be executed from a list of test cases and a list of environments and countries and a list of devices. Campaign can be easilly executed from CICD systems of even scheduled on specific timing</li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.30', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.35', '', 'en', '<h3>Execution Reporting</h3><p>Click on <b>Execution Reporting</b> in order to discover the various entries.</p><p>Access here various Reporting and Analytics dashboards:</p><ul><li>Navigate through the test execution list from <b>Execution List</b></li><li>See the trends, results and reliability of a particular test case over-time from <b>Execution Report Over Time</b></li><li>Analyze the result and coverage of a specific test campaign from <b>Campaign execution report</b></li><li>Get insights with the campaign test analytics dashboard from <b>Campaign Report Over Time</b></li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.35', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.40', '', 'en', '<h3>Application Management</h3><p>Click on <b>Application</b> in order to discover the various entries.</p><p>Manage here your <b>application, environment and associated libraries</b></p><ul><li>Create, update and manage your applications and their corresponding environments and parameters from <b>Application</b></li><li>Define reusable objects to leverage within your test definition from <b>Application Object</b></li><li>Build your service library from <b>Service Library</b>. Service support REST, SOAP, GraphQL, Kafka, or FTP connectivity.</li><li>Administer your SQL library from <b>SQL Library</b> to create rich, dynamic and secured test dataset</li><li>Customize deployment type for specific integrations in a CI/CD environment from <b>Deployment Type</b></li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.40', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.42', '', 'en', '<h3>Integration</h3><p>Click on <b>Integration</b> in order to discover the various entries.</p><p>Manage here your <b>environments</b> for each system</p><ul><li>Consult the status of all your environments as well as their latest changes from <b>Integration Status</b></li><li>Create, update and manage all environments and their associated applications and parameters from <b>Environment</b></li><li>Defined the major and minor version allowed for each system from <b>Versioning Definition</b></li><li>Describe here the content of your release from <b>Build Content</b></li><li>Set and decribe allowed events for each system from <b>Events</b></li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.42', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.45', '', 'en', '<h3>System Administration</h3><p>Click on <b>Administration</b> in order to discover the various entries.</p><p>Administer Cerberus Testing from this menu</p><ul><li>Configure the list of system allowed per user as well as access to Keycloack in order to create, delete and modify the users from <b>User Management</b></li><li>Access the full tracability of events done on Cerberus from <b>Log Viewer</b></li><li>Check that Cerberus database has the latest updates from <b>Database Maintenance</b></li><li>Check and modify system parameters from <b>Parameters</b></li><li>Modify invariants from <b>Invariant</b>. Invariant is a concept in Cerberus that allow to administer a list of various values that does not change very often inside Cerberus. Ex : countries, environment, Capabilities, User Agents, ...</li><li>Consult some system information of Cerberus such as JVM memory consumption, database version or scheduled campaigns status from <b>Cerberus Monitoring</b></li></ul><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.45', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.50', '', 'en', '<h3>Help Center</h3><p>Click on <b>Help</b> in order to discover the various entries.</p><p>Need help? Access anytime here our detailed Documentation from <b>Documentation</b></p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.50', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '1.step.60', '', 'en', '<h3>Product Tour finished</h3><p>This is the end of the Product Tour!</p><p>We hope it gave you a good overview of Cerberus Testing feature.</p><p>Click on <b>Done</b> in order to leave the tutorial and start your automated testing experience with Cerberus Testing!!</p>', '','') ");
        b.append(",('interactiveTutoStep', '1.step.60', '', 'fr', '', '','') ");
        b.append(",('interactiveTuto', 'createTest', '', 'en', 'Create a Test', '','') ");
        b.append(",('interactiveTuto', 'createTest', '', 'fr', '', '','') ");
        b.append(",('interactiveTuto', 'createTest.detail', '', 'en', 'A step by step guide to organize and create your test cases', '','') ");
        b.append(",('interactiveTuto', 'createTest.detail', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.5', '', 'en', '<h3>Test Repository Tutorial</h3><p>Welcome to this Test Creation Tutorial, at the end of this tutorial, you will be able to<ul><li>Manage your Test folder</li><li>Create a Test Case</li><li>Define Actions and Controls </li></ul></p><p>We will guide you through the various steps inside Cerberus Testing with a pop-up that will indicate to either<ul><li>Click on an element</li><li>Fill in a particular field</li><li>Information note where you only need to click on the <b>Next</b> button</li></ul></p><p>Each pop-up will confirm the step to be taken. Ready? Let\\'s get started!</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.5', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.10', '', 'en', '<h3>Test Repository</h3><p>We will start by initiate the <b>Test Repository</b> accessible in this menu.</p><p>Please naviguate to <b>Test ></b>, then click on <b>Test Case List</b> menu</b>.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.10', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.15', '', 'en', '<h3>Test Case List</h3><p>You have now access to the test cases inside your test folder.</p><p>We will create a new test case by clicking on <b>Create Test Case</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.15', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.20', '', 'en', '<h3>Test Case Creation</h3><p>This page let you define all your test case information : description, status, execution settings, ...</p><p>We will configure the main information to keep things simple.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.20', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.25', '', 'en', '<h3>Test Case Folder</h3><p>You are able to organize your Test Cases inside Test folders.</p><p><b>Click on the menu</b> in order to see the list appearing to fill or create your own test folder.</p><p><b>Fill or select</b> here your Test folder.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.25', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.30', '', 'en', '<h3>Test Case Header</h3><p>This page enables you to define your Test Case header information such as description, use-case, environment, status and other settings.</p><p>We will fill the mininal information to keep things simple</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.30', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.35', '', 'en', '<h3>Test Case Description</h3><p><b>Fill</b> here your test case description, traditionally a use-case, test case or requirement reference</p><p>The format usually format a use-case format such as : As a user, I want to login and verify the homepage access.</p><p>For this example, let\\'s fill with <b>As a web user, I want to access google</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.35', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.40', '', 'en', '<h3>Test Case Application</h3><p>A Test Case is executed upon a particular application available on a serie of environment and country, also known as the <b>Application under Test</b>.</p><p>That way, the configuration is not duplicated is each test case.</p><p><b>Select Google</b> in the list</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.40', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.45', '', 'en', '<h3>Test Case Creation</h3><p>Confirm the Test Case creation by clicking on <b>Create</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.45', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.50', '', 'en', '<h3>Test Case Creation</h3><p>Congratulations! Your Test Case have been created!</p><p>The next step is to define your test actions and controls by accessing the test case detail.</p><p>Click on <b>Yes</b> in order to get to script page</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.50', '', 'fr', '', '','') ");
//        b.append(",('interactiveTutoStep', '2.step.55', '', 'en', '<h3>Test Case Detail</h3><p>We will access the Test Case by clicking on the <b>left blue icon </b> (Go To Test Case Script Page)</p>', '','') ");
//        b.append(",('interactiveTutoStep', '2.step.55', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.60', '', 'en', '<h3>Test Case Content</h3><p>Good! You are now on the Test Case page where you can define your action, control and properties.</p><p>A Test Case is composed of major elements we will cover<ul><li><b>Step</b> that group actions and controls into logical steps, for ease of understanding and organisation</li><li><b>Action</b> that describes every action that the test must perform</li><li><b>Control</b> that are executed after the linked actions to perform regular verifications</li></ul></p><p>You can combine step, action and control as you wish, even have multiple controls for the same action.</p><p>For this tutorial, we will keep things simple and create one action and control</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.60', '', 'fr', '', '','') ");
//        b.append(",('interactiveTutoStep', '2.step.65', '', 'en', '<h3>Test Case Step</h3><p>We need to add a step first, click on <b>Add step</b></p>', '','') ");
//        b.append(",('interactiveTutoStep', '2.step.65', '', 'fr', '', '','') ");
//        b.append(",('interactiveTutoStep', '2.step.70', '', 'en', '<h3>Test Case Step</h3><p>A step is a convenient way to organize your actions and controls around use-cases and major blocks of your test case. They can even be reused in other tests</p><p>For now, you can fill it with <b>Standard Search on Google</b> inside the step description, then click on <b>Next</b>.</p>', '','') ");
//        b.append(",('interactiveTutoStep', '2.step.70', '', 'fr', '', '','') ");
//        b.append(",('interactiveTutoStep', '2.step.75', '', 'en', '<h3>Test Case Step</h3><p>Click on <b>Create</b> to confirm your Step creation.</p>', '','') ");
//        b.append(",('interactiveTutoStep', '2.step.75', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.80', '', 'en', '<h3>Test Case Action & Control</h3><p>Great! We now need to add an action and a control to our test.</p><p>Let\\'s start by adding an Action by clicking on <b>Add Action</b>.</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.80', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.85', '', 'en', '<h3>Test Case Action</h3><p>Describe and select here your desired action from the low code library.</p><p><ul><li><b>Fill</b> the <b>Description</b> with <b>Open the google url</b></li><li><b>Select the Action</b> on the box <b>openUrl</b></li><li><b>Fill the parameter</b> with <b>www.google.com</b></li></ul></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.85', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.90', '', 'en', '<h3>Test Case Control</h3><p>You are quite there, we only miss to add one control.</p><p>You can here add or remove action and control from your test<ul><li>The <b>Blue</b> is to <b>Add an action</b></li><li>The <b>Green</b> is to <b>Add a control</b></li><li>The <b>Red</b> one is to <b>Remove</b> an action or control.</li></ul></p><p><b>Click Green Plus Sign</b> in order to </b>Add a control.</b></ul></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.90', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.95', '', 'en', '<h3>Test Case Control</h3><p>As for the Action, we will define our Control using the available library</p><p>Start by<ul><li><b>Fill</b> the <b>Description</b> with <b>Verify access to google page</b></li><li><b>Select the Control</b> on the box <b>verifyTextInPage</b></li><li><b>Fill the parameter</b> with <b>google</b></li></ul></p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.95', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.100', '', 'en', '<h3>Save Test Case</h3><p>You need to save your test case o keep your changes.</p><p>Click on the <b>Save Test Case</b> button</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.100', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '2.step.105', '', 'en', '<h3>Test Case Tutorial Completed</h3><p>Great job! You have finished the Test Case creation tutorial.</p><p>It should have helped you understand better the steps to manage your test, test cases and how to add actions and controls.</p><p>You can now follow the test execution tutorial, and enjoy Cerberus Testing!</p><p>Happy Testing!</p>', '','') ");
        b.append(",('interactiveTutoStep', '2.step.105', '', 'fr', '', '','') ");
        b.append(",('interactiveTuto', 'testTour', '', 'en', 'Run a Test', '','') ");
        b.append(",('interactiveTuto', 'testTour', '', 'fr', 'Exécutez un Test', '','') ");
        b.append(",('interactiveTuto', 'testTour.detail', '', 'en', 'Discover how to access, run and see the result of a Test', '','') ");
        b.append(",('interactiveTuto', 'testTour.detail', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.5', '', 'en', '<h3>Navigate to the Test Repository</h3><p>We will start by accessing the existing test case that we will use as an example.</p><p>Please open the <b>Test</b> menu, then select the <b>Test Case List</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.5', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.10', '', 'en', '<h3>Selecting the Test Case</h3><p>Well Done! We now see the available tests.</p><p>Please select the first one by clicking on the second blue icon <b>Go to Test Case Script Page</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.10', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.15', '', 'en', '<h3>Test Case Definition</h3><p>Great! We are now in the Test Case page, we will cover the main elements of a Test Case.</p><p>A <b>Step</b> is a collection of actions and controls for your tests. You can then reuse them across tests, we will cover that later on.</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.15', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.20', '', 'en', '<h3>Action and Control</h3><p>The blue box shows an <b>Action</b>, that is composed of<ul><li>A plain language description</li><li>An low code action you can select in the available list</li><li>Parameters depending on your action, this can be a target element, a specific data, a text to verify</li></ul></p><p>The green box is a <b>Control</b> that will be performed after the above action, in the same way<ul><li>Select a control from the low code library</li><li>Set your desired verifications parameter or value</li></ul></p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.20', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.25', '', 'en', '<h3>Test Data and Properties</h3><p>This tab <b>Properties</b> enables you to use variables within your tests, that can be linked to your Data Library.</p><p>This is not required for now, we will share later on. <p>Click on <b>Next</p></b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.25', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.30', '', 'en', '<h3>Test Execution Options</h3><p>This <b>Run</b> Menu allows you to manually launch a test, in a variety of ways :<ul><li><b>Run Test Case</b> will let you select all the execution settings in the run page</li><li><b>ReRun Test Case</b> move you to the run page with the same execution settings of the last execution</li><li><b>ReRun From Queue</b> let you launch the test with the last execution parameters in the background</li><li><b>ReRun From Queue and See</b> will also launch the test in the same executions settings, but you will be able to see it live</li></ul></p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.30', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.35', '', 'en', '<h3>Accessing the Run Page</h3><p>To start, we will define the test run settings by accessing the execution page!</p><p>We will access the page using the left menu.</p><p>Go to the <b>Run > Run Test Case</b> menu</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.35', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.40', '', 'en', '<h3>Test Execution Page</h3><p>We are now on the page that let you run tests at your convenience.</p><p>They can selected manually or directly from an existing campaign</p><p>For our example, we will select the test that is available</p><p>Click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.40', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.45', '', 'en', '<h3>Test Case Selection</h3><p>Select here the firt Test Case <b>0001A</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.45', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.50', '', 'en', '<h3>Environment Selection</h3><p>Select the environments you would like to launch your Test.</p><p>They can be launched on a single or multiple environments, on existing or a custom one you would like to use for your test (manual).</p><p>For now leave it as <b>PROD</b> and click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.50', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.55', '', 'en', '<h3>Environment Selection</h3><p>This is the list of country where you can execute your tests</p><p>This list is customisable to your own needs</p><p>Proceed by selecting <b>FR</b>, then click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.55', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.60', '', 'en', '<h3>Test Hub Selection</h3><p>Choose where you want to launch your test : local or remote hub</p><p>To simplify your test automation, Cerberus provides you native and ready-to-use integrations</p><p>Select one <b>option</b> and click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.60', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.65', '', 'en', '<h3>Advanced Execution Options</h3><p>You can customise your execution with a specific tag, logging level, screenshots, automated rerun, ...</p><p>For this tour, we will leave them as default, click on <b>Next</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.65', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.70', '', 'en', '<h3>Test Case Launch</h3><p>All Right! You are now ready to launch your first test</p><p>Click on <b>Run Test Case (and See Result)</b></p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.70', '', 'fr', '', '','') ");
        b.append(",('interactiveTutoStep', '3.step.75', '', 'en', '<p>Congratulations! Your first test is now running, you will be able to access its result soon.</p>', '','') ");
        b.append(",('interactiveTutoStep', '3.step.75', '', 'fr', '', '','') ");
