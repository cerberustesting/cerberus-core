...
public class DocumentationDatabaseService implements IDocumentationDatabaseService {
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(",('interactiveTuto', 'firstStepAdmin', '', 'en', 'First step for an Admin','','')");
        b.append(",('interactiveTuto', 'firstStepAdmin', '', 'fr', '1ère étapes en Administrateur','','')");
        b.append(",('interactiveTuto', 'firstStepAdmin.detail', '', 'en', 'Learn the first steps to initialize cerberus and create your first test system','','')");
        ...
        b.append(",('interactiveTuto', 'firstStepImplementer', '', 'en', 'First step for a Test Implementer','','')");
        b.append(",('interactiveTuto', 'firstStepImplementer', '', 'fr', '1ère étapes en Implémenteur de test','','')");
        b.append(",('interactiveTuto', 'firstStepImplementer.detail', '', 'en', 'Learn how implement your first test','','')");
        ...
        b.append(",('interactiveTuto', 'webImplementationBeginner.detail', '', 'fr', 'Implementation web pour les debutant.','','')");
        ...
        b.append(",('interactiveTuto', 'runTestManually', '', 'en', 'Run GUI test manually','','')");
        b.append(",('interactiveTuto', 'runTestManually', '', 'fr', 'Executer un cas de test','','')");
        b.append(",('interactiveTuto', 'runTestManually.detail', '', 'en', 'Learn to run GUI test (create your robot and run test)','','')");
        ...
        b.append(",('interactiveTutoStep', '1.step.55', '', 'fr', 'Voilà, ton <b>système</b> est créé ! Prochaine étape : vérifiez qu''un type de déploiement existe. Rendez vous dans <b>Application/Type de deploiement</b>','','')");
        b.append(",('interactiveTutoStep', '1.step.57', '', 'fr', 'Nous allons donc d''abord changer de <b>système</b> pour selectionner celui que nous avons créer précédemment. Cela permettra de lier tout ce qu''on nous allons créer à ce </b>système<b>.','','')");
        b.append(",('interactiveTutoStep', '1.step.60', '', 'fr', 'Cliquez sur <b>Créer un nouveau type de déploiement</b>.','','')");
        b.append(",('interactiveTutoStep', '1.step.65', '', 'fr', 'Renseignez le nom du type de déploiement','','')");
        b.append(",('interactiveTutoStep', '1.step.70', '', 'fr', 'Décrivez le type de déploiement','','')");
        b.append(",('interactiveTutoStep', '1.step.75', '', 'fr', 'Et sauvegardez le type de déploiement','','')");
        b.append(",('interactiveTutoStep', '1.step.80', '', 'fr', 'Prochaine étape : il faut créer un <b>environnement</b>. L''<b>environement</b> represente une plateforme de test, ex : INTEGRATION ou PREPRODUCTION.  Rendez-vous dans le menu <b>Integration/Environment</b>','','')");
        b.append(",('interactiveTutoStep', '1.step.85', '', 'fr', 'Cliquez sur <b>Créer un environement</b>','','')");
        b.append(",('interactiveTutoStep', '1.step.90', '', 'fr', 'Sélectionnez le système que vous venez de créer','','')");
        b.append(",('interactiveTutoStep', '1.step.95', '', 'fr', 'Sélectionnez le pays','','')");
        b.append(",('interactiveTutoStep', '1.step.100', '', 'fr', 'Sélectionnez l''environnement sur lequel vous voulez faire tourner le système','','')");
        b.append(",('interactiveTutoStep', '1.step.105', '', 'fr', 'Ajoutez une description de l''environnement (Ex: <b>%country% - %environement%</b>','','')");
        b.append(",('interactiveTutoStep', '1.step.110', '', 'fr', 'Et validez l''environement','','')");
        ...
        b.append(",('interactiveTutoStep', '1.step.120', '', 'fr', 'Cliquez sur <b>Céer une application</b>','','')");
        ...
        b.append(",('interactiveTutoStep', '1.step.145', '', 'fr', 'Selectionnez le <b>type de deploiement</b> prevu pour l''application','','')");
        ...
        b.append(",('interactiveTutoStep', '1.step.160', '', 'fr', 'Aller dans l''onglet <b>Environments</b>','','')");
        b.append(",('interactiveTutoStep', '1.step.165', '', 'fr', 'Ajouter un <b>environement</b>','','')");
        b.append(",('interactiveTutoStep', '1.step.170', '', 'fr', 'Renseigner un environement et un pays','','')");
        ...
        b.append(",('interactiveTutoStep', '6.step.55', '', 'fr', 'Sélectionnez l''environement (qui a dû être créer au préalable)','','')");
        b.append(",('interactiveTutoStep', '6.step.60', '', 'fr', 'Et le pays (qui a dû être configuré à la création de l''application)','','')");
        b.append(",('interactiveTutoStep', '6.step.65', '', 'fr', 'Sélectionnez <b>Redirect to the execution before the end of the execution</b>. Ce parametre permetra de rediriger la page directement vers le detaill de l''execution','','')");
