...
//            LOG.error(exception1.toString(), exception1);
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(",('testcase','ConditionOperator','','fr','Condition Opérateur','',NULL)");
        ...
        b.append(",('testcase','FromMajor','','en','From Sprint',' ','_testcase')");
        b.append(",('testcase','FromMajor','','fr','Depuis le Sprint','','_cas_de_test')");
        b.append(",('testcase','FromMinor','','en','From minor',' ','_testcase')");
        b.append(",('testcase','FromMinor','','fr','Depuis la Révision','','_cas_de_test')");
        ...
        b.append(",('testcase','TargetMajor','','en','Target Sprint','This is the Target Build that should fix the bug. Until we reach that Build, the <code class=\\'doc-crbvvoca\\'>test case</code> execution will be discarded.','_testcase')");
        b.append(",('testcase','TargetMajor','','fr','Sprint Cible','','_cas_de_test')");
        b.append(",('testcase','TargetMinor','','en','Target Rev','This is the Revision that should fix the bug. Until we reach that Revision, the <code class=\\'doc-crbvvoca\\'>test case</code> execution will be discarded.','_testcase')");
        b.append(",('testcase','TargetMinor','','fr','Revision Cible','Correpond à la Revision à partir de laquelle le bug est corrigé.','_testcase')");
        ...
        b.append(",('testcase','ToMajor','','en','To Sprint',' ','_testcase')");
        b.append(",('testcase','ToMajor','','fr','Jusqu\\'au Sprint','','_cas_de_test')");
        b.append(",('testcase','ToMinor','','en','To Rev',' ','_testcase')");
        b.append(",('testcase','ToMinor','','fr','Jusqu\\'à la Revision','','_cas_de_test')");
        ...
        b.append(",('page_runtest','TargetMinor','','en','Target Revision','',NULL)");
        b.append(",('page_runtest','TargetMinor','','fr','Révision Cible','',NULL)");
        b.append(",('page_runtest','TargetMajor','','en','Target Major','',NULL)");
        b.append(",('page_runtest','TargetMajor','','fr','Major Cible','',NULL)");
