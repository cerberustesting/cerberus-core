...
//            LOG.error(exception1.toString(), exception1);
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(", (2, 30, '#editTestCaseModal #description', 'default', null) ");
        b.append(", (2, 35, '#editTestCaseModal #shortDesc', 'default', null) ");
        b.append(", (2, 40, '#editTestCaseModal #application', 'default', null) ");
        b.append(", (2, 45, '#addTestCaseButton', 'default', null) ");
        b.append(", (2, 50, null, 'general', null) ");
        ...
        b.append(",('interactiveTutoStep', '2.step.50', '', 'en', '<h3>Test Case Creation</h3><p>Congratulations! Your Test Case have been created!</p><p>The next step is to define your test actions and controls by accessing the test case detail.</p><p>Click on <b>Next</b></p>', '','') ");
