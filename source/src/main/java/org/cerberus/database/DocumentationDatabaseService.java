...
public class DocumentationDatabaseService implements IDocumentationDatabaseService {
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(",('page_tag','exepermin','','en','Executions per minute','',NULL)");
        b.append(",('page_tag','exepermin','','fr','Nb execution par minute','',NULL)");
        b.append(",('page_tag','reliability','','en','Reliability %','',NULL)");
        b.append(",('page_tag','reliability','','fr','% de fiabilité','',NULL)");
        b.append(",('page_tag','duration','','en','Duration','',NULL)");
        b.append(",('page_tag','duration','','fr','Durée','',NULL)");
