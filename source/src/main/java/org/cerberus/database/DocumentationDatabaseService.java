...
//        b.append(", (3, 75, null, 'general', null) ");
        ...
        b.append(",('interactiveTutoStep', '1.step.40', '', 'en', '<h3>Application Management</h3><p class=\\'tutoA\\'>Click on <b>Application.</b> From there you can manage your applications, environment and associated libraries:</p><ul><li>Create, update and manage your applications, as well as its corresponding environments and parameters on <b>Application</b></li><li>Define commonly reusable objects to use later in your test definition on <b>Application Object</b> (This will save you a lot of time and effort!)</li><li>Build your service library on <b>Service Library</b>. Service supports REST, SOAP, GraphQL, Kafka, or FTP connectivity.</li><li>Manage your SQL library to create rich, dynamic and reliable test datasets on <b>SQL Library</b></li><li>Customize the deployment type for specific integrations in a CI/CD environment on <b>Deployment Type</b></li></ul><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '2.step.25', '', 'en', '<h3>Test Case Folder</h3><p>You can save your Test Cases in a Folder of your choice. Each Test Case can only belong to one Folder.</p><p><b>Click on the pre-selected folder</b>.</p><p><b>Quick tip:</b> You can choose an existing folder or type a new entry to automatically create a new one.</p><p class=\\'tutoA\\'>Click on <b>Next</b> once finished.</p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '2.step.30', '', 'en', '<h3>Test Case ID</h3><p>Cerberus automatically generated a unique ID for that folder but you can change it to any other value if you prefer. This ID together with its corresponding Test Folder will identify the test case.</p><p class=\\'tutoA\\'>Click on <b>Next</b></p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '2.step.85', '', 'en', '<h3>Test Case Action</h3><p>Describe and select here your desired action from the low code library.</p><p class=\\'tutoA\\'><ul><li>Fill in the <b>Description</b> with <b><i>Open the google url</i></b></li><li><b>Select the Action</b> on the box <b><i>openUrl</i></b></li><li>Fill in the <b>parameter</b> with <b><i>www.google.com</i></b></li></ul></p><p class=\\'tutoA\\'>Click on <b>Next</b> once finished.</p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '2.step.90', '', 'en', '<h3>Test Case Control</h3><p>You are almost there! Let\\'s add one control.</p><p>In every action, you can add or remove actions and controls from your test:</p><ul><li>The <b>Blue</b> button <b>Adds an action</b></li><li>The <b>Green</b> button <b>Adds a control</b></li><li>The <b>Red</b> button <b>Removes</b> the action.</li></ul><p class=\\'tutoA\\'>Click on the <b>Green Plus Symbol</b> to Add a control.</p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '2.step.105', '', 'en', '<h3>Test Case Tutorial Completed</h3><p>Great job! You just finished the Test Case creation tutorial.</p><p>We hope it helped you understand better the main steps to manage your tests and test cases and how to add actions and controls.</p><p>You can now try the Run a Test tutorial and enjoy Cerberus Testing!</p><p>Happy Testing!</p><p class=\\'tutoA\\'>Click on <b>Done</b> to leave the tutorial.</p>', '','') ");
        ...
        b.append(",('interactiveTutoStep', '3.step.45', '', 'en', '<h3>Test Case Selection</h3><p>You can select one or multiple test cases to execute. Just press CTRL key in order to activate multiple selection.</p><p class=\\'tutoA\\'>For our selection, select only one Test Case:<br><b><i>Examples - 0001A [Google] Search for Cerberus Website</i></b></p><p class=\\'tutoA\\'>Then, click on <b>Next</b></p>', '','') ");
