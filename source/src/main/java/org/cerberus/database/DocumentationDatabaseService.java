...
//            LOG.error(exception1.toString(), exception1);
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(",('testcase','TargetMajor','','en','Target Major','This is the Target Build that should fix the bug. Until we reach that Build, the <code class=\\'doc-crbvvoca\\'>test case</code> execution will be discarded.','_testcase')");
        b.append(",('testcase','TargetMajor','','fr','Version Majeure','','_cas_de_test')");
        b.append(",('testcase','TargetMinor','','en','Target Minor','This is the Revision that should fix the bug. Until we reach that Revision, the <code class=\\'doc-crbvvoca\\'>test case</code> execution will be discarded.','_testcase')");
        b.append(",('testcase','TargetMinor','','fr','Version Mineure','Correpond à la Revision à partir de laquelle le bug est corrigé.','_testcase')");
