...
public class DocumentationDatabaseService implements IDocumentationDatabaseService {
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(",('countryenvironmentparameters','Var1','','en','Variable 1','Variable can be used inside testcases with %SYS_APP_VAR1% variable.<br /> You have the possibility to use variable1 & variable2 to execute shell (adb) on mobile (Android) before a test stop (just before the driver disconnect).<br /> variable 1 is the command (ex : \"am start\")','_environment')");
        b.append(",('countryenvironmentparameters','Var1','','fr','Variable 1','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR1%. <br /> Vous pouvez utiliser variable 1 et variable 2 pour éxecuter une commande shell (adb) sur le mobile (Android) avant que le test ne se termine (juste avant que le driver se deconnecte. variable 1 est la commande (ex : \"am start\")','_environnement')");
        b.append(",('countryenvironmentparameters','Var2','','en','Variable 2','Variable can be used inside testcases with %SYS_APP_VAR2% variable.<br /> You have the possibility to use variable1 & variable2 to execute shell (adb) on mobile (Android) before a test stop (just before the driver disconnect).<br /> variable 2 is the arguments (ex : \"-p 60\")','_environment')");
        b.append(",('countryenvironmentparameters','Var2','','fr','Variable 2','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR2%.<br /> Vous pouvez utiliser variable 1 et variable 2 pour executer une commande shell (adb) sur le mobile (Android) avant que le test ne se termine (juste avant que le driver se deconnecte. variable 2 est les arguments de la commande (ex : \"-p 60\")','_environnement')");
        b.append(",('countryenvironmentparameters','Var3','','en','Variable 3','Variable can be used inside testcases with %SYS_APP_VAR3% variable. <br />For Android application : package application. If available, call appiumDriver to force remove application from the phone before stop the test','_environment')");
        b.append(",('countryenvironmentparameters','Var3','','fr','Variable 3','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR3%. <br />Pour les application Android : le package de l\\'application. Si renseigné, appel la methode de suppression de l\\'application avant de stoper le test (force à désinstaller l\\'apk)' ,'_environnement')");
