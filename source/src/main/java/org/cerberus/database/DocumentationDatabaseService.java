...
//            LOG.error(exception1.toString(), exception1);
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(",('page_reportovertime','title','','en','HTTP Execution reporting over Time','This page provide some stats of http counters over time.',NULL)");
        b.append(",('page_reportovertime','title','','fr','Rapport d\\'execution HTTP dans le temps','Cette page génère des rapports d\\'evolution de compteurs http',NULL)");
