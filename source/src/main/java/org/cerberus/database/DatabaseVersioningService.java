...
//-- ------------------------ 609-610
        ...
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("INSERT INTO `documentation` VALUES ('application','Application','','en','Application','',NULL)");
        SQLS.append(",('application','Application','','fr','Application','',NULL)");
        SQLS.append(",('application','bugtrackernewurl','','en','New Bug URL','This correspond to the URL that points to the page where a new bug can be created on the Bug system of the <code class=\\'doc-crbvvoca\\'>application</code>.<br><br><table cellspacing=0 cellpadding=3><th class=\\'ex\\' colspan=\\'2\\'>The following variables can be used inside the URL</th><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%TEST%</code></td><td class=\\'ex\\'>Test</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%TESTCASE%</code></td><td class=\\'ex\\'>Test case reference</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%TESTCASEDESC%</code></td><td class=\\'ex\\'>Description of the test case</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%EXEID%</code></td><td class=\\'ex\\'>Execution ID</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%EXEDATE%</code></td><td class=\\'ex\\'>Start date and time of the execution.</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%ENV%</code></td><td class=\\'ex\\'>Environment</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%COUNTRY%</code></td><td class=\\'ex\\'>Country</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%BUILD%</code></td><td class=\\'ex\\'>Build</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%REV%</code></td><td class=\\'ex\\'>Revision</td></tr></table>',NULL)");
        SQLS.append(",('application','bugtrackernewurl','','fr','URL pour nouveau Bug','Correspond à l\\'URL qui pointe vers la page de création de bug du Bug Tracker de l\\'<code class=\\'doc-crbvvoca\\'>application</code>.<br><br><table cellspacing=0 cellpadding=3><th class=\\'ex\\' colspan=\\'2\\'>Les variables suivantes peuvent être utilisées dans l\\'URL</th><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%TEST%</code></td><td class=\\'ex\\'>Test</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%TESTCASE%</code></td><td class=\\'ex\\'>Reference du cas de test</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%TESTCASEDESC%</code></td><td class=\\'ex\\'>Description du cas de test</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%EXEID%</code></td><td class=\\'ex\\'>ID de l\\'execution</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%EXEDATE%</code></td><td class=\\'ex\\'>Date et heure du debut de l\\'execution.</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%ENV%</code></td><td class=\\'ex\\'>Environnement</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%COUNTRY%</code></td><td class=\\'ex\\'>Pays</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%BUILD%</code></td><td class=\\'ex\\'>Build</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%REV%</code></td><td class=\\'ex\\'>Revision</td></tr></table>',NULL)");
        SQLS.append(",('application','bugtrackerurl','','en','Bug Tracker URL','This correspond to the URL of the Bug reporting system of the <code class=\\'doc-crbvvoca\\'>application</code>.<br><br><table cellspacing=0 cellpadding=3><th class=\\'ex\\' colspan=\\'2\\'>The following variables can be used inside the URL</th><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%BUGID%</code></td><td class=\\'ex\\'>ID of the Bug</td></tr></table>',NULL)");
        SQLS.append(",('application','bugtrackerurl','','fr','URL du Bug Tracker','Correspond à l\\'URL du Bug Tracker de l\\'<code class=\\'doc-crbvvoca\\'>application</code>.<br><br><table cellspacing=0 cellpadding=3><th class=\\'ex\\' colspan=\\'2\\'>Les variables suivantes peuvent être utilisées dans l\\'URL</th><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%BUGID%</code></td><td class=\\'ex\\'>ID du Bug</td></tr></table>',NULL)");
        SQLS.append(",('application','deploytype','','en','Deploy Type','This information groups the <code class=\\'doc-crbvvoca\\'>application</code> by typology of deployement process.<br>It can be used as a variable in the parameter <code class=\\'doc-parameter\\'>jenkins_deploy_url</code> that correspond to the URL that calls a continious integration system such as Jenkins.',NULL)");
        ...
        SQLS.append(",('application','Description','','en','Description','This is the short Description of the <code class=\\'doc-crbvvoca\\'>application</code>.',NULL)");
        SQLS.append(",('application','Description','','fr','Description','Description courte de l\\'<code class=\\'doc-crbvvoca\\'>application</code>.',NULL)");
        SQLS.append(",('application','mavengroupid','','en','Maven Group ID','',NULL)");
        SQLS.append(",('application','mavengroupid','','fr','Identifiant du groupe Maven','',NULL)");
        SQLS.append(",('application','sort','','en','Sort','This correspond to an integer value that is used as a sorting criteria for various combo box within Cerberus GUI.',NULL)");
        SQLS.append(",('application','sort','','fr','identifiant de Tri','Correspond à une valeur entière et utilisée pour trier les differentes valeurs dans l\\'interface graphique.',NULL)");
        SQLS.append(",('application','subsystem','','en','Subsystem','A <code class=\\'doc-crbvvoca\\'>Subsystem</code> define a group of <code class=\\'doc-crbvvoca\\'>application</code> inside a <code class=\\'doc-crbvvoca\\'>system</code>.',NULL)");
        SQLS.append(",('application','subsystem','','fr','Sous Système','Le <code class=\\'doc-crbvvoca\\'>Sous système</code> regroupe un ensemble d\\'<code class=\\'doc-crbvvoca\\'>application</code> au sein d\\'un même <code class=\\'doc-crbvvoca\\'>système</code>.',NULL)");
        SQLS.append(",('application','svnurl','','en','SVN URL','This correspond to the URL of the svn repository of the <code class=\\'doc-crbvvoca\\'>application</code>.',NULL)");
        SQLS.append(",('application','svnurl','','fr','URL du SVN','Correspond à l\\'URL du SVN de l\\'<code class=\\'doc-crbvvoca\\'>application</code>.',NULL)");
        SQLS.append(",('application','system','','en','System','A <code class=\\'doc-crbvvoca\\'>system</code> is a group of <code class=\\'doc-crbvvoca\\'>application</code> for which all changes sometimes require to be done all together.<br> Most of the time those <code class=\\'doc-crbvvoca\\'>applications</code> all connect to a single database and share the same data structure.',NULL)");
        SQLS.append(",('application','system','','fr','Système','Un <code class=\\'doc-crbvvoca\\'>système</code> est un groupe d\\'<code class=\\'doc-crbvvoca\\'>applications</code> pour lesquels il y a de temps en temps necessité de faire les changements en même temps.<br> La plupart du temps ces <code class=\\'doc-crbvvoca\\'>applications</code> partagent une même base de donnée et donc une structure de donnée unique.',NULL)");
        SQLS.append(",('application','type','','en','Type','The Type of the <code class=\\'doc-crbvvoca\\'>application</code> define whether the <code class=\\'doc-crbvvoca\\'>application</code> is a GUI, a Service or a Batch Treatment.<br>An automated <code class=\\'doc-crbvvoca\\'>testcase</code> based on a GUI <code class=\\'doc-crbvvoca\\'>application</code> will require a selenium server to execute.',NULL)");
        SQLS.append(",('application','type','','fr','Type','Le type de l\\'<code class=\\'doc-crbvvoca\\'>application</code> defini si l\\'<code class=\\'doc-crbvvoca\\'>application</code> est une interface graphique (GUI), un fournisseur de Service ou un traitement batch.<br>Un <code class=\\'doc-crbvvoca\\'>cas de test</code> automatisé basé sur une <code class=\\'doc-crbvvoca\\'>application</code> de type GUI necessitera un serveur Selenium pour s\\'executer.',NULL)");
        SQLS.append(",('appservice','application','','en','Application','',NULL)");
        SQLS.append(",('appservice','application','','fr','Application','',NULL)");
        SQLS.append(",('appservice','description','','en','Description','',NULL)");
        SQLS.append(",('appservice','description','','fr','Description','',NULL)");
        SQLS.append(",('appservice','group','','en','Group','',NULL)");
        SQLS.append(",('appservice','group','','fr','Groupe','',NULL)");
        SQLS.append(",('appservice','method','','en','Method','',NULL)");
        SQLS.append(",('appservice','method','','fr','Méthode','',NULL)");
        SQLS.append(",('appservice','operation','','en','Operation','',NULL)");
        SQLS.append(",('appservice','operation','','fr','Operation','',NULL)");
        SQLS.append(",('appservice','service','','en','Service','',NULL)");
        SQLS.append(",('appservice','service','','fr','Service','',NULL)");
        SQLS.append(",('appservice','servicePath','','en','Service Path','',NULL)");
        SQLS.append(",('appservice','servicePath','','fr','Chemin du service','',NULL)");
        SQLS.append(",('appservice','srvRequest','','en','Request','',NULL)");
        SQLS.append(",('appservice','srvRequest','','fr','Requête','',NULL)");
        SQLS.append(",('appservice','type','','en','Type','',NULL)");
        SQLS.append(",('appservice','type','','fr','Type','',NULL)");
        SQLS.append(",('batchinvariant','Batch','','en','Batch','',NULL)");
        SQLS.append(",('batchinvariant','Batch','','fr','Batch','',NULL)");
        SQLS.append(",('batchinvariant','Description','','en','Description','Description of the batch.',NULL)");
        SQLS.append(",('batchinvariant','Description','','fr','Description','Description du batch',NULL)");
        SQLS.append(",('batchinvariant','system','','en','System','System of the batch',NULL)");
        SQLS.append(",('batchinvariant','system','','fr','System','System du batch',NULL)");
        ...
        SQLS.append(",('buildrevisioninvariant','level','','en','Level','',NULL)");
        SQLS.append(",('buildrevisioninvariant','level','','fr','Niveau','',NULL)");
        SQLS.append(",('buildrevisioninvariant','seq','','en','Sequence','',NULL)");
        SQLS.append(",('buildrevisioninvariant','seq','','fr','Séquence','',NULL)");
        SQLS.append(",('buildrevisioninvariant','system','','en','System','',NULL)");
        SQLS.append(",('buildrevisioninvariant','system','','fr','Système','',NULL)");
        SQLS.append(",('buildrevisioninvariant','versionName','','en','Version Name','',NULL)");
        SQLS.append(",('buildrevisioninvariant','versionName','','fr','Nom de la Version','',NULL)");
        SQLS.append(",('buildrevisioninvariant','versionname01','','en','Build','',NULL)");
        SQLS.append(",('buildrevisioninvariant','versionname01','','fr','Build','',NULL)");
        SQLS.append(",('buildrevisioninvariant','versionname02','','en','Revision','',NULL)");
        SQLS.append(",('buildrevisioninvariant','versionname02','','fr','Revision','',NULL)");
        SQLS.append(",('buildrevisionparameters','application','','en','Application','',NULL)");
        SQLS.append(",('buildrevisionparameters','application','','fr','Application','',NULL)");
        SQLS.append(",('buildrevisionparameters','BugIDFixed','','en','Associated Bug ID','This is the bug ID which has been solved with the <code class=\\'doc-crbvvoca\\'>release</code>.',NULL)");
        SQLS.append(",('buildrevisionparameters','BugIDFixed','','fr','ID du Bug associé','ID du bug dont la release est associée.',NULL)");
        SQLS.append(",('buildrevisionparameters','Build','','en','Build','',NULL)");
        SQLS.append(",('buildrevisionparameters','Build','','fr','Build','',NULL)");
        SQLS.append(",('buildrevisionparameters','datecre','','en','Creation Date','',NULL)");
        SQLS.append(",('buildrevisionparameters','datecre','','fr','Date de Création','',NULL)");
        SQLS.append(",('buildrevisionparameters','id','','en','ID','',NULL)");
        SQLS.append(",('buildrevisionparameters','id','','fr','ID','',NULL)");
        SQLS.append(",('buildrevisionparameters','jenkinsBuildId','','en','Jenkins Build ID','',NULL)");
        SQLS.append(",('buildrevisionparameters','jenkinsBuildId','','fr','ID du build Jenkins','',NULL)");
        SQLS.append(",('buildrevisionparameters','Link','','en','Link','This is the link to the detailed content of the <code class=\\'doc-crbvvoca\\'>release</code>.',NULL)");
        SQLS.append(",('buildrevisionparameters','Link','','fr','Lien','Lien vers le detail de la <code class=\\'doc-crbvvoca\\'>release</code>.',NULL)");
        SQLS.append(",('buildrevisionparameters','mavenArtifactId','','en','Maven Artifact ID','',NULL)");
        SQLS.append(",('buildrevisionparameters','mavenArtifactId','','fr','Maven Artifact ID','',NULL)");
        SQLS.append(",('buildrevisionparameters','mavenGroupId','','en','Maven Group ID','',NULL)");
        SQLS.append(",('buildrevisionparameters','mavenGroupId','','fr','ID du groupe Maven','',NULL)");
        SQLS.append(",('buildrevisionparameters','mavenVersion','','en','Maven Version','',NULL)");
        SQLS.append(",('buildrevisionparameters','mavenVersion','','fr','Maven Version','',NULL)");
        SQLS.append(",('buildrevisionparameters','project','','en','Project','',NULL)");
        SQLS.append(",('buildrevisionparameters','project','','fr','Projet','',NULL)");
        SQLS.append(",('buildrevisionparameters','Release','','en','Release','A <code class=\\'doc-crbvvoca\\'>release</code> is a single change done on the <code class=\\'doc-crbvvoca\\'>application</code>.',NULL)");
        SQLS.append(",('buildrevisionparameters','Release','','fr','Release','A <code class=\\'doc-crbvvoca\\'>release</code> is a single change done on the <code class=\\'doc-crbvvoca\\'>application</code>.',NULL)");
        SQLS.append(",('buildrevisionparameters','ReleaseOwner','','en','Owner','This is the name of the person who is responsible for the <code class=\\'doc-crbvvoca\\'>release</code>.',NULL)");
        SQLS.append(",('buildrevisionparameters','ReleaseOwner','','fr','Responsable','Nom de la personne responsable de la <code class=\\'doc-crbvvoca\\'>release</code>.',NULL)");
        SQLS.append(",('buildrevisionparameters','repositoryUrl','','en','Repository URL','This information corresponds to the URL where the current build of the <code class=\\'doc-crbvvoca\\'>application</code> can be downloaded.<br>It allow to retrieve it in a repository such as Nexus.',NULL)");
        SQLS.append(",('buildrevisionparameters','repositoryUrl','','fr','URL du Dépot','Cette information correspond à l\\'URL d\\'où le build de l\\'<code class=\\'doc-crbvvoca\\'>application</code> peut-être téléchargé.<br>Cela permet de retrouver un build spécifique dans un dépot de livrable de type Nexus.',NULL)");
        SQLS.append(",('buildrevisionparameters','Revision','','en','Revision','',NULL)");
        SQLS.append(",('buildrevisionparameters','Revision','','fr','Revision','',NULL)");
        SQLS.append(",('buildrevisionparameters','subject','','en','Description','',NULL)");
        SQLS.append(",('buildrevisionparameters','subject','','fr','Description','',NULL)");
        SQLS.append(",('buildrevisionparameters','TicketIDFixed','','en','Associated Ticket ID','This is the Ticket ID which has been delivered with the <code class=\\'doc-crbvvoca\\'>release</code>.',NULL)");
        SQLS.append(",('buildrevisionparameters','TicketIDFixed','','fr','ID du Ticket associé','ID du ticket dont la release est associée.',NULL)");
        SQLS.append(",('countryenvdeploytype','JenkinsAgent','','en','Jenkins Agent','',NULL)");
        SQLS.append(",('countryenvdeploytype','JenkinsAgent','','fr','Agent Jenkins','',NULL)");
        ...
        SQLS.append(",('countryenvironmentdatabase','Database','','en','Database','',NULL)");
        SQLS.append(",('countryenvironmentdatabase','Database','','fr','Base de donnée','',NULL)");
        SQLS.append(",('countryenvironmentparameters','domain','','en','Domain','Domain of the Application. Can be used inside any test execution with %SYS_APP_DOMAIN% variable.',NULL)");
        SQLS.append(",('countryenvironmentparameters','domain','','fr','Domaine','Domaine Internet de l\\'application. Peut être utilisé pendant l\\'execution des tests avec la variable %SYS_APP_DOMAIN%.',NULL)");
        SQLS.append(",('countryenvironmentparameters','IP','','en','Host','Ressource location of the application.<br><br>Examples :<br><doc class=\"examples\"><code class=\\'doc-url\\'>www.domain.com</code><br><code class=\\'doc-url\\'>192.168.1.1:80</code><br><code class=\\'doc-url\\'>user:password@www.domain.com:8080</code><br><code class=\\'doc-url\\'>user:password@192.168.1.1:80</code><br><code class=\\'doc-url\\'>http://www.laredoute.fr</code><br><code class=\\'doc-url\\'>https://www.facebook.com</code><br></doc><br>NB : If the protocol is not specified, the default selected is http://<br>In case you want to test an https:// application, this ressource location must begin by https://.',NULL)");
        SQLS.append(",('countryenvironmentparameters','IP','','fr','Hote','Chemin de l\\'application.<br><br>Exemples :<br><doc class=\"examples\"><code class=\\'doc-url\\'>www.domain.com</code><br><code class=\\'doc-url\\'>192.168.1.1:80</code><br><code class=\\'doc-url\\'>user:password@www.domain.com:8080</code><br><code class=\\'doc-url\\'>user:password@192.168.1.1:80</code><br><code class=\\'doc-url\\'>http://www.laredoute.fr</code><br><code class=\\'doc-url\\'>https://www.facebook.com</code><br></doc><br>NB : Si le protocole n\\'est pas specifié, le protocople par default utilisé est http://<br>En cas de test d\\'une application en https, il faut commencer l\\'URL par https://.',NULL)");
        SQLS.append(",('countryenvironmentparameters','poolSize','','en','Pool size','Maximal number of testcases that can be executed in same time by a single Cerberus instance',NULL)");
        SQLS.append(",('countryenvironmentparameters','poolSize','','fr','Parallelisation','Nombre maximal, par instances Cerberus, de tests pouvant être exécutés en parallèle',NULL)");
        SQLS.append(",('countryenvironmentparameters','URL','','en','Context Root','Root URL used to access the application. Equivalent to context root.<br>This path will always be added to the information specified in the testcase.<br><br>Example :<br><doc class=\"examples\"><table cellspacing=0 cellpadding=3><th class=\\'ex\\'>URL</th><th class=\\'ex\\'>Description</th><tr><td class=\\'ex\\'><code class=\\'doc-url\\'>/Cerberus-1.0.1-SNAPSHOT/</code></td><td class=\\'ex\\'>When opening <code class=\\'doc-url\\'>login.jsp</code>, Cerberus will open <code class=\\'doc-url\\'>/Cerberus-1.0.1-SNAPSHOT/login.jsp</code> URL</td></tr></table></doc>',NULL)");
        SQLS.append(",('countryenvironmentparameters','URL','','fr','Context Root','URL Racine de l\\'application. Equivalent du Context Root.<br>Ce chemin sera systematiquement ajouté aux chemin specifiés dans chaque cas de test.<br><br>Exemple :<br><doc class=\"examples\"><table cellspacing=0 cellpadding=3><th class=\\'ex\\'>URL</th><th class=\\'ex\\'>Description</th><tr><td class=\\'ex\\'><code class=\\'doc-url\\'>/Cerberus-1.0.1-SNAPSHOT/</code></td><td class=\\'ex\\'>Lorsque l\\'on ouvrira <code class=\\'doc-url\\'>login.jsp</code>, Cerberus ouvrira  <code class=\\'doc-url\\'>/Cerberus-1.0.1-SNAPSHOT/login.jsp</code> URL</td></tr></table></doc>',NULL)");
        SQLS.append(",('countryenvironmentparameters','URLLOGIN','','en','Login URL','Path to login page. This path is used only when calling the <code class=\\'doc-action\\'>openUrlLogin</code> Action.',NULL)");
        SQLS.append(",('countryenvironmentparameters','URLLOGIN','','fr','URL de Login','Chemin vers la page de login. Ce chemin peut être utilisé à partir de l\\'action <code class=\\'doc-action\\'>openUrlLogin</code>.',NULL)");
        SQLS.append(",('countryenvironmentparameters','Var1','','en','Variable 1','Variable can be used inside testcases with %SYS_APP_VAR1% variable.',NULL)");
        SQLS.append(",('countryenvironmentparameters','Var1','','fr','Variable 1','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR1%',NULL)");
        SQLS.append(",('countryenvironmentparameters','Var2','','en','Variable 2','Variable can be used inside testcases with %SYS_APP_VAR2% variable.',NULL)");
        SQLS.append(",('countryenvironmentparameters','Var2','','fr','Variable 2','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR2%',NULL)");
        SQLS.append(",('countryenvironmentparameters','Var3','','en','Variable 3','Variable can be used inside testcases with %SYS_APP_VAR3% variable.',NULL)");
        SQLS.append(",('countryenvironmentparameters','Var3','','fr','Variable 3','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR3%',NULL)");
        SQLS.append(",('countryenvironmentparameters','Var4','','en','Variable 4','Variable can be used inside testcases with %SYS_APP_VAR4% variable.',NULL)");
        SQLS.append(",('countryenvironmentparameters','Var4','','fr','Variable 4','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR4%',NULL)");
        SQLS.append(",('countryenvlink','CountryLink','','en','Country linked','',NULL)");
        SQLS.append(",('countryenvlink','CountryLink','','fr','Pays lié','',NULL)");
        SQLS.append(",('countryenvlink','EnvironmentLink','','en','Environment linked','',NULL)");
        SQLS.append(",('countryenvlink','EnvironmentLink','','fr','Environnement lié','',NULL)");
        SQLS.append(",('countryenvlink','systemLink','','en','System','',NULL)");
        SQLS.append(",('countryenvlink','systemLink','','fr','System','',NULL)");
        SQLS.append(",('countryenvparam','active','','en','Active','Define if the <code class=\\'doc-crbvvoca\\'>environment</code> is active or not. A <code class=\\'doc-crbvvoca\\'>test case</code> cannot be executed against an <code class=\\'doc-crbvvoca\\'>environment</code> that is not  active.',NULL)");
        SQLS.append(",('countryenvparam','active','','fr','Actif','',NULL)");
        SQLS.append(",('countryenvparam','chain','','en','Chain','',NULL)");
        SQLS.append(",('countryenvparam','chain','','fr','Chaine','',NULL)");
        SQLS.append(",('countryenvparam','Description','','en','Description','',NULL)");
        SQLS.append(",('countryenvparam','Description','','fr','Description','',NULL)");
        SQLS.append(",('countryenvparam','DistribList','','en','Recipent list of Notification Email','This is the list of email adresses that will receive the notification on any environment event.<br><br>In case that value is not feeded, the following parameters are used (depending on the related event) :<br><code class=\\'doc-parameter\\'>integration_notification_disableenvironment_to</code><br><code class=\\'doc-parameter\\'>integration_notification_newbuildrevision_to</code><br><code class=\\'doc-parameter\\'>integration_notification_newchain_to</code>',NULL)");
        SQLS.append(",('countryenvparam','DistribList','','fr','Emails des destinataires','',NULL)");
        SQLS.append(",('countryenvparam','EMailBodyChain','','en','EMail Body on New Chain Executed Event','This is the Body of the mail that will be generated when a new Treatment has been executed on the <code class=\\'doc-crbvvoca\\'>environment</code>.<br><br><table cellspacing=0 cellpadding=3><th class=\\'ex\\' colspan=\\'2\\'>The following variable can be used</th><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%SYSTEM%</code></td><td class=\\'ex\\'>System value</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%COUNTRY%</code></td><td class=\\'ex\\'>Country code</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%ENV%</code></td><td class=\\'ex\\'>Environment code</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%BUILD%</code></td><td class=\\'ex\\'>Current Build version name</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%REVISION%</code></td><td class=\\'ex\\'>Current Revision version name</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%CHAIN%</code></td><td class=\\'ex\\'>Chain value that has been executed</td></tr></table><br>In case that value is not feeded, the following parameter is used :<br><code class=\\'doc-parameter\\'>integration_notification_newchain_body</code>',NULL)");
        SQLS.append(",('countryenvparam','EMailBodyChain','','fr','Corps du message en cas de nouvelle Chaine','',NULL)");
        ...
        SQLS.append(",('countryenvparam','EMailBodyDisableEnvironment','','fr','Corps du message en cas de désactivation','',NULL)");
        ...
        SQLS.append(",('homepage','testCaseStatusByApp','','fr','Status des Cas de Tests par Application','Status de l\\'avancement des cas de tests par Application',NULL)");
        ...
        SQLS.append(",('page_application','title','','en','APPLICATION','This page can be used to manage the applications.',NULL)");
        SQLS.append(",('page_application','title','','fr','APPLICATION','Cette page permet de gérer et créer des applications.',NULL)");
        ...
        SQLS.append(",('page_applicationObject','title','','en','Application Object','',NULL)");
        SQLS.append(",('page_applicationObject','title','','fr','Objet d\\'application','',NULL)");
        ...
        SQLS.append(",('page_batchinvariant','title','','en','BATCH','This page can be used in order to manage the batch per system.',NULL)");
        SQLS.append(",('page_batchinvariant','title','','fr','BATCH','Cette page permet de gérer et créer des batch pour chaque systeme.',NULL)");
        ...
        SQLS.append(",('page_buildcontent','title','','en','BUILD CONTENT','This page can be used to manage the Build Content.',NULL)");
        SQLS.append(",('page_buildcontent','title','','fr','CONTENU DES BUILDS','Cette page permet de gérer le contenu d\\'un build.',NULL)");
        ...
        SQLS.append(",('page_buildrevdefinition','title','','en','BUILD REVISION DEFINITION','This page can be used to manage the definition of Builds and Revisions.',NULL)");
        SQLS.append(",('page_buildrevdefinition','title','','fr','DEFINITION DES BUILDS REVISIONS','Cette page permet de gérer la definition d\\'un build.',NULL)");
        ...
        SQLS.append(",('page_deploytype','title','','en','DEPLOYMENT TYPE','This page can be used in order to manage the deployment types.',NULL)");
        SQLS.append(",('page_deploytype','title','','fr','TYPE DE DEPLOIEMENT','Cette page permet de gérer et créer des types de deploiements.',NULL)");
        ...
        SQLS.append(",('page_environment','title','','en','ENVIRONMENT','This page can be used to manage the environments.',NULL)");
        SQLS.append(",('page_environment','title','','fr','ENVIRONNEMENT','Cette page permet de gérer et créer des environnements.',NULL)");
        ...
        SQLS.append(",('page_label','title','','en','LABEL','This page can be used in order to manage the labels.',NULL)");
        SQLS.append(",('page_label','title','','fr','LABEL','Cette page permet de gérer et créer des labels.',NULL)");
        ...
        SQLS.append(",('page_logviewer','title','','en','LOG VIEWER','This page displays all the log messages from Cerberus.',NULL)");
        SQLS.append(",('page_logviewer','title','','fr','JOURNAL DE MODIFICATIONS','Cette page affiche tout les messages de log de Cerberus.',NULL)");
        ...
        SQLS.append(",('page_project','title','','en','PROJECT','This page can be used in order to manage the projets.',NULL)");
        SQLS.append(",('page_project','title','','fr','PROJET','Cette page permet de gérer et créer des projets.',NULL)");
        ...
        SQLS.append(",('page_robot','title','','en','ROBOT','This page can be used in order to manage the robots.',NULL)");
        SQLS.append(",('page_robot','title','','fr','ROBOT','Cette page permet de gérer et créer des Robots.',NULL)");
        ...
        SQLS.append(",('test','Active','','en','Active','Define if the <code class=\\'doc-crbvvoca\\'>test</code> is active.<br>If <code class=\\'doc-crbvvoca\\'>test</code> is not active, no execution is possible on any of the associated <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('test','Active','','fr','Actif','Booléen qui définit si le <code class=\\'doc-crbvvoca\\'>test</code> est actif.<br>Si le <code class=\\'doc-crbvvoca\\'>test</code> n\\'est pas actif, aucune execution des <code class=\\'doc-crbvvoca\\'>Cas de tests</code> n\\'est possible.',NULL)");
        SQLS.append(",('test','Automated','','en','Automated','Define if the test is automated or not.',NULL)");
        SQLS.append(",('test','Automated','','fr','Automatisé','Boléen qui définit si le test est automatisé ou non',NULL)");
        SQLS.append(",('test','dateCreation','','en','Creation date','The date when the test have been created',NULL)");
        SQLS.append(",('test','dateCreation','','fr','Date de création','Date à laquelle le test a été créé',NULL)");
        SQLS.append(",('test','Description','','en','Test Description','This is the description of the <code class=\\'doc-crbvvoca\\'>test</code>.',NULL)");
        SQLS.append(",('test','Description','','fr','Description du test','Description du <code class=\\'doc-crbvvoca\\'>test</code>.',NULL)");
        SQLS.append(",('test','Test','','en','Test','A <code class=\\'doc-crbvvoca\\'>test</code> is grouping some <code class=\\'doc-crbvvoca\\'>test case</code> together. The criteria that groups the <code class=\\'doc-crbvvoca\\'>test cases</code> can be an application page or a feature.',NULL)");
        SQLS.append(",('test','Test','','fr','Test','Un <code class=\\'doc-crbvvoca\\'>test</code> regroupe plusieurs <code class=\\'doc-crbvvoca\\'>Cas de tests</code> ensemble.',NULL)");
        SQLS.append(",('testcase','activePROD','','en','Active PROD','Define whether the <code class=\\'doc-crbvvoca\\'>test case</code> can be executed in PROD environments.<br>If the environment gp1 (attached to the invariant) is PROD and Active PROD is No, the <code class=\\'doc-crbvvoca\\'>test case</code> will never be executed.',NULL)");
        SQLS.append(",('testcase','activePROD','','fr','Actif PROD',NULL,NULL)");
        SQLS.append(",('testcase','activeQA','','en','Active QA','Define whether the <code class=\\'doc-crbvvoca\\'>test case</code> can be executed in QA environments.<br>If the environment gp1 (attached to the invariant) is QA and Active QA is No, the <code class=\\'doc-crbvvoca\\'>test case</code> will never be executed.',NULL)");
        SQLS.append(",('testcase','activeQA','','fr','Actif QA',NULL,NULL)");
        SQLS.append(",('testcase','activeUAT','','en','Active UAT','Define whether the <code class=\\'doc-crbvvoca\\'>test case</code> can be executed in UAT environments.<br>If the environment gp1 (attached to the invariant) is UAT and Active UAT is No, the <code class=\\'doc-crbvvoca\\'>test case</code> will never be executed.',NULL)");
        SQLS.append(",('testcase','activeUAT','','fr','Actif UAT',NULL,NULL)");
        SQLS.append(",('testcase','BehaviorOrValueExpected','','en','Detailed Description / Value Expected','It is a full description of the <code class=\\'doc-crbvvoca\\'>application</code> feature that we expect to be tested with that <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcase','BehaviorOrValueExpected','','fr','Description détaillée / Valeur attendue',NULL,NULL)");
        SQLS.append(",('testcase','BugID','','en','Bug ID','This is the bug ID that will fix the pending KO.',NULL)");
        SQLS.append(",('testcase','BugID','','fr','BugID','',NULL)");
        SQLS.append(",('testcase','Comment','','en','Comment','This is where to add any interesting comment about the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcase','Comment','','fr','Commentaire','This is where to add any interesting comment about the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcase','countryList','','en','Country List','The list of countries where the test case is defined',NULL)");
        SQLS.append(",('testcase','countryList','','fr','Liste des pays','La liste des pays sur lesquels le cas de test est défini',NULL)");
        SQLS.append(",('testcase','Creator','','en','Creator','This is the name of the Cerberus user who created the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcase','Creator','','fr','Créateur',NULL,NULL)");
        SQLS.append(",('testcase','Description','','en','Test case short description','It is a synthetic description of what the <code class=\\'doc-crbvvoca\\'>test case</code> do.',NULL)");
        SQLS.append(",('testcase','Description','','fr','Description courte','',NULL)");
        SQLS.append(",('testcase','FromBuild','','en','From Sprint',' ',NULL)");
        SQLS.append(",('testcase','FromBuild','','fr','Depuis le sprint',NULL,NULL)");
        SQLS.append(",('testcase','FromRev','','en','From Rev',' ',NULL)");
        SQLS.append(",('testcase','FromRev','','fr','Depuis la révision',NULL,NULL)");
        SQLS.append(",('testcase','Function','','en','Function','The function is the functionnality that the <code class=\\'doc-crbvvoca\\'>test case</code> is testing.',NULL)");
        SQLS.append(",('testcase','Function','','fr','Fonction','',NULL)");
        SQLS.append(",('testcase','HowTo','','en','How To','<i>How to</i> field is used to define the step by step procedure used in order to execute the <code class=\\'doc-crbvvoca\\'>test case</code>. This is mainly used for MANUAL group <code class=\\'doc-crbvvoca\\'>test cases</code>.',NULL)");
        SQLS.append(",('testcase','HowTo','','fr','Comment',NULL,NULL)");
        SQLS.append(",('testcase','Implementer','','en','Implementer','This is the name of the Cerberus user who implemented the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcase','LastModifier','','en','LastModifier','This is the name of the Cerberus user who last modified the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcase','LastModifier','','fr','Dernier Modificateur',NULL,NULL)");
        SQLS.append(",('testcase','Origine','','en','Origin','This is the country or the team that identified the scenario of the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcase','Origine','','fr','Origine',NULL,NULL)");
        SQLS.append(",('testcase','RefOrigine','','en','RefOrigin','This is the external reference of the <code class=\\'doc-crbvvoca\\'>test case</code> when coming from outside Cerberus.',NULL)");
        SQLS.append(",('testcase','RefOrigine','','fr','RefOrigine',NULL,NULL)");
        SQLS.append(",('testcase','Status','','en','Status','It is the workflow status of the <code class=\\'doc-crbvvoca\\'>test case</code> used to follow-up the implementation of the tests.<br>It can take any values depending on the workflow that manage the <code class=\\'doc-crbvvoca\\'>test case</code> life cycle.<br><br>The first status defined on the invariant table (based on the sequence) will be the default value for any new <code class=\\'doc-crbvvoca\\'>test case</code>.<br>The only status that is mandatory to define and create is the WORKING status that correspond to fully working and stable <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcase','Status','','fr','Status','',NULL)");
        SQLS.append(",('testcase','TargetBuild','','en','Target Sprint','This is the Target Build that should fix the bug. Until we reach that Build, the <code class=\\'doc-crbvvoca\\'>test case</code> execution will be discarded.',NULL)");
        SQLS.append(",('testcase','TargetBuild','','fr','Sprint cible',NULL,NULL)");
        SQLS.append(",('testcase','TargetRev','','en','Target Rev','This is the Revision that should fix the bug. Until we reach that Revision, the <code class=\\'doc-crbvvoca\\'>test case</code> execution will be discarded.',NULL)");
        SQLS.append(",('testcase','TcActive','','en','Act','This field define if the test is active or not. A <code class=\\'doc-crbvvoca\\'>test case</code> that is not active cannot be executed.',NULL)");
        SQLS.append(",('testcase','TcActive','','fr','Actif',NULL,NULL)");
        SQLS.append(",('testcase','TCDateCrea','','en','Creation Date','This is the <code class=\\'doc-crbvvoca\\'>test case</code> creation date.',NULL)");
        SQLS.append(",('testcase','TCDateCrea','','fr','Date de création',NULL,NULL)");
        SQLS.append(",('testcase','TestCase','','en','Testcase ID','A <code class=\\'doc-crbvvoca\\'>test case</code> is a scenario that test a specific feature of an <code class=\\'doc-crbvvoca\\'>application</code>.',NULL)");
        SQLS.append(",('testcase','TestCase','','fr','ID du Cas de test','',NULL)");
        SQLS.append(",('testcase','ticket','','en','Ticket','The is the Ticket Number that provided the implementation of the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcase','ticket','','fr','Ticket',NULL,NULL)");
        SQLS.append(",('testcase','ToBuild','','en','To Sprint',' ',NULL)");
        SQLS.append(",('testcase','ToBuild','','fr','Depuis le Sprint',NULL,NULL)");
        SQLS.append(",('testcase','ToRev','','en','To Rev',' ',NULL)");
        SQLS.append(",('testcase','ToRev','','fr','Depuis la Revision',NULL,NULL)");
        ...
        SQLS.append(",('testdatalib','actions_nopermissions','','fr','Actions',NULL,NULL)");
        SQLS.append(",('testdatalib','country','','en','Country','<p>Country where the entry is available. If not specified, then the data entry apply to ALL countries. </p>',NULL)");
        SQLS.append(",('testdatalib','created','','en','Creation Date','',NULL)");
        SQLS.append(",('testdatalib','created','','fr','Date de création',NULL,NULL)");
        SQLS.append(",('testdatalib','creator','','en','Creator','User who created the data.',NULL)");
        SQLS.append(",('testdatalib','creator','','fr','Créateur',NULL,NULL)");
        SQLS.append(",('testdatalib','csvUrl','','en','CSV URL','<p>CSV URL specifies the URL where the CSV can be reached.</p>',NULL)");
        SQLS.append(",('testdatalib','csvUrl','','fr','URL du CSV','<p>L’URL du CSV représente l’URL du fichier CSV à décrypter.</p>',NULL)");
        SQLS.append(",('testdatalib','database','','en','Database','<p>Specifies the database where the <i>script</i> attribute should be executed. </p> You can then configure the JDBC Connection pool on that database at the environment level. That allows to create testdata independant from the environement where the testcase is executed.',NULL)");
        SQLS.append(",('testdatalib','databaseCsv','','en','Database','<p>Specifies the database where the <i>Service Path</i> will be requested. </p> You can then configure the left part of the Service URL on that database at the environment level. That allows to create testdata independant from the environment where the testcase is executed.',NULL)");
        SQLS.append(",('testdatalib','databaseCsv','','fr','Base de données',NULL,NULL)");
        ...
        SQLS.append(",('testdatalib','databaseUrl','','fr','Base de données','',NULL)");
        SQLS.append(",('testdatalib','description','','en','Description','<p>Textual description of the entry.</p>',NULL)");
        SQLS.append(",('testdatalib','envelope','','en','Envelope','<p>Envelope that should be sent in the SOAP request.</p>',NULL)");
        SQLS.append(",('testdatalib','envelope','','fr','Enveloppe','<p>Enveloppe qui doit être envoyée dans la requête SOAP</p>',NULL)");
        SQLS.append(",('testdatalib','environment','','en','Environment','<p>Environment where the entry is available. If not specified, then the data entry apply to ALL environments.</p>',NULL)");
        SQLS.append(",('testdatalib','group','','en','Group','<p>Name that groups entries that are at some extent correlated. It is an <b>optional</b> attribute.</p>',NULL)");
        SQLS.append(",('testdatalib','lastmodified','','en','Modification Date','',NULL)");
        SQLS.append(",('testdatalib','lastmodified','','fr','Dernière modification',NULL,NULL)");
        SQLS.append(",('testdatalib','lastmodifier','','en','Last Modifier','User who last modified the data.',NULL)");
        SQLS.append(",('testdatalib','lastmodifier','','fr','Dernier modificateur','Utilisateur qui a modifié en dernier la donnée',NULL)");
        SQLS.append(",('testdatalib','method','','en','Operation','<p>Operation that is invoked by the SOAP request/call.</p>',NULL)");
        SQLS.append(",('testdatalib','method','','fr','Operation','<p>Operation à appeler pour la Requête SOAP.</p>',NULL)");
        SQLS.append(",('testdatalib','name','','en','Name','<p>Name of the entry. It is a <b>mandatory</b> attribute.</p><p><b><u>Note</u></b>: The combination of <u>Name</u>, <u>System</u>, <u>Environment</u> and <u>Country</u> can be duplicated when the type is STATIC in order to allow a list of data to be available.</p>',NULL)");
        SQLS.append(",('testdatalib','name','','fr','Nom','<p>Nom de la donnée</p>',NULL)");
        SQLS.append(",('testdatalib','script','','en','Script','<p>SQL commands that should be executed to retrieve test data.</p><p>Examples:</p><table><tr><td>select * from table;</td></tr><tr><td>select * from table where column = %COLUMN%;</td></tr></table>',NULL)");
        SQLS.append(",('testdatalib','script','','fr','Scenario',NULL,NULL)");
        SQLS.append(",('testdatalib','separator','','en','Separator','<p>Separator used parsing a CSV.</p>',NULL)");
        SQLS.append(",('testdatalib','separator','','fr','Séparateur','<p>Séparateur à utiliser pour le décryptage du CSV.</p>',NULL)");
        SQLS.append(",('testdatalib','service','','en','Service','',NULL)");
        SQLS.append(",('testdatalib','servicepath','','en','Service Path','<p>Location of the service.</p><p>Examples:</p><table><tr><td>http://mydomain/mywebservicelocation</td></tr><tr><td>mywebservicelocation</td></tr><tr><td>http://%MY_DYNAMIC_IP%/mywebservicelocation</td></tr><tr><td>%LOCATION%</td></tr></table>',NULL)");
        SQLS.append(",('testdatalib','system','','en','System','<p>System where the entry is available. If not specified, then the data entry apply to ALL systems.</p>',NULL)");
        SQLS.append(",('testdatalib','testdatalibid','','en','ID','<p>Unique identifier of the test data library entry</p>',NULL)");
        SQLS.append(",('testdatalib','testdatalibid','','fr','Identifiant','<p>Identifiant unique de librairie de donnée</p>',NULL)");
        SQLS.append(",('testdatalib','type','','en','Type','<p>Entry Type - Cerberus allows the definition of 4 types: INTERNAL, SQL, CSV and SERVICE.</p><table border=\\'1\\'> <tr><th class=\\'ex\\'>Type</th><th class=\\'ex\\'>Description</th></tr> <tr><td>INTERNAL</td><td>Static test data - in each execution the values used by the test cases are statically definied directly in Cerberus.</td></tr> <tr><td>SQL</td><td> Test data obtained from a SQL execution – values depend on what the SQL return on the corresponding environment.</td></tr><tr><td>SERVICE</td><td>Test data obtained from a SERVICE call – values depend on the result of the service call. Service needs to be configured on Service screen inside application menu.</td></tr><tr><td>CSV</td><td>Test data obtained from a CSV file structure privided by a URL. Values depend on the result of the service call to CSV file.</td></tr></table>',NULL)");
        SQLS.append(",('testdatalibdata','column','','en','Column','<p>Column name representing the value that should be obtained after executing a SQL instruction (select).</p>',NULL)");
        SQLS.append(",('testdatalibdata','column','','fr','Colonne','<p>Nom de la colonne représentant la vakeur qui devrait être obtenu après l\\'execution du SQL</p>',NULL)");
        SQLS.append(",('testdatalibdata','columnPosition','','en','Column Position','<p>Column position [1,2,3…] representing the value that should be obtained after parsing a CSV file.</p>',NULL)");
        SQLS.append(",('testdatalibdata','columnPosition','','fr','Position','<p>Position [1,2,3…] de la valeur à obtenir lors du décryptage du CSV.</p>',NULL)");
        SQLS.append(",('testdatalibdata','description','','en','Description','<p>Textual description for the sub-data entry.</p>',NULL)");
        SQLS.append(",('testdatalibdata','parsingAnswer','','en','Parsing Answer','<p>XPath or JsonPath expression that allows the user to parse data from the SERVICE response.</p>',NULL)");
        SQLS.append(",('testdatalibdata','parsingAnswer','','fr','Analyse de la réponse',NULL,NULL)");
        SQLS.append(",('testdatalibdata','subData','','en','Sub-data ','<p>Unique name for a sub-data entry. For a test data library entry, this value should be unique.</p>',NULL)");
        SQLS.append(",('testdatalibdata','subData','','fr','Sous-donnée',NULL,NULL)");
        SQLS.append(",('testdatalibdata','value','','en','Value','<p>STATIC value.</p>',NULL)");
        SQLS.append(",('transversal','DateCreated','','en','Creation Date','Date of the creation of the object.',NULL)");
        SQLS.append(",('transversal','DateCreated','','fr','Date de Création','Date de création de l\\'objet.',NULL)");
        SQLS.append(",('transversal','DateModif','','en','Modification Date','Last modification Date of the object.',NULL)");
        SQLS.append(",('transversal','DateModif','','fr','Date de Modification','Date de dernière modification de l\\'objet.',NULL)");
        SQLS.append(",('transversal','UsrCreated','','en','Created by','User who created the object.',NULL)");
        SQLS.append(",('transversal','UsrCreated','','fr','Créé par','Utilisateur ayant créé l\\'objet.',NULL)");
        SQLS.append(",('transversal','UsrModif','','en','Modified by','Last modification date of the object.',NULL)");
        SQLS.append(",('transversal','UsrModif','','fr','Modifié par','Date de dernière modification de l\\'objet.',NULL)");
        SQLS.append(",('user','DefaultSystem','','en','Default System','This is the default <code class=\\'doc-crbvvoca\\'>system</code> the user works on the most. It is used to default the perimeter of <code class=\\'doc-crbvvoca\\'>test case</code> or <code class=\\'doc-crbvvoca\\'>applications</code> displayed on some Cerberus pages.',NULL)");
        SQLS.append(",('user','DefaultSystem','','fr','Système par defaut','Système par defaut',NULL)");
        SQLS.append(",('user','Team','','en','Team','This is the team of the user.',NULL)");
        SQLS.append(",('user','Team','','fr','Equipe','Correspond à l\\'équipe de l\\'utilisateur',NULL)");
        SQLS.append(",('usergroup','GroupName','','en','Group Name','Authorities are managed by group. In order to be granted to a set of feature, you must belong to the corresponding group.<br>Every user can of course belong to as many group as necessary in order to get access to as many feature as required.<br>In order to get the full access to the system you must belong to every group.<br>Some groups are linked together on the test perimeter and integration perimeter.<br><br><b>Test perimeter :</b><br><br><code class=\\'doc-fixed\\'>TestRO</code>: Has read only access to the information related to test cases and also has access to execution reporting options.<br><br><code class=\\'doc-fixed\\'>Test</code>: Can modify non WORKING test cases but cannot delete test cases.<br><br><code class=\\'doc-fixed\\'>TestAdmin</code>: Can modify or delete any test case (including Pre Testing test cases). Can also create or delete a test.<br><br>The minimum group you need to belong is <code class=\\'doc-fixed\\'>TestRO</code> that will give you access in read only to all test data (including its execution reporting page).<br>If you want to be able to modify the testcases (except the WORKING ones), you need <code class=\\'doc-fixed\\'>Test</code> group on top of <code class=\\'doc-fixed\\'>TestRO</code> group.<br>If you want the full access to all testcase (including beeing able to delete any testcase), you will need <code class=\\'doc-fixed\\'>TestAdmin</code> on top of <code class=\\'doc-fixed\\'>TestRO</code> and <code class=\\'doc-fixed\\'>Test</code> group.<br><br><b>Test Data perimeter :</b><br><br><code class=\\'doc-fixed\\'>TestDataManager</code>: Can modify the test data..<br><br><b>Test Execution perimeter :</b><br><br><code class=\\'doc-fixed\\'>RunTest</code>: Can run both Manual and Automated test cases from GUI.<br><br><b>Integration perimeter :</b><br><br><code class=\\'doc-fixed\\'>IntegratorRO</code>: Has access to the integration status.<br><br><code class=\\'doc-fixed\\'>Integrator</code>: Can add an application. Can change parameters of the environments.<br><br><code class=\\'doc-fixed\\'>IntegratorNewChain</code>: Can register the end of the chain execution. Has read only access to the other informations on the same page.<br><br><code class=\\'doc-fixed\\'>IntegratorDeploy</code>: Can disable or enable environments and register new build / revision.<br><br>The minimum group you need to belong is <code class=\\'doc-fixed\\'>IntegratorRO</code> that will give you access in read only to all environment data.<br>If you want to be able to modify the environment data, you need <code class=\\'doc-fixed\\'>Integrator</code> group on top of <code class=\\'doc-fixed\\'>IntegratorRO</code> group.<br><code class=\\'doc-fixed\\'>IntegratorNewChain</code> and <code class=\\'doc-fixed\\'>IntegratorDeploy</code> are used on top of <code class=\\'doc-fixed\\'>Integrator</code> Group to be able to create a new chain on an environment or perform a deploy operation.<br><br><b>Administration perimeter :</b><br><br><code class=\\'doc-fixed\\'>Administrator</code>: Can create, modify or delete users. Has access to log Event and Database Maintenance. Can change Parameter values.',NULL)");
