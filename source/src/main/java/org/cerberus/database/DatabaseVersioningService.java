...
// New updated Documentation.
        ...
        SQLS.append(",('testcase','Status','','Status','It is the workflow status of the <code class=\\'doc-crbvvoca\\'>test case</code> used to follow-up the implementation of the tests. It could be :<br><br><b>STANDBY</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> is created but needs to be analysed to know if we have to implement it or delete it.<br><b>TO BE IMPLEMENTED</b>: We decide to implement this <code class=\\'doc-crbvvoca\\'>test case</code>, but nobody work on it yet.<br><b>IN PROGRESS</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> is being implemented.<br><b>TO BE VALIDATED</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> is correctly implemented but need to be validated by the Test committee.<br><b>WORKING</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> has been validated by the Test Committee.<br><b>CANCELED</b>The <code class=\\'doc-crbvvoca\\'>test case</code> have been canceled because it is useless for the moment.<br><b>TO BE DELETED</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> will be deleted after the validation of Test committee.')");
        ...
        SQLS.append(",('testcasestepaction','Action','calculateProperty','Calculate a Cerberus property.','<b>calculateProperty :</b> When the action expected is to calculate an HTML property, or calculate a property which should not be used with another action like <i>type</i><br><br><dd><u><i>How to feed it :</i></u><br><br><dd><i>Action =</i> calculateProperty, <i>Value =</i> null and <i>Property =</i> The name of the property which should be calculated<br><br><br><br>')");
        SQLS.append(",('testcasestepaction','Action','click','Clicking on a button.','<b>click :</b> When the action expected is to click on a link or a button.<br><br><dd><u><i>How to feed it :</i></u> <br><br><dd><i>Action =</i> click, <i>Value =</i> the <i>id</i> of the link or the button which should be kicked.  and <i>Property =</i> null<br><br><br>')");
        SQLS.append(",('testcasestepaction','Action','clickAndWait','Clicking on a button and waiting some time.','<b>clickAndWait :</b> When the action expected is to click on a link or a button which open a new URL.<br><br><dd><u><i>How to feed it :</i></u> <br><br><dd><i>Action =</i> clickAndWait, <i>Value =</i> the <i>id</i> of the link or the button which should be kicked.  and <i>Property =</i> null<br><br><br>')");
        SQLS.append(",('testcasestepaction','Action','doubleClick','Double clicking on a button.','TBD')");
        SQLS.append(",('testcasestepaction','Action','enter','Press ENTER key.','<b>enter :</b> When the action expected is to emulate a keypress on the enter button.<br><br><dd><u><i>How to feed it :</i></u> <br><br><dd><i>Action =</i> enter, <i>Value =</i> null.  and <i>Property =</i> null<br><br>WARNING: The action is performed on the active window.<br><br><br>')");
        ...
        SQLS.append(",('testcasestepaction','Action','keypress','Press a specific key.','<b>keypress :</b> When the action expected is to emulate a keypress of any key.<br><br><dd><u><i>How to feed it :</i></u> <br><br><dd><i>Action =</i> keypress, <i>Value =</i> The keycode of the key to press.  and <i>Property =</i> null<br><br>WARNING: The action is performed on the active window.<br><br><br>')");
        ...
        SQLS.append(",('testcasestepaction','Action','selectAndWait','Select a value on a combo and wait a certain time.','<b>selectAndWait :</b> When the action expected is to select a value in a select box and wait for a new URL opened.<br><br><dd><u><i>How to feed it :</i></u> <br><br><dd><i>Action =</i> selectAndWait, <i>Value =</i> the <i>id</i> of the select box.  and <i>Property =</i> the property containing the value to select.<br>It could be label=TheExactNameOfTheValue or value=the first letter or the place number of the value expected in the select box<br>For example : label=WEB   , value=W   , value=3 if the WEB is the third value in the selectbox. <br><br><br>')");
        ...
        SQLS.append(",('testcasestepactioncontrol','Type','verifyElementNotPresent',NULL,'TBD')");
        ...
        SQLS.append(",('testcasestepactioncontrol','Type','verifyIntegerGreater',NULL,'TBD')");
        SQLS.append(",('testcasestepactioncontrol','Type','verifyIntegerMinor',NULL,'TBD')");
        SQLS.append(",('testcasestepactioncontrol','Type','verifyRegexInElement',NULL,'TBD')");
        SQLS.append(",('testcasestepactioncontrol','Type','verifyStringDifferent',NULL,'TBD')");
        SQLS.append(",('testcasestepactioncontrol','Type','verifyStringEqual',NULL,'TBD')");
        SQLS.append(",('testcasestepactioncontrol','Type','verifyStringGreater',NULL,'TBD')");
        SQLS.append(",('testcasestepactioncontrol','Type','verifyStringMinor',NULL,'TBD')");
        SQLS.append(",('testcasestepactioncontrol','Type','verifyTextInElement',NULL,'TBD')");
        SQLS.append(",('testcasestepactioncontrol','Type','verifyTextInPage',NULL,'TBD')");
        SQLS.append(",('testcasestepactioncontrol','Type','verifyTextNotInPage',NULL,'TBD')");
