...
// New updated Documentation.
        ...
        SQLS.append(",('testcasestepaction','Action','calculateProperty','Calculate a Cerberus property.','<code class=\\'doc-fixed\\'>calculateProperty</code> will allow you to calculate a property defined in the property section of the test case.<br><br>Examples :<br><doc class=\"examples\"><table cellspacing=0 cellpadding=2><th class=\\'ex\\'>Object</th><th class=\\'ex\\'>Property</th><th class=\\'ex\\'>Result</th><tr><td class=\\'ex\\'>n/a</td><td class=\\'ex\\'>PROPERTY_NAME</td><td class=\\'ex\\'>PROPERTY_NAME will be calculated</td></tr></table></doc>')");
        SQLS.append(",('testcasestepaction','Action','click','Clicking on a button.','<code class=\\'doc-fixed\\'>click</code> will allow you to click on an element inside the current page.<br><br>Examples :<br><doc class=\"examples\"><table cellspacing=0 cellpadding=2><th class=\\'ex\\'>Object</th><th class=\\'ex\\'>Property</th><th class=\\'ex\\'>Result</th><tr><td class=\\'ex\\'>identifier=html_reference</td><td class=\\'ex\\'>n/a</td><td class=\\'ex\\'>html_reference will be clicked</td></tr></table></doc>')");
