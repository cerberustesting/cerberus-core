...
//-- ------------------------ 609-610
        ...
        // Add value2 doUsage to the calculateProperty action.
        //-- ------------------------ 954
        SQLS = new StringBuilder();
        SQLS.append("select 1 from DUAL;");
        SQLInstruction.add(SQLS.toString());
        ...
        SQLS.append(",('testcasecountryproperties','Length','','en','Length','It is the length parameter of the property.<br>The parameter doUsage depend on the <code class=\\'doc-fixed\\'>type</code> of the property.')");
