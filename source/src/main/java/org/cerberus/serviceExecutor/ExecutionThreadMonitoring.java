...
public class ExecutionThreadMonitoring extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            etp.getSize();
            out.println("<h3>Execution Thread Monitoring</h3>");
            out.println("Size Of Queue In Memory: " +etp.getSize());
            out.println("<br>Number of Actual Simultaneous Execution : "+etp.getInExecution());
        } finally {
            out.close();
        }
    }
