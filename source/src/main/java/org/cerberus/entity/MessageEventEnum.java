...
public enum MessageEventEnum {
    ...
    PROPERTY_FAILED_NO_PROPERTY_DEFINITION(151, "", "Warning, Property not defined for %PROP% and country %COUNTRY%.", false, true, true, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
