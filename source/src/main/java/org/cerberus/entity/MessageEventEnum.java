...
public enum MessageEventEnum {
    ...
    CONTROL_FAILED_TEXTNOTINELEMENT_NO_SUCH_ELEMENT(369, "KO", "Failed to verifyText because could not find element '%ELEMENT%'", true, true ,true , MessageGeneralEnum.EXECUTION_KO),
