...
public enum MessageEventEnum {
    ...
    ACTION_FAILED_NO_ELEMENT_TO_CLICK(254, "FA", "Object and Property are ‘null’. At least one is mandatory in order to perform the action click.", true, true ,true , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    CONTROL_FAILED_SELENIUM_CONNECTIVITY(354, "CA", "The test case is canceled due to lost connection to Selenium Server! Detailed error : %ERROR%", true, true ,true , MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_TEXTINELEMENT_NO_SUCH_ELEMENT(369, "KO", "Failed to verifyText because could not find element '%ELEMENT%'", true, true ,true , MessageGeneralEnum.EXECUTION_KO),
