...
public enum MessageEventEnum {
    ...
    PROPERTY_FAILED(150, "KO", "PROPERTY_ERROR Generic error on getting the property.", true, false ,false , MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_NO_PROPERTY_DEFINITION(151, "", "Warning, Property not defined for %PROP% and country %COUNTRY%.", false, false ,false , MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_FAILED_SQL(152, "KO", "An error occur when connecting to ?! Error detail: ?", true, false ,false , MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_SQL_NODATA(153, "KO", "The SQL performed against database %DB% and JDBCPOOL %JDBCPOOLNAME% returned no data to test. SQL : %SQL%", true, false ,false , MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_SQL_ERROR(154, "KO", "The SQL '%SQL%' has an error : '%EX%'.", true, false ,false , MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_SQL_CANNOTACCESSJDBC(155, "KO", "An error occur when connecting to JDBC datasource '%JDBC%'. Please verify with your administrator that the JDBC is configured inside the application server. Error detail: %EX%", true, false ,false , MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_SQL_JDBCPOOLNOTCONFIGURED(156, "KO", "The JDBC connection pool name does not exist for the corresponding System : %SYSTEM% Country : %COUNTRY%, environment : %ENV% and database : %DB% . Please define it inside the database.", true, false ,false , MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_SQL_EMPTYJDBCPOOL(157, "KO", "The JDBC connection pool name is empty for the corresponding System : %SYSTEM% Country : %COUNTRY%, environment : %ENV% and database : %DB% . Please define it inside the database.", true, false ,false , MessageGeneralEnum.EXECUTION_FA),
    ...
    PROPERTY_FAILED_HTML_ELEMENTDONOTEXIST(180, "KO", "Failed to calculate property because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_HTMLVISIBLE_ELEMENTDONOTEXIST(181, "KO", "Failed to calculate visible html property because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA),
    ...
    PROPERTY_FAILED_TESTDATA_PROPERTYDONOTEXIST(184, "KO", "TestData %PROPERTY% do not exist!", true, true ,false , MessageGeneralEnum.EXECUTION_NA),
    ...
    PROPERTY_FAILED_GETFROMXML(186, "NA", "Failed to get Data from '%VALUE1%' because could not find '%VALUE2%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMCOOKIE_COOKIENOTFOUND(187, "NA", "Failed to get Parameter '%PARAM%' because could not find cookie '%COOKIE%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMCOOKIE_PARAMETERNOTFOUND(187, "NA", "Cannot find Parameter '%PARAM%' form Cookie '%COOKIE%'. Parameter do not exist or is not supported!", true, true ,false , MessageGeneralEnum.EXECUTION_FA),
    ...
    ACTION_SUCCESS_CLOSE_ALERT(200, "OK", "Alert popup is closed !", true, true ,false , MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_FAILED_CLICK(251, "FA", "Failed to click on '%ELEMENT%'.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_SELENIUM_CONNECTIVITY(252, "CA", "The test case is canceled due to lost connection to Selenium Server!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_NO_SUCH_ELEMENT(253, "FA", "Identifier '?=' isn't recognized! Use: id=, name=, class=, css= or xpath=.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_NO_ELEMENT_TO_CLICK(254, "FA", "Object and Property are ‘null’. At least one is mandatory in order to perform the action click.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_CLICKANDWAIT_GENERIC(255, "FA", "Object is 'null'. This is mandatory in order to perform the action click and wait.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_CLICKANDWAIT(256, "FA", "Element '%ELEMENT%' clicked but failed to wait '%TIME%' ms.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_TYPE(257, "FA", "Object and/or Property are ‘null’. Both are mandatory in order to perform the action type.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_DOUBLECLICK(258, "FA", "Object and Property are ‘null’. At least one is mandatory in order to perform the action double click.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_URLLOGIN(259, "FA", "Failed to open '%URL%'.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_MOUSEOVER(260, "FA", "Object and property are ‘null’. At least one is mandatory in order to perform the action mouse over.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_MOUSEOVERANDWAIT_GENERIC(261, "FA", "Object is 'null'. This is mandatory in order to perform the action mouse over and wait.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_MOUSEOVERANDWAIT(262, "FA", "Mouse over '%ELEMENT%' but failed to wait '%TIME%' ms.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_WAIT(263, "FA", "Failed to wait '%TIME%' ms.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_KEYPRESS(264, "FA", "Object and/or Property are ‘null’. Both are mandatory in order to perform the action type.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_OPENURL(265, "FA", "Failed to open '%URL%'.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_SELECT(266, "FA", "Object and/or Property are ‘null’. Both are mandatory in order to perform the action type.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_CLICK_NO_SUCH_ELEMENT(267, "FA", "Failed to click because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_DOUBLECLICK_NO_SUCH_ELEMENT(268, "FA", "Failed to double click because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_TYPE_NO_SUCH_ELEMENT(269, "FA", "Failed to type because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_MOUSEOVER_NO_SUCH_ELEMENT(270, "FA", "Failed to move mouse over because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_WAIT_NO_SUCH_ELEMENT(271, "FA", "Failed to wait because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_KEYPRESS_NO_SUCH_ELEMENT(272, "FA", "Failed to press key because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_SELECT_NO_SUCH_ELEMENT(273, "FA", "Failed to select because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_SELECT_NO_IDENTIFIER(274, "FA", "Identifier '%IDENTIFIER%=' isn't recognized! Use: value=, label= or index=.", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_CLICKANDWAIT_NO_NUMERIC(275, "FA", "Failed to wait because '%TIME%' in not numeric!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_MOUSEOVERANDWAIT_NO_NUMERIC(276, "FA", "Failed to wait because '%TIME%' in not numeric!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_SELECT_NO_SUCH_VALUE(279, "FA", "Found the element '%ELEMENT%', but failed to select because could not find '%DATA%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_FOCUS_NO_SUCH_ELEMENT(280, "FA", "Failed to focus to iframe because could not find element '%IFRAME%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_SELECT_REGEX_INVALIDPATERN(281, "FA", "Pattern '%PATERN%' is not valid. Detailed error : %ERROR%", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_MOUSEUP_NO_SUCH_ELEMENT(282, "FA", "Failed to release click because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_MOUSEDOWN_NO_SUCH_ELEMENT(283, "FA", "Failed to left click because could not find element '%ELEMENT%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_SWITCHTOWINDOW_NO_SUCH_ELEMENT(280, "FA", "Failed to switch to window because could not find element '%WINDOW%'!", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_CLOSE_ALERT(280, "FA", "Failed to close to alert popup !", true, true ,false , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    CONTROL_FAILED_NO_SUCH_ELEMENT(353, "FA", "Element '%ELEMENT%' doesn't exist. Selenium Exception : %SELEX%.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_SELENIUM_CONNECTIVITY(354, "CA", "The test case is canceled due to lost connection to Selenium Server! Detailed error : %ERROR%", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_PRESENT(361, "KO", "Element '%STRING1%' is not present on the page.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_PRESENT_NULL(362, "KO", "Object is 'null'. This is mandatory in order to perform the control verify element present", true, false ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_NOTPRESENT(363, "KO", "Element '%STRING1%' is present on the page.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_NOTPRESENT_NULL(364, "KO", "Object is 'null'. This is mandatory in order to perform the control verify element not present", true, false ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_VISIBLE(365, "KO", "Element '%STRING1%' not visible on the page.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_NOTVISIBLE(365, "KO", "Element '%STRING1%' is visible on the page.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_VISIBLE_NULL(366, "KO", "Object is 'null'. This is mandatory in order to perform the control verify element visible", true, false ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_NOTVISIBLE_NULL(366, "KO", "Object is 'null'. This is mandatory in order to perform the control verify element not visible", true, false ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TEXTINELEMENT(367, "KO", "Element '%STRING1%' with value '%STRING2%' is not equal to '%STRING3%'.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TEXTINELEMENT_NULL(368, "KO", "Found Element '%STRING1%' but can not find text or value.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TEXTINELEMENT_NO_SUCH_ELEMENT(369, "KO", "Failed to verifyText because could not find element '%ELEMENT%'", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TEXTINPAGE(370, "KO", "Pattern '%STRING1%' not found in page!", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TEXTINPAGE_INVALIDPATERN(371, "KO", "Pattern '%PATERN%' is not valid. Detailed error : %ERROR%", true, false ,false , MessageGeneralEnum.EXECUTION_FA),
    CONTROL_FAILED_URL(372, "KO", "Current page '%STRING1%' is not equal to '%STRING2%'", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TITLE(373, "KO", "Current title '%STRING1%' is not equal to '%STRING2%'", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TEXTNOTINPAGE(374, "KO", "Pattern '%STRING1%' found in page!", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TEXTNOTINPAGE_INVALIDPATERN(375, "KO", "Pattern '%PATERN%' is not valid. Detailed error : %ERROR%", true, false ,false , MessageGeneralEnum.EXECUTION_FA),
    CONTROL_FAILED_REGEXINELEMENT(376, "KO", "Element '%STRING1%' with value '%STRING2%' does not match '%STRING3%'.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_REGEXINELEMENT_NULL(377, "KO", "Object is 'null'. This is mandatory in order to perform the control verify regex in element", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_REGEXINELEMENT_NO_SUCH_ELEMENT(378, "KO", "Failed to verifyRegex because could not find element '%ELEMENT%'", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_REGEXINELEMENT_INVALIDPATERN(379, "KO", "Pattern '%PATERN%' is not valid. Detailed error : %ERROR%", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TEXTINALERT(380, "KO", "Alert text with value '%STRING1%' does not match '%STRING2%'.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_TEXTINALERT_NULL(381, "KO", "Alert popup does not have text.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_CONTAINS(382, "KO", "'%STRING1%' does not contain '%STRING2%'.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_ELEMENTINELEMENT(383, "KO", "Element '%STRING1%' is not child of element '%STRING2%'.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_CLICKABLE(386, "KO", "Element '%ELEMENT%' is not clickable.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_NOTCLICKABLE(387, "KO", "Element '%ELEMENT%' is clickable but it shouldn't.", true, true ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_CLICKABLE_NULL(362, "KO", "Object is 'null'. This is mandatory in order to perform the control verify element clickable", true, false ,false , MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_NOTCLICKABLE_NULL(362, "KO", "Object is 'null'. This is mandatory in order to perform the control verify element not clickable", true, false ,false , MessageGeneralEnum.EXECUTION_KO),
