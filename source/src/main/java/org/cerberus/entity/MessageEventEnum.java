...
public enum MessageEventEnum {
    ...
    ACTION_SUCCESS_CLOSE_ALERT(200, "OK", "Alert popup is closed !", false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_FAILED_SWITCHTOWINDOW_NO_SUCH_ELEMENT(284, "FA", "Failed to switch to window because could not find element '%WINDOW%'!", true, true, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_CLOSE_ALERT(285, "FA", "Failed to close to alert popup !", true, true, MessageGeneralEnum.EXECUTION_FA_ACTION),
