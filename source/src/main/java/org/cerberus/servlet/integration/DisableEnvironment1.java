 ...
 * @author vertigo
 */
@WebServlet(name = "DisableEnvironment1", urlPatterns = {"/DisableEnvironment1"})
public class DisableEnvironment1 extends HttpServlet {
...
//        AnswerItem answer = new AnswerItem(msg);
            ...
            if (!(answerItem.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode()) && answerItem.getItem()!=null)) {
                ...
                if (!(answer.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode()))) {
                    ...
                    try {
                        ...
                        Logger.getLogger(DisableEnvironment1.class.getName()).log(Level.SEVERE, Infos.getInstance().getProjectNameAndVersion() + " - Exception catched.", e);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DisableEnvironment1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
