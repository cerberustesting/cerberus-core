...
public class ReadTag1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            org.apache.log4j.Logger.getLogger(ReadTag1.class.getName()).log(org.apache.log4j.Level.ERROR, null, e);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReadTag1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    }
