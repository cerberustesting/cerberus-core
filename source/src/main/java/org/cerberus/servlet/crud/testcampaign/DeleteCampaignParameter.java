 ...
 * @author memiks
 */
@WebServlet(name = "DeleteCampaignParameter", urlPatterns = {"/DeleteCampaignParameter"})
public class DeleteCampaignParameter extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        campaignService.deleteCampaignParameter(factoryCampaignParameter.create(Integer.parseInt(id), null, null, null));
    }
}
