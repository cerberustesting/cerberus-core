 ...
 * @author cerberus
 */
@WebServlet(name = "UpdateTest1", urlPatterns = {"/UpdateTest1"})
public class UpdateTest1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (StringUtil.isNullOrEmpty(test)) {
            ...
            if (!(resp.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode()) && resp.getItem()!=null)) {
                ...
                ans = testService.update(testData);
                  ...
                  if (ans.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode())) {
                    ...
                    logEventService.createForPrivateCalls("/UpdateTest", "UPDATE", "Updated Test : ['" + test + "']", request);
                }
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateTest1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
