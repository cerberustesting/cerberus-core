 ...
 * @author ip100003
 */
@WebServlet(name = "UpdateParameter2", urlPatterns = {"/UpdateParameter2"})
public class UpdateParameter2 extends HttpServlet {
