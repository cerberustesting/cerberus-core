...
public class ReadCountryEnvLink extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            org.apache.log4j.Logger.getLogger(ReadCountryEnvLink.class.getName()).log(org.apache.log4j.Level.ERROR, null, e);
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReadCountryEnvLink.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private JSONObject convertToJSONObject(CountryEnvLink object) throws JSONException {
        Gson gson = new Gson();
