...
public class ReadSqlLibrary extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("name") == null && Strings.isNullOrEmpty(columnName)){
                ...
                answer = findSqlLibraryBySystemByKey(request.getParameter("name"), appContext);
                jsonResponse = (JSONObject) answer.getItem();
            }
    ...
    private AnswerItem findSqlLibraryBySystemByKey(String key,ApplicationContext appContext) throws JSONException {
        ...
        resp.setItem(convertSqlLibraryToJSONObject(p));
