...
public class CreateTestCaseExecutionFile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String extension = ParameterParserUtil.parseStringParamAndDecodeAndSanitize(fileData.get("type"), null, charset);
        ...
        if (file == null) {
            ...
            msg.setDescription(msg.getDescription().replace("%ITEM%", "Testcase execution file")
            ...
            if (ans.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode())) {
                ...
                logEventService.createForPrivateCalls("/CreateTestCaseExecutionFile", "CREATE", "Create execution file", request);
            }
        }
