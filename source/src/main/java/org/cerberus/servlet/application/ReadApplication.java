...
public class ReadApplication extends HttpServlet {
        ...
        try {
            ...
            if (request.getParameter("action") == null) {
                ...
                if (actionParameter == 1) {
                    ...
                    answer = findApplicationByID(appContext, application);
                    jsonResponse = (JSONObject) answer.getItem();
                }
            }
    ...
    private AnswerItem findApplicationList(ApplicationContext appContext, HttpServletRequest request, HttpServletResponse response) throws JSONException {
        ...
        AnswerList resp = applicationService.findApplicationListByCriteria(startPosition, length, columnName, sort, searchParameter, "");
    ...
    private AnswerItem findApplicationByID(ApplicationContext appContext, String id) throws JSONException, CerberusException {
        AnswerItem item = new AnswerItem();
