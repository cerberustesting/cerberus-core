...
public class ResultCI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        logEventService.createPublicCalls_Deprecated("/ResultCI", "CALL", "ResultCIV0 called : " + request.getRequestURL(), request);
        ...
        try {
            ...
            if (!error) {
                ...
                logEventService.createPublicCalls_Deprecated("/ResultCI", "CALLRESULT", "ResultCI calculated with result [" + result + "] : " + nbkop1 + "*" + pond1 + " + " + nbkop2 + "*" + pond2 + " + " + nbkop3 + "*" + pond3 + " + " + nbkop4 + "*" + pond4 + " = " + resultCal, request);
