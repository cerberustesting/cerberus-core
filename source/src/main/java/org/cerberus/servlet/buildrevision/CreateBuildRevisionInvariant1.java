 ...
 * @author bcivel
 */
@WebServlet(name = "CreateBuildRevisionInvariant1", urlPatterns = {"/CreateBuildRevisionInvariant1"})
public class CreateBuildRevisionInvariant1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CreateBuildRevisionInvariant1.class.getName()).log(Level.SEVERE, null, ex);
