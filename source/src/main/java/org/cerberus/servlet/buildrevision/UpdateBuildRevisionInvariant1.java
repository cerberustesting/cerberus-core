...
public class UpdateBuildRevisionInvariant1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateBuildRevisionInvariant1.class
                    .getName()).log(Level.SEVERE, null, ex);
        } catch (JSONException ex) {
            Logger.getLogger(UpdateBuildRevisionInvariant1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
