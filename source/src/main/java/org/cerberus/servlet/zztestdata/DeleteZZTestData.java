 ...
 * @author bcivel
 */
public class DeleteZZTestData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            zzTestDataService.deleteZZTestData(testData);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeleteZZTestData.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
