...
/**
 * A {@link PostableHttpServlet} that can be publicly published
 *
 * @author Aurelien Bourdon
 */
public abstract class PublicPostableHttpServlet<REQUEST extends Validable, RESPONSE> extends PostableHttpServlet<REQUEST, RESPONSE> {
