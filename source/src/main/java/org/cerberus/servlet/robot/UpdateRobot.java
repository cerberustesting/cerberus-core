...
public class UpdateRobot extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                org.apache.log4j.Logger.getLogger(UpdateRobot.class.getName()).log(org.apache.log4j.Level.ERROR, null, ex);
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            MyLogger.log(UpdateRobot.class.getName(), Level.FATAL, ex.toString());
        }
    }
