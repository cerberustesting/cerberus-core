...
public class EventHook {
    ...
    public String toString() {
        return "EventHook{" + "id=" + id + ", eventReference=" + eventReference + ", isActive=" + isActive + ", ObjectKey1=" + objectKey1 + ", ObjectKey2=" + objectKey2 + ", HookConnector=" + hookConnector + ", usrCreated=" + usrCreated + ", dateCreated=" + dateCreated + ", usrModif=" + usrModif + ", dateModif=" + dateModif + '}';
    }
}
