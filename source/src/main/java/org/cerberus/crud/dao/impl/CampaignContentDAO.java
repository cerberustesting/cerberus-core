...
public class CampaignContentDAO implements ICampaignContentDAO {
    ...
    private static final Logger LOG = Logger.getLogger(CampaignContentDAO.class);
    ...
    private static interface Query {
         ...
         */
        String UPDATE = "UPDATE `campaigncontent` SET `campaign` = ? AND `testbattery` = ? WHERE `campaigncontentID` = ?";
