...
public interface IFactoryTestCaseStepActionControlExecution {
    ...
    TestCaseStepActionControlExecution create(long id, String test, String testCase, int step,
            int sequence, int controlSequence, int sort, String returnCode, String returnMessage, String conditionOper, String conditionVal1, String conditionVal2, String control,
