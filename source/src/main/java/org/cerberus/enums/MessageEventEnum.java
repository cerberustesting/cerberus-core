...
public enum MessageEventEnum {
    ...
    **/
    ...
    PROPERTY_FAILED_SQL_NODATA(904, "NA", "The SQL performed against database %DB% and JDBC Ressource %JDBCPOOLNAME% returned no data to test. SQL : %SQL%", true, false, false, MessageGeneralEnum.EXECUTION_NA),
