...
public enum MessageEventEnum {
    ...
    PROPERTY_SUCCESS_GETFROMDATALIB_STATIC(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
