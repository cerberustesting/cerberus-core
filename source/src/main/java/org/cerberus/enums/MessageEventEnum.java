...
public enum MessageEventEnum {
    ...
    PROPERTY_SUCCESS_GETFROMDATALIB_STATIC_STATIC(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_STATIC_RANDOM(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. Random result (position %POS% from %TOTALPOS%) fetch from TestDataLbrary (%ENTRYSELID%). %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_STATIC_RANDOMNEW(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. Out of %TOTNB% entries, %REMNB% removed (Already used for the same property name, testcase in the same country environment and build). Random result (position %POS% from %TOTALPOS%) taken (%ENTRYSELID%). %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_STATIC_NOTINUSE(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. Out of %TOTNB% entries, %REMNB% removed (Recent pending (PE) executions for the same property name in the same country, environment). Random result (position %POS% from %TOTALPOS%) taken (%ENTRYSELID%). %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_SQL_STATIC(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. First result fetch from SQL executed against database '%DB%' and JDBCPOOL '%JDBCPOOLNAME%'. SQL : '%SQL%'. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_SQL_RANDOM(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. Random result (position %POS% from %TOTALPOS%) fetch from SQL executed against database '%DB%' and JDBCPOOL '%JDBCPOOLNAME%'. SQL : '%SQL%'. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_SQL_RANDOMNEW(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. Out of %TOTNB% entries, %REMNB% removed (Already used for the same property name, testcase in the same country environment and build). Random result (position %POS% from %TOTALPOS%) taken. Data fetched from SQL executed against database '%DB%' and JDBCPOOL '%JDBCPOOLNAME%'. SQL : '%SQL%'. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_SQL_NOTINUSE(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. Out of %TOTNB% entries, %REMNB% removed (Recent pending (PE) executions for the same property name in the same country, environment). Random result (position %POS% from %TOTALPOS%) taken. Data fetched from SQL executed against database '%DB%' and JDBCPOOL '%JDBCPOOLNAME%'. SQL : '%SQL%'. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_SOAP_STATIC(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. First result fetch from XML from Service '%SERVICE%' and Operation '%OPERATION%'. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_SOAP_RANDOM(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. Random result (position %POS% from %TOTALPOS%) fetch from XML from Service '%SERVICE%' and Operation '%OPERATION%'. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_SOAP_RANDOMNEW(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. Out of %TOTNB% entries, %REMNB% removed (Already used for the same property name, testcase in the same country environment and build). Random result (position %POS% from %TOTALPOS%) taken. Data fetched from XML from Service '%SERVICE%' and Operation '%OPERATION%'. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    PROPERTY_SUCCESS_GETFROMDATALIB_SOAP_NOTINUSE(100, "OK", "Data Library entry %ENTRY% (%ENTRYID%) retrieved with success. Out of %TOTNB% entries, %REMNB% removed (Recent pending (PE) executions for the same property name in the same country, environment). Random result (position %POS% from %TOTALPOS%) taken. Data fetched from XML from Service '%SERVICE%' and Operation '%OPERATION%'. %RESULTVALUE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    PROPERTY_SUCCESS_GETFROMDATALIBDATA_GETSUBDATA(100, "OK", "Subdata '%SUBDATA%' retrieved from Property '%PROP%' with success.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_NOT_FOUND_ERROR(904, "FA", "The test data library entry %ITEM% is not available for the selected system %SYSTEM%, environment %ENVIRONMENT% and country %COUNTRY%.", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_NOT_EXIST_ERROR(904, "FA", "The test data library entry %ITEM% do not exist.", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_STATIC_GENERIC(192, "FA", "An error occurred while calculating the data from test data library entry '%ENTRY%' (%ENTRYID%)!", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_STATIC_NODATA(153, "NA", "The Static Test Data Library returned no data to test.", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_GETFROMDATALIB_STATIC_RANDOMNEW_NOMORERECORD(904, "NA", "Data Library entry %ENTRY% (%ENTRYID%) retrieved but there are no more data available. All %TOTNB% entries, has been removed (Already used for the same property name, testcase in the same country environment and build). Data fetched from TestDataLib.", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_GETFROMDATALIB_STATIC_NOTINUSE_NOMORERECORD(904, "NA", "Data Library entry %ENTRY% (%ENTRYID%) retrieved but there are no more data available. All %TOTNB% entries, has been removed (Recent pending (PE) executions for the same property name in the same country, environment). Data fetched from TestDataLib.", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_GETFROMDATALIB_SQL_GENERIC(192, "FA", "An error occurred while calculating the SQL from test data library entry %ENTRY% (%ENTRYID%)! Database: %DATABASE%, SQL: %SQL%", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_SQL_COLUMNNOTMATCHING(192, "FA", "When loading the Data Library entry %ENTRY% (%ENTRYID%), some column(s) do not match with the SQL Query! Columns mapping in error : %BADCOLUMNS%. Database: %DATABASE%. SQL: %SQL%", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_SQL_NOCOLUMNMATCH(192, "FA", "When loading the Data Library entry %ENTRY% (%ENTRYID%), none of the column match with the SQL Query! Columns mapping in error : %BADCOLUMNS%. Database: %DATABASE%. SQL: %SQL%", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_SQL_NODATA(192, "NA", "SQL return no result for SQL test data library entry '%ENTRY%' (%ENTRYID%) ! Database: %DATABASE%, SQL: %SQL%", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_GETFROMDATALIB_SQL_RANDOMNEW_NOMORERECORD(904, "NA", "Data Library entry %ENTRY% (%ENTRYID%) retrieved but there are no more data available. All %TOTNB% entries, has been removed (Already used for the same property name, testcase in the same country environment and build). Data fetched from SQL executed against database '%DB%' and JDBCPOOL '%JDBCPOOLNAME%'. SQL : '%SQL%'", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_GETFROMDATALIB_SQL_NOTINUSE_NOMORERECORD(904, "NA", "Data Library entry %ENTRY% (%ENTRYID%) retrieved but there are no more data available. All %TOTNB% entries, has been removed (Recent pending (PE) executions for the same property name in the same country, environment). Data fetched from SQL executed against database '%DB%' and JDBCPOOL '%JDBCPOOLNAME%'. SQL : '%SQL%'", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_GETFROMDATALIB_SOAP_RANDOMNEW_NOMORERECORD(904, "NA", "Data Library entry %ENTRY% (%ENTRYID%) retrieved but there are no more data available. All %TOTNB% entries, has been removed (Already used for the same property name, testcase in the same country environment and build). Data fetched from XML from Service '%SERVICE%' and Operation '%OPERATION%'..", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_GETFROMDATALIB_SOAP_NOTINUSE_NOMORERECORD(904, "NA", "Data Library entry %ENTRY% (%ENTRYID%) retrieved but there are no more data available. All %TOTNB% entries, has been removed (Recent pending (PE) executions for the same property name in the same country, environment). Data fetched from XML from Service '%SERVICE%' and Operation '%OPERATION%'..", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_SOAP_URLKOANDNODATABASE(197, "FA", "The service URL '%SERVICEURL%' is not a valid URL and the corresponding DatabaseURL is not defined to prefix it - Library entry '%ENTRY%' (%ENTRYID%).", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_SOAP_URLKOANDDATABASESOAPURLNOTEXIST(197, "FA", "The service URL '%SERVICEURL%' is not a valid URL and the corresponding DatabaseURL %DB% is not configured on the system %SYSTEM%, country %COUNTRY%, Environment %ENV% - Library entry '%ENTRY%' (%ENTRYID%).", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_SOAP_URLKO(197, "FA", "The service URL '%SERVICEURL%' (Calculated from concatenation of '%SOAPURL%' with '%SERVICEPATH%') is not a valid URL - Library entry '%ENTRY%' (%ENTRYID%).", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_SOAP_URLKOANDDATABASESOAPURLEMPTY(197, "FA", "The service URL '%SERVICEURL%' is not a valid URL and the corresponding DatabaseURL %DB% on the system %SYSTEM%, country %COUNTRY%, Environment %ENV% has no SoapURL defined - Library entry '%ENTRY%' (%ENTRYID%).", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_SOAP_XML_NOTFOUND(197, "NA", "No elements found! The evaluation of the xpath expression '%XPATH%' specified in the sub-data entry '%SUBDATA%' for the library entry '%ENTRY%' (%ENTRYID%) didn't match any XML elements! inside XML %XMLCONTENT%", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_CSV_FILENOTFOUND(194, "FA", "An error occurred while trying to get CSV file calling %URL%.", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    ...
    ACTION_FAILED_CALLSOAP(286, "FA", "Failed to call the SOAP Operation '%SOAPNAME%' on Service Path %SERVICEPATH% ! Caused by : %DESCRIPTION%.%ERRORDETAILMESSAGE%", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
