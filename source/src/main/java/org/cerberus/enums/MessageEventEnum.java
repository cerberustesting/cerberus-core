...
public enum MessageEventEnum {
    ...
    PROPERTY_FAILED_GETFROMDATALIB_CSV_URLKOANDDATABASECSVURLNOTEXIST(197, "FA", "The CSV service URL '%SERVICEURL%' is not a valid URL and the corresponding Csv DatabaseURL %DB% is not configured on the system %SYSTEM%, country %COUNTRY%, Environment %ENV%", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_CSV_URLKOANDDATABASECSVURLEMPTY(197, "FA", "The CSV service URL '%SERVICEURL%' is not a valid URL and the corresponding Csv DatabaseURL %DB% on the system %SYSTEM%, country %COUNTRY%, Environment %ENV% has no CsvURL defined", true, false, false, MessageGeneralEnum.EXECUTION_FA),
