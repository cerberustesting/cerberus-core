...
public enum MessageEventEnum {
    ...
    ACTION_SUCCESS_EXECUTESHELL(200, "OK", "Shell executed : %LOG%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_FAILED_EXECUTESHELL(297, "FA", "Failed to execute shell : %EXCEPTION%.", true, true, true, MessageGeneralEnum.EXECUTION_FA_ACTION),
