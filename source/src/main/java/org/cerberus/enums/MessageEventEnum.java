...
public enum MessageEventEnum {
    ...
    PROPERTY_SUCCESS_GETFROMDATALIB_STATIC(100, "OK", "%NBROW% row(s) retrieved  from STATIC Test Data lib with success", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    PROPERTY_SUCCESS_GETFROMDATALIB_STATIC_NODATA(100, "OK", "No data was retrieved from DataStatic lib %SYSTEM% %ENV% %COUNTRY%.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_GLOBAL_NODATALEFT(153, "NA", "Data Library entry %ENTRY% (%ENTRYID%) failed . %DATAMESSAGE% but %FILTERNATUREMESSAGE%.", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    PROPERTY_FAILED_GETFROMDATALIB_GLOBAL_NODATA(153, "NA", "Data Library entry %ENTRY% (%ENTRYID%) failed . %DATAMESSAGE% but %FILTERNATUREMESSAGE%.", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_STATIC(153, "FA", "Error occured when retrieving the data for lib %SYSTEM% %ENV% %COUNTRY%.", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_STATICNODATA(904, "NA", "No data for the data for lib %SYSTEM% %ENV% %COUNTRY%.", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_SUBDATASQL(153, "FA", "Error when retreiving subdata.", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    PROPERTY_FAILED_GETFROMDATALIB_SUBDATASOAP(153, "FA", "Error when retreiving subdata.", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_RANDOMNEW_NOMORERECORD(904, "NA", "there are no more data available. All %TOTNB% entries, has been removed (Already used for the same property name, testcase in the same country environment and build).", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_SOAP_URLKOANDDATABASESOAPURLNOTEXIST(197, "FA", "The service URL '%SERVICEURL%' is not a valid URL and the corresponding DatabaseURL %DB% is not configured on the system %SYSTEM%, country %COUNTRY%, Environment %ENV%", true, false, false, MessageGeneralEnum.EXECUTION_FA),
    ...
    PROPERTY_FAILED_GETFROMDATALIB_SOAP_URLKOANDDATABASESOAPURLEMPTY(197, "FA", "The service URL '%SERVICEURL%' is not a valid URL and the corresponding DatabaseURL %DB% on the system %SYSTEM%, country %COUNTRY%, Environment %ENV% has no SoapURL defined", true, false, false, MessageGeneralEnum.EXECUTION_FA),
