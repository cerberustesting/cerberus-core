...
public enum MessageEventEnum {
    ...
    ACTION_SUCCESS_CALLSERVICE_SEARCHKAFKA(200, "OK", "'%SERVICEMETHOD%' Call to Kafka topic '%TOPIC%' executed successfully. All %NBEVENT% event(s) retrieved in %NBSEC% second(s).", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ACTION_SUCCESS_CALLSERVICE_SEARCHKAFKAPARTIALRESULT(200, "OK", "'%SERVICEMETHOD%' Call to Kafka topic '%TOPIC%' executed successfully. Only %NBEVENT% event(s) retrieved in %NBSEC% second(s).", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_SUCCESS_NOTCONTAINS(300, "OK", "'%STRING1%' does not contains '%STRING2%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_FAILED_NOTCONTAINS(382, "KO", "'%STRING1%' contain '%STRING2%'.", true, true, false, MessageGeneralEnum.EXECUTION_KO),
