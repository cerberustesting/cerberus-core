...
public enum MessageEventEnum {
    ...
    ACTION_FAILED_KEYPRESS(264, "FA", "Element and KeyValue are both mandatory in order to perform the action.", true, true, true, MessageGeneralEnum.EXECUTION_FA_ACTION),
