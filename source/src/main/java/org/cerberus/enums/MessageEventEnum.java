...
public enum MessageEventEnum {
    ...
    PROPERTY_FAILED_GETFROMDATALIB_GLOBAL_NOTENOUGHTDATA(153, "NA", "Data Library entry %ENTRY% (%ENTRYID%) failed . %DATAMESSAGE% but this is not enought in order to provide the requested %NBREQUEST% row(s).", true, false, false, MessageGeneralEnum.EXECUTION_NA),
