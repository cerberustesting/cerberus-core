...
public enum MessageEventEnum {
    ...
    ACTION_SUCCESS_SETHARCONTENT(200, "OK", "HAR Network traffic set to current content.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_FAILED_SETHARCONTENT(259, "FA", "Failed to set HAR Content. : %DETAIL%", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_SETHARCONTENT_ROBOTEXECUTORPROXYNOTACTIVATED(259, "NE", "This action is not executed because robot proxy is not activated or proxy host not defined. Please configure the robot '%ROBOT%' executor '%EXECUTOR%' in order to enable the feature.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTEXECUTING),
    // *********** EXECUTION CONTROLS ***********
