...
public enum MessageEventEnum {
    ...
    PROPERTY_FAILED_GETFROMDATALIB_SQL_NOCOLUMNMATCH(192, "FA", "When loading the Data Library entry %ENTRY% (%ENTRYID%), no column were matched! Database: %DATABASE%, SQL: %SQL%", true, false, false, MessageGeneralEnum.EXECUTION_FA),
