...
public enum MessageEventEnum {
    ...
    PROPERTY_SUCCESS_GETFROMNETWORKTRAFFIC(100, "OK", "Path '%PARAM%' from Network Traffic Json has been found and returned '%VALUE%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_SUCCESS_SETNETWORKTRAFFICCONTENT(200, "OK", "HAR Network traffic (JSON format) set to current content.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
