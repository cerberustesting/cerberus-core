...
public enum MessageEventEnum {
    ...
    CONTROL_SUCCESS_TEXTINELEMENT(300, "OK", "Element '%STRING1%' with value '%STRING2%' is equal to %STRING3%, %STRING4%.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_TEXTNOTINELEMENT(300, "OK", "Element '%STRING1%' with value '%STRING2%' is different than %STRING3%, %STRING4%.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_FAILED_TEXTINELEMENT(367, "KO", "Element '%STRING1%' with value '%STRING2%' is not equal to %STRING3%, %STRING4%.", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_TEXTNOTINELEMENT(367, "KO", "Element '%STRING1%' with value '%STRING2%' is not different than %STRING3%, %STRING4%.", true, true, true, MessageGeneralEnum.EXECUTION_KO),
