...
public enum MessageEventEnum {
    ...
    CONTROL_FAILED_TEXTINELEMENT(367, "KO", "Element '%STRING1%' with value '%STRING2%' is not equal to '%STRING3%' with case sensitive constraint : '%STRING4%'.", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONDITIONEVAL_FALSE_STRINGEQUAL(1210, "NA", "'%STR1%' is not equal to '%STR2%' with case sensitive constraint : '%STRING3%'", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONDITIONEVAL_FALSE_STRINGDIFFERENT(1210, "NA", "'%STR1%' is not different from '%STR2%' with case sensitive constraint : '%STRING3%'", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONDITIONEVAL_FALSE_STRINGCONTAINS(1210, "NA", "'%STR1%' does contain '%STR2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONDITIONEVAL_FALSE_STRINGNOTCONTAINS(1210, "NA", "'%STR1%' contain '%STR2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONDITIONEVAL_TRUE_STRINGEQUAL(1210, "OK", "'%STR1%' is equal to '%STR2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONDITIONEVAL_TRUE_STRINGDIFFERENT(1210, "OK", "'%STR1%' is different from '%STR2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONDITIONEVAL_TRUE_STRINGCONTAINS(1210, "OK", "'%STR1%' does not contain '%STR2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONDITIONEVAL_TRUE_STRINGNOTCONTAINS(1210, "OK", "'%STR1%' does not contain '%STR2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONDITIONEVAL_TRUE_TEXTINELEMENT(300, "OK", "Element '%STRING1%' with value '%STRING2%' is equal to '%STRING3%' with case sensitive constraint : '%STRING4%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONDITIONEVAL_TRUE_TEXTNOTINELEMENT(300, "OK", "Element '%STRING1%' with value '%STRING2%' is different than '%STRING3%' with case sensitive constraint : '%STRING4%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
