...
public enum MessageEventEnum {
    ...
    ACTION_FAILED_CALLSOAP(286, "FA", "Failed to call the SOAP '%SOAPNAME%'! Caused by : %DESCRIPTION%.%ERRORDETAILMESSAGE%", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
