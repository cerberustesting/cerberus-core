...
public enum MessageEventEnum {
    ...
    CONTROL_NOTEXECUTED_NOTSUPPORTED_FOR_MESSAGETYPE(362, "KO", "Cannot perform the control '%CONTROL%' because message type %TYPE% not supported.", true, false, true, MessageGeneralEnum.EXECUTION_KO),
