...
public enum MessageEventEnum {
    ...
    PROPERTY_FAILED_SQL_NODATA(153, "NA", "The SQL performed against database %DB% and JDBCPOOL %JDBCPOOLNAME% returned no data to test. SQL : %SQL%", true, false, false, MessageGeneralEnum.EXECUTION_NA),
    ...
    ACTION_SUCCESS_CLICKIF(200, "OK", "Element '%ELEMENT%' clicked because it was present.", false, false ,false , MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_SUCCESS_TYPEIF(200, "OK", "Element '%ELEMENT%' feeded with '%DATA%' because it was present.", false, false ,false , MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_FAILED_CLICKIF(251, "FA", "Failed to clickIF on '%ELEMENT%' beacause was present.", true, true ,true , MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_NO_SUCH_ELEMENT(253, "FA", "Identifier '%IDENTIFIER%=' isn't recognized! Use: id=, name=, class=, css= , xpath= , link= , picture=, , ng-click=, ng-value=, ng-if=, ng-model=, title= or data-cerberus=.", true, true, true, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_TYPEIF(257, "FA", "Object and/or Property are ‘null’. Both are mandatory in order to perform the action type and was present.", true, true ,true , MessageGeneralEnum.EXECUTION_FA_ACTION),
