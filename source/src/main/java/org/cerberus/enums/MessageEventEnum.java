...
public enum MessageEventEnum {
    ...
    ACTION_SUCCESS_SETNETWORKTRAFFICCONTENT(200, "OK", "HAR Network traffic set to current content.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
