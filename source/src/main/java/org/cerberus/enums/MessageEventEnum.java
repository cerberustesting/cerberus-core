...
public enum MessageEventEnum {
    ...
    CONTROL_FAILED_EQUAL(357, "KO", "'%STRING1%' is not equal to '%STRING2%' %STRING3%.", true, true, false, MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_DIFFERENT(358, "KO", "'%STRING1%' is not different from '%STRING2%' %STRING3%.", true, true, false, MessageGeneralEnum.EXECUTION_KO),
