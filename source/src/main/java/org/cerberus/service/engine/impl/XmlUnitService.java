...
import org.cerberus.service.engine.impl.input.AInputTranslator;
import org.cerberus.service.engine.impl.input.InputTranslator;
import org.cerberus.service.engine.impl.input.InputTranslatorException;
import org.cerberus.service.engine.impl.input.InputTranslatorManager;
...
public class XmlUnitService implements IXmlUnitService {
    ...
    public boolean isSimilarTree(String lastSOAPResponse, String xpath, String tree) {
        ...
        try {
            ...
            for (Node candidate : new XmlUtil.IterableNodeList(candidates)) {
                boolean found = true;
                for (org.cerberus.service.engine.impl.diff.Difference difference : Differences.fromString(getDifferencesFromXml(XmlUtil.toString(candidate), tree))) {
    ...
    public String getDifferencesFromXml(String left, String right) {
        try {
            ...
            for (Object diff : diffs.getAllDifferences()) {
                ...
                resultDiff.addDifference(new org.cerberus.service.engine.impl.diff.Difference(xPathLocation));
            }
    ...
    public String removeDifference(String pattern, String differences) {
        ...
        try {
            ...
            for (org.cerberus.service.engine.impl.diff.Difference currentDiff : current.getDifferences()) {
