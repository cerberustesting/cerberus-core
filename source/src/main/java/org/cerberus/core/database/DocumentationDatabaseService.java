...
public class DocumentationDatabaseService implements IDocumentationDatabaseService {
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(",('robotexecutor','executorExtensionHost','','en','Extension Host', 'Host used to reach the Cerberus browser extension. If empty, the executor Host will be used. Useful when the extension is exposed through a different host/tunnel than Selenium (e.g. cloudflared).',NULL)");
        b.append(",('robotexecutor','executorExtensionHost','','fr','Nom d\\'hote de l\\'extension', 'Nom de la machine utilisée pour accéder à l\\'extension Cerberus. Si vide, le host de l\\'executor est utilisé. Utile lorsque l\\'extension est exposée via un hôte/tunnel différent de celui de Selenium (ex: cloudflared).',NULL)");
        b.append(",('robotexecutor','executorExtensionHost','','fa','میزبان افزونه', 'میزبانی که برای دسترسی به افزونه مرورگر Cerberus استفاده می‌شود. اگر خالی باشد، میزبان مجری استفاده خواهد شد.',NULL)");
        ...
        b.append(",('page_executiondetail','lastexecution','','en','Executions History','',NULL)");
        b.append(",('page_executiondetail','lastexecution','','fa','فهرست اجراها','',NULL)");
        b.append(",('page_executiondetail','lastexecution','','fr','Historique d\\'Executions','',NULL)");
        b.append(",('page_executiondetail','lastexecutionwithenvcountry','','en','Executions History (same Environment & Country)','',NULL)");
        b.append(",('page_executiondetail','lastexecutionwithenvcountry','','fa','فهرست اجرا ها (محیط و کشور یکسان)','',NULL)");
        b.append(",('page_executiondetail','lastexecutionwithenvcountry','','fr','Historique d\\'Executions (même Environnement & Pays)','',NULL)");
        b.append(",('page_executiondetail','lastexecutionoT','','en','Execution Trend','',NULL)");
        b.append(",('page_executiondetail','lastexecutionoT','','fa','گزارش در طول زمان','',NULL)");
        b.append(",('page_executiondetail','lastexecutionoT','','fr','Tendances','',NULL)");
