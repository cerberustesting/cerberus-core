...
public class DocumentationDatabaseService implements IDocumentationDatabaseService {
    ...
    public ArrayList<String> getSqlDocumentation() {
        ...
        b.append(",('countryenvironmentparameters','Var4','','fa','Variable 4','متغیر را می توان با استفاد از متغیر %SYS_APP_VAR4% مورد استفاده قرار داد..','_environment')");
        ...
        b.append(",('robot','active','','fa','Active','تعریف می کند که آیا ربات فعال می باشد یا خیر.',NULL)");
        ...
        b.append(",('robot','robotdecli','','fa','Robot Declination','گرایش ربات به هر اجرایی که با آن ربات اجرا می شود متصل می شود. در صفحه reportByTag به همراه محیط و کشور نمایش داده می شود. اگر خالی باشد، گرایش نام ربات را می گیرد و از متغیرهای زیر پشتیبانی می کند : %SCREENSIZE%, %BROWSER%, %BROWSERVERSION%, %PLATFORM%.',NULL)");
        ...
        b.append(",('robot','useragent','','fa','عامل کاربر','عمل کاربر ربات.',NULL)");
        ...
        b.append(",('robot','ExtraParam','','fa','پارامترهای اضافی','Extra parameters sent to the robot.',NULL)");
        ...
        b.append(",('page_label','btn_view','','en','مشاهده برچسب','',NULL)");
