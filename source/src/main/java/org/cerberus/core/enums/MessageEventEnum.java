...
public enum MessageEventEnum {
    ...
    ACTION_SUCCESS_MOUSEOVER(200, "OK", "%ELEMENTFOUND%. Mouse moved over '%ELEMENT%' with an offset '%OFFSET%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_SUCCESS_WAIT_ELEMENT(200, "OK", "%ELEMENTFOUND%. Waited for %ELEMENT%.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ACTION_SUCCESS_FOUND_ELEMENT(200, "OK", "Warning!! %NUMBER% Elements identified by '%ELEMENT%' were found. Used the first one.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ACTION_SUCCESS_FOUND_UNIQUEELEMENT(200, "OK", "A unique element was identified by '%ELEMENT%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ACTION_SUCCESS_WAITVANISH_ELEMENT(200, "OK", "%ELEMENTFOUND%. Waited for %ELEMENT% to disappear.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ACTION_SUCCESS_KEYPRESS(200, "OK", "Key '%KEY%' pressed with success with modifier '%MODIFIER%' on element '%ELEMENT%'. %ELEMENTFOUND%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_SUCCESS_DRAGANDDROP(200, "OK", "%MESSAGE%. Drag and drop from %SOURCE% to %TARGET% with success", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_SUCCESS_SETACCESSIBILITYCONTENT(200, "OK", "Accessibility analysis (JSON format) set to current content.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    ACTION_FAILED_SELENIUM_CONNECTIVITY(252, "CA", "The test case is cancelled due to a generic Selenium Server error! Detailed error : %ERROR%", true, true, true, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_CLICK_NO_SUCH_ELEMENT(267, "FA", "Failed to click because could not find element '%ELEMENT%'! %MESSAGE%", true, true, true, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_CALLSERVICE_TIMEOUT(286, "FA", "Failed to call the Service '%SERVICEURL%' due to timeout (%TIMEOUT% ms). %DESCRIPTION%", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_CALLSERVICE_MONGO_EMPTYREQUEST(286, "FA", "Failed to call the Service '%SERVICENAME%'. MongoDB Update operation require the 2 requests to be defined.", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_RIGHTCLICK_NO_SUCH_ELEMENT(288, "FA", "Failed to Right Click on element %ELEMENT% because could not find element '%ELEMENT%'! %MESSAGE%", true, true, true, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_SETCONSOLECONTENT(259, "FA", "Failed to set console Content. : %DETAIL%", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_SETACCESSIBILITYCONTENT(259, "FA", "Failed to set Accessibility analysis Content. : %DETAIL%", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    CONTROL_SUCCESS_PRESENT(300, "OK", "%ELEMENTFOUND%. Element '%STRING1%' is present on the message/page/screen.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_NOTPRESENT(300, "OK", "Element '%STRING1%' is not present on the message/page/screen. %MESSAGE%", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_SUCCESS_ELEMENTNUMERICEQUAL(300, "OK", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is equal than '%VALUE%' (transformed to '%VALUETRANS%').", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_ELEMENTNUMERICDIFFERENT(300, "OK", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is different than '%VALUE%' (transformed to '%VALUETRANS%').", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_ELEMENTNUMERICGREATER(300, "OK", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is greater than '%VALUE%' (transformed to '%VALUETRANS%').", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_ELEMENTNUMERICGREATEROREQUAL(300, "OK", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is greater or equal to '%VALUE%' (transformed to '%VALUETRANS%').", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_ELEMENTNUMERICMINOR(300, "OK", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is lower than '%VALUE%' (transformed to '%VALUETRANS%').", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_ELEMENTNUMERICMINOROREQUAL(300, "OK", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is lower or equal to '%VALUE%' (transformed to '%VALUETRANS%').", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_SUCCESS_VERIFYJSONFORMAT(300, "OK", "JSON %JSONTOVALIDATE% is in the expected format %JSONSCHEMA%.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_FAILED_SELENIUM_CONNECTIVITY(354, "CA", "The test case is cancelled due to a generic Selenium Server error! Detailed error : %ERROR%", true, true, true, MessageGeneralEnum.EXECUTION_FA_CONNECTIVITY),
    ...
    CONTROL_FAILED_PRESENT(361, "KO", "Element '%STRING1%' is not present on the message/page/screen. %MESSAGE%", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_NOTPRESENT(363, "KO", "%ELEMENTFOUND%. Element '%STRING1%' is present on the message/page/screen.", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_ELEMENTNUMERICEQUAL(367, "KO", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is not equal to '%VALUE%' (transformed to '%VALUETRANS%').", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_ELEMENTNUMERICDIFFERENT(367, "KO", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is not different than '%VALUE%' (transformed to '%VALUETRANS%').", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_ELEMENTNUMERICGREATER(367, "KO", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is not greater than '%VALUE%'.", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_ELEMENTNUMERICGREATEROREQUAL(367, "KO", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is not greater or equal to '%VALUE%' (transformed to '%VALUETRANS%').", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_ELEMENTNUMERICMINOR(367, "KO", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is not lower than '%VALUE%' (transformed to '%VALUETRANS%').", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_ELEMENTNUMERICMINOROREQUAL(367, "KO", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') is not lower or equal to '%VALUE%' (transformed to '%VALUETRANS%').", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_VERIFYJSONFORMAT(363, "FA", "JSON %JSONTOVALIDATE% is not in the expected format %JSONSCHEMA%. Differences : %DIFFERENCES%", true, false, true, MessageGeneralEnum.EXECUTION_FA),
    ...
    CONDITIONEVAL_FAILED_SELENIUM_CONNECTIVITY(1230, "FA", "Generic Selenium Server error! Detailed error : %ERROR%.", false, false, false, MessageGeneralEnum.EXECUTION_FA_CONDITION),
