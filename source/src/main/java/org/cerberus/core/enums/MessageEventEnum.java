...
public enum MessageEventEnum {
    ...
    CONTROL_FAILED_ELEMENTTEXTCONTAINS(367, "KO", "Element '%ELEMENT%' with value '%ELEMENTVALUE%' (transformed to '%ELEMENTVALUETRANS%') does not contain '%VALUE%' %CASESENSITIVE%.", true, true, true, MessageGeneralEnum.EXECUTION_KO),
