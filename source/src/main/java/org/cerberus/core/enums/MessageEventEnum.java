...
public enum MessageEventEnum {
    ...
    PROPERTY_FAILED_GETFROMJSON(190, "FA", "Failed to get the value '%PARAM%' from JSON. %ERROR%", true, true, true, MessageGeneralEnum.EXECUTION_FA),
    ...
    PROPERTY_FAILED_GETFROMJSON_INVALIDPATH(190, "FA", "The JSON path '%PATH%' is invalid.", true, true, true, MessageGeneralEnum.EXECUTION_FA),
    ...
    PROPERTY_FAILED_GETFROMNETWORKTRAFFIC_INVALIDPATH(904, "FA", "The JSON path '%PATH%' is invalid.", true, true, true, MessageGeneralEnum.EXECUTION_FA),
    ...
    CONTROL_FAILED_ELEMENT_INVALIDJSONPATH(367, "FA", "The JSON path '%PATH%' is invalid. %ERROR%", true, false, true, MessageGeneralEnum.EXECUTION_FA),
    ...
    CONDITIONEVAL_FAILED_INVALIDJSONPATH(1230, "FA", "The JSON path '%PATH%' is invalid.", false, false, false, MessageGeneralEnum.EXECUTION_FA_CONDITION),
