...
@Schema(name = "TestcaseMonthlyStats")
public class TestcaseMonthlyStatsDTOV001 {

    @JsonView(View.Public.GET.class)
    @Schema(description = "Global KPIs")
    private TestcaseStatsDTOV001 global;

    @JsonView(View.Public.GET.class)
    @Schema(description = "Global KPIs for the previous 30 days")
    private TestcaseStatsDTOV001 globalPreviousMonth;

    @JsonView(View.Public.GET.class)
    @Schema(description = "User KPIs")
    private TestcaseStatsDTOV001 system;

    @JsonView(View.Public.GET.class)
    @Schema(description = "User KPIs for the previous 30 days")
    private TestcaseStatsDTOV001 systemPreviousMonth;
