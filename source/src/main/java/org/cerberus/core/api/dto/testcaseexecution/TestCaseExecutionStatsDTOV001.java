...
@JsonPropertyOrder({
        "totalExecutions",
        "totalExecutionsByType",
        "fromDate",
        "toDate"
})
@Schema(name = "TestCaseExecutionStats")
public class TestCaseExecutionStatsDTOV001 {
    ...
    @JsonView({View.Public.GET.class})
    @Schema(description = "Number of executions grouped by type",
            example = "{\"Web\":40,\"API\":50,\"Batch\":30}")
    private Map<String, Integer> totalExecutionsByType;
