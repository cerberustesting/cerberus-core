...
public class ParameterService implements IParameterService {
    ...
    public boolean hasPermissionsUpdate(Parameter parameter, HttpServletRequest request) {
        ...
        if (Property.isSaaS()) {
            if (Parameter.VALUE_queueexecution_global_threadpoolsize.equalsIgnoreCase(parameter.getParam())
                    ...
                    || Parameter.VALUE_cerberus_anthropic_apikey.equalsIgnoreCase(parameter.getParam())
                    || Parameter.VALUE_cerberus_ai_mcp_apikey.equalsIgnoreCase(parameter.getParam())
    ...
    public boolean isToSecureParameter(Parameter parameter) {
        if (parameter.getParam().equals("cerberus_accountcreation_defaultpassword")
                ...
                || parameter.getParam().equals(Parameter.VALUE_cerberus_anthropic_apikey)
                || parameter.getParam().equals(Parameter.VALUE_cerberus_ai_mcp_apikey)
