...
public class FactoryCampaignParameter implements IFactoryCampaignParameter {
    ...
    @Override
    public CampaignParameter create(Integer campaignparameterID, String campaign, String parameter, String value) {
        return new CampaignParameter(campaignparameterID, campaign, parameter, value
        );
    }
