...
//    public static final String VALUE_cerberus_accesskey_value = "cerberus_manage_token";
    ...
    public static final String VALUE_cerberus_groovy_classes_whitelist = "cerberus_groovy_classes_whitelist";

    public static final String VALUE_cerberus_anthropic_apikey = "cerberus_anthropic_apikey";
    public static final String VALUE_cerberus_ai_mcp_apikey = "cerberus_ai_mcp_apikey";
    ...
    public static final String SECUREDPARAMINSQLCLAUSE = "(\"cerberus_accountcreation_defaultpassword\",\"cerberus_proxyauthentification_password\",\"cerberus_jenkinsadmin_password\","
            ...
            + "\"cerberus_anthropic_apikey\",\"cerberus_ai_mcp_apikey\")";
