 ...
 * @author cerberus
 */
@WebServlet(name = "ReadCountryEnvLink", urlPatterns = {"/ReadCountryEnvLink"})
public class ReadCountryEnvLink extends HttpServlet {

    private static final Logger LOG = LogManager.getLogger(ReadCountryEnvLink.class);
    private ICountryEnvLinkService celService;
    private final String OBJECT_NAME = "ReadCountryEnvLink";
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    private AnswerItem<JSONObject> findCountryEnvironmentParametersList(String system, String country, String environment, ApplicationContext appContext, boolean userHasPermissions, HttpServletRequest request) throws JsonProcessingException {
        ...
        if (resp.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode())) {//the service was able to perform the query, then we should get all values
            for (CountryEnvLink cel : resp.getDataList()) {
    ...
    private JSONObject convertToJSONObject(CountryEnvLink object) throws JsonProcessingException {
