...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    private AnswerItem<JSONObject> findBuildRevisionBatchList(String system, String country, String environment, ApplicationContext appContext, boolean userHasPermissions, HttpServletRequest request) throws JsonProcessingException {
    ...
    private JSONObject convertToJSONObject(BuildRevisionBatch brb) throws JsonProcessingException {
    ...
    private AnswerItem<JSONObject> findDistinctValuesOfColumn(String system, ApplicationContext appContext, HttpServletRequest request, String columnName) throws JSONException {
        ...
        AnswerList testCaseList = brbService.readDistinctValuesByCriteria(system, searchParameter, individualSearch, columnName);
