 ...
 * @author cdelage
 */
@WebServlet(name = "DeleteScheduleEntry", urlPatterns = {"/DeleteScheduleEntry"})
public class DeleteScheduleEntry extends HttpServlet {

    private static final Logger LOG = LogManager.getLogger(DeleteScheduleEntry.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id == null || id == 0) {
            ...
            ans = scheduleEntryService.delete(scheduleEntry);
            ...
            if (ans.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode())) {
                ...
                logEventService.createForPrivateCalls("/DeleteScheduleEntry", "DELETE", LogEvent.STATUS_INFO, "Delete schedule entry : ['" + scheduleEntry.getName() + "']", request);
            }
        }
