...
import org.cerberus.core.crud.service.impl.DeployTypeService;
...
public class ReadDeployType extends HttpServlet {
    ...
    private static final Logger LOG = LogManager.getLogger(ReadDeployType.class);
    ...
    private AnswerItem<JSONObject> findDeployTypeList(ApplicationContext appContext, boolean userHasPermissions, HttpServletRequest request) throws JsonProcessingException {
    ...
    private AnswerItem<JSONObject> findDeployTypeByID(String id, ApplicationContext appContext, boolean userHasPermissions) throws JsonProcessingException, CerberusException {
        AnswerItem<JSONObject> item = new AnswerItem<>();
        JSONObject object = new JSONObject();
    ...
    private JSONObject convertDeployTypeToJSONObject(DeployType deployType) throws JsonProcessingException {

        JSONObject result = new JSONObject(JsonUtil.toJson(deployType));
        return result;
    }
    ...
    private AnswerItem<JSONObject> findDistinctValuesOfColumn(ApplicationContext appContext, HttpServletRequest request, String columnName) throws JSONException {
        ...
        AnswerList testCaseList = deployTypeService.readDistinctValuesByCriteria(searchParameter, individualSearch, columnName);
