 ...
 * @author ip100003
 */
@WebServlet(name = "ChangeUserPasswordAdmin", urlPatterns = {"/ChangeUserPasswordAdmin"})
public class ChangeUserPasswordAdmin extends HttpServlet {

    private static final Logger LOG = LogManager.getLogger(ChangeUserPasswordAdmin.class);
