...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    private AnswerItem<JSONObject> findBatchInvariantList(List<String> system, ApplicationContext appContext, boolean userHasPermissions, HttpServletRequest request) throws JsonProcessingException {
        ...
        private AnswerItem<JSONObject> findBatchInvariantByKey(String batch, ApplicationContext appContext, boolean userHasPermissions) throws CerberusException, JsonProcessingException {
        AnswerItem<JSONObject> item = new AnswerItem<>();
        JSONObject object = new JSONObject();
    ...
    private JSONObject convertToJSONObject(BatchInvariant brb) throws JsonProcessingException {
        JSONObject result = new JSONObject(JsonUtil.toJson(brb));
        return result;
    }
    ...
    private AnswerItem<JSONObject> findDistinctValuesOfColumn(List<String> system, ApplicationContext appContext, HttpServletRequest request, String columnName) throws JSONException {
        ...
        AnswerList testCaseList = biService.readDistinctValuesByCriteria(system, searchParameter, individualSearch, columnName);
