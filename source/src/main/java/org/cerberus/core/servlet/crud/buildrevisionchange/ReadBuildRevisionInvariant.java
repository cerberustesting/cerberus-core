...
public class ReadBuildRevisionInvariant extends HttpServlet {
    ...
    private AnswerItem<JSONObject> findBuildRevisionInvariantList(List<String> system, Integer level, ApplicationContext appContext, boolean userHasPermissions, HttpServletRequest request) throws JsonProcessingException {
    ...
    private AnswerItem<JSONObject> findBuildRevisionInvariantByKey(String system, Integer level, Integer seq, ApplicationContext appContext, boolean userHasPermissions) throws JsonProcessingException, CerberusException {
        AnswerItem<JSONObject> item = new AnswerItem<>();
        JSONObject object = new JSONObject();
    ...
    private JSONObject convertBuildRevisionInvariantToJSONObject(BuildRevisionInvariant brp) throws JsonProcessingException {
