...
public class ReadCountryEnvDeployType extends HttpServlet {
    ...
    private static final Logger LOG = LogManager.getLogger(ReadCountryEnvDeployType.class);
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    private AnswerItem<JSONObject> findCountryEnvironmentDeployTypeList(String system, String country, String environment, ApplicationContext appContext, boolean userHasPermissions, HttpServletRequest request) throws JsonProcessingException {
    ...
    private JSONObject convertToJSONObject(CountryEnvDeployType object) throws JsonProcessingException {
