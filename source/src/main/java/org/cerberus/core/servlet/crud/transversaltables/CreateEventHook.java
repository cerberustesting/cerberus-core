 ...
 * @author bcivel
 */
@WebServlet(name = "CreateEventHook", urlPatterns = {"/CreateEventHook"})
public class CreateEventHook extends HttpServlet {

    private static final Logger LOG = LogManager.getLogger(CreateEventHook.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ans = eventHookService.create(eh);
        ...
        if (ans.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode())) {
            ...
            logEventService.createForPrivateCalls("/CreateEventHook", "CREATE", LogEvent.STATUS_INFO, "Create EventHook : ['" + id + "']", request);
        }
