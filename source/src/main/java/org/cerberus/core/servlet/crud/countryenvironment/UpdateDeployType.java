...
public class UpdateDeployType extends HttpServlet {
    ...
    private static final Logger LOG = LogManager.getLogger(UpdateDeployType.class);
        ...
        if (StringUtil.isEmptyOrNull(deployType)) {
            ...
            if (!(resp.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode()) && resp.getItem()!=null)) {
                ...
                if (ans.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode())) {
                    ...
                    logEventService.createForPrivateCalls("/UpdateDeployType", "UPDATE", LogEvent.STATUS_INFO, "Updated Deploy Type : ['" + deployType + "']", request);
                }
            }
        }
