...
public class CreateBuildRevisionInvariant extends HttpServlet {
    ...
    private static final Logger LOG = LogManager.getLogger(CreateBuildRevisionInvariant.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (StringUtil.isEmptyOrNull(system)) {
            ...
            if (ans.isCodeEquals(MessageEventEnum.DATA_OPERATION_OK.getCode())) {
                ...
                logEventService.createForPrivateCalls("/CreateBuildRevisionInvariant", "CREATE", LogEvent.STATUS_INFO, "Create BuildRevisionInvariant : ['" + system + "'|'" + level + "'|'" + seq + "']", request);
            }
        }
