...
import org.cerberus.core.statistics.BuildRevisionStatisticsEnv;
import org.cerberus.core.statistics.IEnvironmentStatisticsService;
...
//        String system = policy.sanitize(request.getParameter("system"));
    ...
    private AnswerItem findBuildRevList(List<String> system, ApplicationContext appContext, boolean userHasPermissions, HttpServletRequest request) throws JsonProcessingException {
    ...
    private JSONObject convertToJSONObject(BuildRevisionStatisticsEnv buildRevStat) throws JsonProcessingException {

        JSONObject result = new JSONObject(JsonUtil.toJson(buildRevStat));
        return result;
    }
