 ...
 */
@Service
public class GlpiGenerationService implements IGlpiGenerationService {

    private static final org.apache.logging.log4j.Logger LOG = org.apache.logging.log4j.LogManager.getLogger(GlpiGenerationService.class);
    ...
    @Override
    public JSONObject generateGlpiIssue(TestCaseExecution execution) {
        ...
        try {
            ...
            issueInputObject.put("name", "TestCase Execution " + execution.getId() + " failed - " + execution.getTest() + " " + execution.getTestCase());
            ...
            issueInputObject.put("content", body);

            issueObject.put("input", issueInputObject);
