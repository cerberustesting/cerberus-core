...
@Component
public class CreateTestWithAIWebSocket extends TextWebSocketHandler {

    private final ObjectMapper objectMapper = new ObjectMapper();
    private final Set<WebSocketSession> sessions = Collections.synchronizedSet(new HashSet<>());
    private static final Logger LOG = LogManager.getLogger(CreateTestWithAIWebSocket.class);

    @Autowired
    private AIService aiService; // Service qui gère la création du test et l’interaction AI
