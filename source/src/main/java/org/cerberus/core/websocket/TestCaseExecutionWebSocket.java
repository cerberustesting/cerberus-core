...
public class TestCaseExecutionWebSocket extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        if (executionIdStr != null) {
            ...
            LOG.warn("Session " + session.getId() + " opened connection to execution " + executionId);
            ...
            try {
                ...
                LOG.warn("Execution " + executionId + " registered session " + session.getId());
    ...
    public void send(TestCaseExecution execution, boolean forcePush) {
        ...
        LOG.warn("Trying to send execution " + execution.getId() + " to sessions");
        for (WebSocketSession registeredSession : registeredSessions) {
            LOG.warn("registeredSession : " + registeredSession.getId());
            try {
