...
public class TestcaseStepDTOV001 {
    ...
    public TestcaseStepDTOV001() {
    }

    public TestcaseStepDTOV001(String testFolderId, String testcaseId, int stepId, int sort, String loop, String conditionOperator, String conditionValue1, String conditionValue2, String conditionValue3, JsonNode conditionOptions, String description, String libraryStepTestFolderId, String libraryStepTestcaseId, Integer libraryStepStepId, boolean isStepInUseByOtherTestcase, int libraryStepSort, boolean isExecutionForced, String usrCreated, String dateCreated, String usrModif, String dateModif, List<TestcaseStepActionDTOV001> actions) {
    ...
    public TestcaseStepDTOV001(String testFolderId, String testcaseId, int stepId, int sort, String loop, String conditionOperator, String conditionValue1, String conditionValue2, String conditionValue3, JsonNode conditionOptions, String description, boolean isUsingLibraryStep, String libraryStepTestFolderId, String libraryStepTestcaseId, Integer libraryStepStepId, boolean isStepInUseByOtherTestcase, int libraryStepSort, boolean isExecutionForced, String usrCreated, String dateCreated, String usrModif, String dateModif, List<TestcaseStepActionDTOV001> actions) {
        this.testFolderId = testFolderId;
        this.testcaseId = testcaseId;
        this.stepId = stepId;
        this.sort = sort;
    ...
    public TestcaseStepDTOV001(String testFolderId, String testcaseId, int stepId, int sort, String loop, String conditionOperator, String conditionValue1, String conditionValue2, String conditionValue3, JsonNode conditionOptions, String description, boolean isUsingLibraryStep, String libraryStepTestFolderId, String libraryStepTestcaseId, Integer libraryStepStepId, boolean isStepInUseByOtherTestcase, int libraryStepSort, boolean isLibraryStep, boolean isExecutionForced, String usrCreated, String dateCreated, String usrModif, String dateModif, List<TestcaseStepActionDTOV001> actions) {
        this.testFolderId = testFolderId;
        this.testcaseId = testcaseId;
        this.stepId = stepId;
        this.sort = sort;
    ...
    public void setActions(List<TestcaseStepActionDTOV001> actions) {
        this.actions = actions;
    }
