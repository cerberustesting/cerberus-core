...
public enum MessageGeneralEnum {
    ...
    VALIDATION_FAILED_RANGE_WRONGFORMAT(54, "", "The Build/Revision of test case isn't formatted has expected"),
    VALIDATION_FAILED_TARGET_DIFFERENT(55, "", "The target Build/Revision of test case isn't in the range of build"),
    VALIDATION_FAILED_TARGET_WRONGFORMAT(56, "", "The target Build/Revision of test case isn't formatted has expected"),
    ...
    VALIDATION_FAILED_COUNTRYENV_NOT_FOUND(65, "", "Country '%COUNTRY%' environment '%ENV%' parameters does not exist."),
