...
public enum MessageEventEnum {
    ...
    CONTROL_SUCCESS_REGEXINELEMENT(300, "OK", "Value '%STRING1%' match '%STRING2%'.", false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_FAILED_REGEXINELEMENT(376, "KO", "Value '%STRING1%' does not match '%STRING2%'.", true, true, MessageGeneralEnum.EXECUTION_KO),
