...
public enum MessageEventEnum {
    ...
    PROPERTY_FAILED_NO_PROPERTY_DEFINITION(151, "NA", "Warning, Property not defined for %PROP% and country %COUNTRY%.", true, false, MessageGeneralEnum.EXECUTION_NA),
    ...
    ACTION_NOTEXECUTED_NO_PROPERTY_DEFINITION(290, "NA", "Not executed because Property '%PROP%' is not defined for the country '%COUNTRY%'.", true, false, MessageGeneralEnum.EXECUTION_NA),
