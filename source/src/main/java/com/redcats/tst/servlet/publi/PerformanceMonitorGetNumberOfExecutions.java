 ...
 * @author vertigo
 */
@WebServlet(name = "PerformanceMonitorGetNumberOfExecutions", urlPatterns = {"/PerformanceMonitorGetNumberOfExecutions"})
public class PerformanceMonitorGetNumberOfExecutions extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!error) {
                ...
                try {
                    myList = MyTestExecutionService.findTCExecutionbyCriteria1(dateLimitFrom, "Performance Monitor", "", application, country, "PROD", controlStatus, "WORKING");
            ...
            Logger.getLogger(PerformanceMonitorGetNumberOfExecutions.class.getName()).log(Level.SEVERE, Version.PROJECT_NAME_VERSION + " - Exception catched.", e);
