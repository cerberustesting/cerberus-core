...
public class ExportListTestCase extends HttpServlet {
    ...
    private String convertTCasetoStringCSV(TCase tc) {
        ...
        sb.append("\"");
        sb.append(tc.getTest());
        sb.append("\",\"");
        sb.append(tc.getTestCase());
        sb.append("\",\"");
        sb.append(tc.getOrigin());
        sb.append("\",\"");
        sb.append(tc.getRefOrigin());
        sb.append("\",\"");
        sb.append(tc.getCreator());
        sb.append("\",\"");
        sb.append(tc.getImplementer());
        sb.append("\",\"");
        sb.append(tc.getLastModifier());
        sb.append("\",\"");
        sb.append(tc.getProject());
        sb.append("\",\"");
        sb.append(tc.getTicket());
        sb.append("\",\"");
        sb.append(tc.getApplication());
        sb.append("\",\"");
        sb.append(tc.getRunQA());
        sb.append("\",\"");
        sb.append(tc.getRunUAT());
        sb.append("\",\"");
        sb.append(tc.getRunPROD());
        sb.append("\",\"");
        sb.append(tc.getPriority());
        sb.append("\",\"");
        sb.append(tc.getGroup());
        sb.append("\",\"");
        sb.append(tc.getStatus());
        sb.append("\",\"");
        sb.append(tc.getShortDescription());
        sb.append("\",\"");
        sb.append(tc.getDescription());
        sb.append("\",\"");
        sb.append(tc.getHowTo());
        sb.append("\",\"");
        sb.append(tc.getActive());
        sb.append("\",\"");
        sb.append(tc.getFromSprint());
        sb.append("\",\"");
        sb.append(tc.getFromRevision());
        sb.append("\",\"");
        sb.append(tc.getToSprint());
        sb.append("\",\"");
        sb.append(tc.getToRevision());
        sb.append("\",\"");
        sb.append(tc.getLastExecutionStatus());
        sb.append("\",\"");
        sb.append(tc.getBugID());
        sb.append("\",\"");
        sb.append(tc.getTargetSprint());
        sb.append("\",\"");
        sb.append(tc.getTargetRevision());
        sb.append("\",\"");
