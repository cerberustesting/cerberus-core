...
The Action will return a json file that follow the below json format:

    {
        ...
        "files": [
        {
            "path": "/home/seluser/Downloads/toto/titi/testnew1.json",
            "filename": "testnew1.json",
            "size": "5018",
            "content-type": "JSON",
...
[NOTE]
====
Please note that on the above example, the 1st file is a json file that contain:
