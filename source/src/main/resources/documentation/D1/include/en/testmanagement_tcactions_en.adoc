...
[NOTE]
====
This action is only possible when Robot has the Cerberus extension activated and fully working.
It also require at least version 1.1 of the robot extension.
====
