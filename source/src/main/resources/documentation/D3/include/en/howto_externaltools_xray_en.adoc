...
* On Cerberus Side, set the 2 parameters *_cerberus_xraydc_token_* with the previously created API Key and  *_cerberus_xraydc_url_* with the URL to your JIRA instance (following the schema : __http://yourserver/rest/raven/2.0/api__).
